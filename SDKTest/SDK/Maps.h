...
public:
	...
	CMember(ABP_Frontend_ShopBG_C*)                    BP_Frontend_ShopBG_9_ExecuteUbergraph_Frontend_BG_Main_RefProperty ___ OFFSET(get<T>, {0x2B0, 8, 0, 0})
	CMember(AFortStaticMeshActor*)                     S_UI_FrontendInspect_HexDonut_ExecuteUbergraph_Frontend_BG_Main_RefProperty ___ OFFSET(get<T>, {0x2B8, 8, 0, 0})
};
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              ___ OFFSET(get<T>, {0x2A8, 8, 0, 0})
	DMember(bool)                                      NewLobby                                                    ___ OFFSET(get<bool>, {0x2B0, 1, 0, 0})
	DMember(bool)                                      NewVar                                                      ___ OFFSET(get<bool>, {0x2B1, 1, 0, 0})
	CMember(AHBOnboardingFlow_C*)                      HBOnboardingFlow_ExecuteUbergraph_Frontend_RefProperty      ___ OFFSET(get<T>, {0x2B8, 8, 0, 0})
};
