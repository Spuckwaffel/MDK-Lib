...
class FCachedPropertyPath : public MDKStruct
{ 
	friend MDKBase;
...
class FPropertyPathTestInnerStruct : public MDKStruct
{ 
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 32;

public:
	DMember(float)                                     float                                                       ___ OFFSET(get<float>, {0x0, 4, 0, 0})
	DMember(bool)                                      bool                                                        ___ OFFSET(get<bool>, {0x4, 1, 0, 0})
...
class FPropertyPathTestStruct : public MDKStruct
{ 
	friend MDKBase;
...
public:
	...
	SMember(FString)                                   String                                                      ___ OFFSET(get<T>, {0x10, 16, 0, 0})
	DMember(float)                                     float                                                       ___ OFFSET(get<float>, {0x20, 4, 0, 0})
...
class FPropertyPathTestBed : public MDKStruct
{ 
	friend MDKBase;
...
public:
	DMember(bool)                                      bool                                                        ___ OFFSET(get<bool>, {0x28, 1, 0, 0})
	...
	DMember(float)                                     float                                                       ___ OFFSET(get<float>, {0x48, 4, 0, 0})
