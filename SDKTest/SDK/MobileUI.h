...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              ___ OFFSET(get<T>, {0x3B8, 8, 0, 0})
};
...
public:
	...
	CMember(UWBP_Augment_SelectionTimer_C*)            WBP_Augment_SelectionTimer                                  ___ OFFSET(get<T>, {0x350, 8, 0, 0})
};
