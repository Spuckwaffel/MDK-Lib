...
public:
	...
	DMember(float)                                     Float00                                                     ___ OFFSET(get<float>, {0x40, 4, 0, 0})
	DMember(float)                                     Float01                                                     ___ OFFSET(get<float>, {0x44, 4, 0, 0})
	DMember(float)                                     Float02                                                     ___ OFFSET(get<float>, {0x48, 4, 0, 0})
	DMember(float)                                     Float03                                                     ___ OFFSET(get<float>, {0x4C, 4, 0, 0})
	DMember(float)                                     Float10                                                     ___ OFFSET(get<float>, {0x50, 4, 0, 0})
	DMember(float)                                     Float11                                                     ___ OFFSET(get<float>, {0x54, 4, 0, 0})
	DMember(float)                                     Float12                                                     ___ OFFSET(get<float>, {0x58, 4, 0, 0})
	DMember(float)                                     Float13                                                     ___ OFFSET(get<float>, {0x5C, 4, 0, 0})
	DMember(float)                                     Float20                                                     ___ OFFSET(get<float>, {0x60, 4, 0, 0})
	DMember(float)                                     Float21                                                     ___ OFFSET(get<float>, {0x64, 4, 0, 0})
	DMember(float)                                     Float22                                                     ___ OFFSET(get<float>, {0x68, 4, 0, 0})
	DMember(float)                                     Float23                                                     ___ OFFSET(get<float>, {0x6C, 4, 0, 0})
	DMember(float)                                     Float30                                                     ___ OFFSET(get<float>, {0x70, 4, 0, 0})
	DMember(float)                                     Float31                                                     ___ OFFSET(get<float>, {0x74, 4, 0, 0})
	DMember(float)                                     Float32                                                     ___ OFFSET(get<float>, {0x78, 4, 0, 0})
	DMember(float)                                     Float33                                                     ___ OFFSET(get<float>, {0x7C, 4, 0, 0})
