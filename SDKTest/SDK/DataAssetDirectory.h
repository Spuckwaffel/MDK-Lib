...
{
	EDataAssetDirectoryTestEnum__A0                                                  = 0,
	EDataAssetDirectoryTestEnum__B1                                                  = 1,
	EDataAssetDirectoryTestEnum__C2                                                  = 2,
	EDataAssetDirectoryTestEnum__D3                                                  = 3,
	EDataAssetDirectoryTestEnum__EDataAssetDirectoryTestEnum_MAX4                    = 4
};
...
{
	EDataAssetDirectoryUpdateStatus__Failed0                                         = 0,
	EDataAssetDirectoryUpdateStatus__Success1                                        = 1,
	EDataAssetDirectoryUpdateStatus__SuccessNoChange2                                = 2,
	EDataAssetDirectoryUpdateStatus__EDataAssetDirectoryUpdateStatus_MAX3            = 3
};
