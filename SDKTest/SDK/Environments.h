...
public:
	...
	SMember(FName)                                     HideElement                                                 ___ OFFSET(get<T>, {0x770, 4, 0, 0})
	SMember(FName)                                     HideElement                                                 ___ OFFSET(get<T>, {0x774, 4, 0, 0})
	SMember(FName)                                     HideElement                                                 ___ OFFSET(get<T>, {0x778, 4, 0, 0})
	SMember(FName)                                     HideElement                                                 ___ OFFSET(get<T>, {0x77C, 4, 0, 0})
	SMember(FName)                                     HideElement                                                 ___ OFFSET(get<T>, {0x780, 4, 0, 0})
	SMember(FName)                                     HideElement                                                 ___ OFFSET(get<T>, {0x784, 4, 0, 0})
	SMember(FName)                                     HideElement                                                 ___ OFFSET(get<T>, {0x788, 4, 0, 0})
	SMember(FName)                                     HideElement                                                 ___ OFFSET(get<T>, {0x78C, 4, 0, 0})
	SMember(FName)                                     HideElement                                                 ___ OFFSET(get<T>, {0x790, 4, 0, 0})
...
public:
	...
	CMember(UTexture*)                                 2dTexture                                                   ___ OFFSET(get<T>, {0x2B0, 8, 0, 0})
...
public:
	...
	CMember(UTimelineComponent*)                       Timeline                                                    ___ OFFSET(get<T>, {0x440, 8, 0, 0})
