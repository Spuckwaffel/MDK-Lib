...
public:
	CMember(UFortSocialAvatarIcon*)                    Icon_SocialAvatar                                           ___ OFFSET(get<T>, {0x310, 8, 0, 0})
};
...
public:
	SMember(FFortPrioritizedWidgetData)                PrioritizationData                                          ___ OFFSET(get<T>, {0x350, 2, 0, 0})
};
