...
public:
	CMember(UCustomizableObjectPopulationClass*)       Class                                                       ___ OFFSET(get<T>, {0x0, 8, 0, 0})
	DMember(int32_t)                                   ClassWeight                                                 ___ OFFSET(get<int32_t>, {0x8, 4, 0, 0})
};
...
public:
	...
	CMember(TArray<FCustomizableObjectPopulationConstraint>) Constraints                                           ___ OFFSET(get<T>, {0x10, 16, 0, 0})
};
...
public:
	CMember(EPopulationConstraintType)                 Type                                                        ___ OFFSET(get<T>, {0x0, 1, 0, 0})
	DMember(int32_t)                                   ConstraintWeight                                            ___ OFFSET(get<int32_t>, {0x4, 4, 0, 0})
	DMember(int32_t)                                   TrueWeight                                                  ___ OFFSET(get<int32_t>, {0x8, 4, 0, 0})
	DMember(int32_t)                                   FalseWeight                                                 ___ OFFSET(get<int32_t>, {0xC, 4, 0, 0})
	SMember(FString)                                   DiscreteValue                                               ___ OFFSET(get<T>, {0x10, 16, 0, 0})
	SMember(FLinearColor)                              DiscreteColor                                               ___ OFFSET(get<T>, {0x20, 16, 0, 0})
	CMember(TArray<FString>)                           AllowList                                                   ___ OFFSET(get<T>, {0x30, 16, 0, 0})
	CMember(TArray<FString>)                           Blocklist                                                   ___ OFFSET(get<T>, {0x40, 16, 0, 0})
	CMember(TArray<FConstraintRanges>)                 Ranges                                                      ___ OFFSET(get<T>, {0x50, 16, 0, 0})
	CMember(UCurveBase*)                               Curve                                                       ___ OFFSET(get<T>, {0x60, 8, 0, 0})
	CMember(ECurveColor)                               CurveColor                                                  ___ OFFSET(get<T>, {0x68, 1, 0, 0})
};
...
public:
	DMember(float)                                     MinimumValue                                                ___ OFFSET(get<float>, {0x0, 4, 0, 0})
	DMember(float)                                     MaximumValue                                                ___ OFFSET(get<float>, {0x4, 4, 0, 0})
	DMember(int32_t)                                   RangeWeight                                                 ___ OFFSET(get<int32_t>, {0x8, 4, 0, 0})
};
...
public:
	CMember(TArray<FString>)                           Tags                                                        ___ OFFSET(get<T>, {0x0, 16, 0, 0})
	CMember(TMap<FString, FPopulationClassParameterOptions>) ParameterOptions                                      ___ OFFSET(get<T>, {0x10, 80, 0, 0})
};
...
public:
	...
	CMember(TArray<FClassWeightPair>)                  ClassWeights                                                ___ OFFSET(get<T>, {0x38, 16, 0, 0})
	CMember(UCustomizableObjectPopulationGenerator*)   Generator                                                   ___ OFFSET(get<T>, {0x48, 8, 0, 0})
};
...
public:
	SMember(FString)                                   Name                                                        ___ OFFSET(get<T>, {0x28, 16, 0, 0})
	CMember(UCustomizableObject*)                      CustomizableObject                                          ___ OFFSET(get<T>, {0x38, 8, 0, 0})
	CMember(TArray<FString>)                           AllowList                                                   ___ OFFSET(get<T>, {0x40, 16, 0, 0})
	CMember(TArray<FString>)                           Blocklist                                                   ___ OFFSET(get<T>, {0x50, 16, 0, 0})
	CMember(TArray<FCustomizableObjectPopulationCharacteristic>) Characteristics                                   ___ OFFSET(get<T>, {0x60, 16, 0, 0})
	CMember(TArray<FString>)                           Tags                                                        ___ OFFSET(get<T>, {0x70, 16, 0, 0})
};
...
public:
	CMember(TArray<UCustomizableObject*>)              PopulationObjects                                           ___ OFFSET(get<T>, {0x28, 16, 0, 0})
};
