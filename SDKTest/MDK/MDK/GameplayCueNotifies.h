...
public:
	...
	// void Activated(FVector EdgeOfStorm);                                                                                     // [0x1ebf994] BlueprintCallable|BlueprintEvent 
...
public:
	...
	// void Set Additional Niagara Parameters on Spawned FX(UNiagaraComponent* Spawned Teleport In FX);                         // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.EndVFX
	// void EndVFX();                                                                                                           // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.Set Additional Niagara Parameter on Drone FX
	// void Set Additional Niagara Parameter on Drone FX(UNiagaraComponent* Drone FX);                                          // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.OnCosmeticPart
	// void OnCosmeticPart(AFortPlayerPawn* Pawn, UCustomCharacterPart* Part, USkeletalMeshComponent* MeshPart, TEnumAsByte<EFortCustomPartType> PartType); // [0x1ebf994] BlueprintCallable|BlueprintEvent 
...
public:
	...
	// void Set Timeline Playrates();                                                                                           // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezOut.GCN_RezOut_C.Dissolve Material Setup
	// void Dissolve Material Setup();                                                                                          // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Play Elmination AnimMontage();                                                                                      // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Set Additional Niagara Parameters on Spawned FX(UNiagaraComponent* Spawned Death FX);                               // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezOut.GCN_RezOut_C.Set Additional Niagara Parameters on Drone FX
	// void Set Additional Niagara Parameters on Drone FX(UNiagaraComponent* Drone FX);                                         // [0x1ebf994] BlueprintCallable|BlueprintEvent 
...
public:
	...
	// void SkeletalMeshSetup(AFortPlayerPawnAthena* FortPawn);                                                                 // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	...
	// void CapsuleFadeTL__FinishedFunc();                                                                                      // [0x1ebf994] BlueprintEvent       
	...
	// void CapsuleFadeTL__UpdateFunc();                                                                                        // [0x1ebf994] BlueprintEvent       
...
public:
	...
	// void SkeletalMeshSetup(AFortPlayerPawn* FortPawn);                                                                       // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
...
public:
	...
	/// Functions
	// Function /TacticalSprintGame/GameplayCueNotifies/GCNL_Athena_Player_TacticalSprint_EnergyDrain.GCNL_Athena_Player_TacticalSprint_EnergyDrain_C.OnLoopingStartGeneric
	...
	// Function /TacticalSprintGame/GameplayCueNotifies/GCNL_Athena_Player_TacticalSprint_EnergyDrain.GCNL_Athena_Player_TacticalSprint_EnergyDrain_C.UpdateFX
	// void UpdateFX();                                                                                                         // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /TacticalSprintGame/GameplayCueNotifies/GCNL_Athena_Player_TacticalSprint_EnergyDrain.GCNL_Athena_Player_TacticalSprint_EnergyDrain_C.OnRemovalGeneric
...
public:
	...
	/// Functions
	// Function /TacticalSprintGame/GameplayCueNotifies/GCNL_Athena_Player_TacticalSprint_Speedlines.GCNL_Athena_Player_TacticalSprint_Speedlines_C.CheckSurfaceType
	// void CheckSurfaceType(AFortPawn* Pawn, int32_t& SurfaceTypeInt);                                                         // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /TacticalSprintGame/GameplayCueNotifies/GCNL_Athena_Player_TacticalSprint_Speedlines.GCNL_Athena_Player_TacticalSprint_Speedlines_C.GetPercentageSprintEnergy
	// void GetPercentageSprintEnergy(AActor* Energy Owning Actor, double& CurrentEnergyPercentage);                            // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /TacticalSprintGame/GameplayCueNotifies/GCNL_Athena_Player_TacticalSprint_Speedlines.GCNL_Athena_Player_TacticalSprint_Speedlines_C.OnLoopingStartNiagara
	...
	// Function /TacticalSprintGame/GameplayCueNotifies/GCNL_Athena_Player_TacticalSprint_Speedlines.GCNL_Athena_Player_TacticalSprint_Speedlines_C.LoopUpdate
	// void LoopUpdate();                                                                                                       // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /TacticalSprintGame/GameplayCueNotifies/GCNL_Athena_Player_TacticalSprint_Speedlines.GCNL_Athena_Player_TacticalSprint_Speedlines_C.MovementModeChanged
	...
	// Function /TacticalSprintGame/GameplayCueNotifies/GCNL_Athena_Player_TacticalSprint_Speedlines.GCNL_Athena_Player_TacticalSprint_Speedlines_C.OnRemovalGeneric
	// void OnRemovalGeneric(AActor* MyTarget, FGameplayCueParameters& Parameters, TArray<UFXSystemComponent*>& ParticleComponents, TArray<UAudioComponent*>& AudioComponents, ULegacyCameraShake* BurstCameraShakeInstance, ADecalActor* BurstDecalInstance); // [0x1ebf994] Event|Public|HasOutParms|BlueprintEvent 
	// Function /TacticalSprintGame/GameplayCueNotifies/GCNL_Athena_Player_TacticalSprint_Speedlines.GCNL_Athena_Player_TacticalSprint_Speedlines_C.UpdateSurfaceType
