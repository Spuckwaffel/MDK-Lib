...
public:
	...
	CMember(UAudioComponent*)                          Audio                                                       OFFSET(get<T>, {0x9B8, 8, 0, 0})
	CMember(AFortPlayerPawn*)                          StormPawn                                                   OFFSET(get<T>, {0x9C0, 8, 0, 0})
	...
	// bool OnExecute(AActor* MyTarget, FGameplayCueParameters& Parameters);                                                    // [0x101681c] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/StWStorm/GCNL_EdgeOfStorm.GCNL_EdgeOfStorm_C.OnActive
	// bool OnActive(AActor* MyTarget, FGameplayCueParameters& Parameters);                                                     // [0x101681c] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/StWStorm/GCNL_EdgeOfStorm.GCNL_EdgeOfStorm_C.Activated
	// void Activated(FVector EdgeOfStorm);                                                                                     // [0x101681c] BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/StWStorm/GCNL_EdgeOfStorm.GCNL_EdgeOfStorm_C.Deactivated
	// void Deactivated();                                                                                                      // [0x101681c] BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/StWStorm/GCNL_EdgeOfStorm.GCNL_EdgeOfStorm_C.ExecuteUbergraph_GCNL_EdgeOfStorm
	// void ExecuteUbergraph_GCNL_EdgeOfStorm(int32_t EntryPoint);                                                              // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	CMember(UTimelineComponent*)                       TFX_ResOutCharacterMesh                                     OFFSET(get<T>, {0x568, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       TFX_GlowCharacterMesh                                       OFFSET(get<T>, {0x578, 8, 0, 0})
	DMember(bool)                                      DEBUG_ANIMATION                                             OFFSET(get<bool>, {0x580, 1, 0, 0})
	DMember(bool)                                      SpawnDrone                                                  OFFSET(get<bool>, {0x581, 1, 0, 0})
	CMember(UClass*)                                   Teleportation_Drone                                         OFFSET(get<T>, {0x588, 8, 0, 0})
	...
	CMember(UPointLightComponent*)                     Teleportation_Point_Light                                   OFFSET(get<T>, {0x5A0, 8, 0, 0})
	...
	CMember(TArray<UMaterialInstanceDynamic*>)         DissolveMIDs                                                OFFSET(get<T>, {0x5D0, 16, 0, 0})
	CMember(UMaterialInterface*)                       Mat_Chracter_Dissolve                                       OFFSET(get<T>, {0x5E0, 8, 0, 0})
	CMember(APlayerPawn_Athena_C*)                     Pawn                                                        OFFSET(get<T>, {0x5E8, 8, 0, 0})
	...
	CMember(TArray<USkeletalMeshComponent*>)           Meshes_to_Dissolve                                          OFFSET(get<T>, {0x658, 16, 0, 0})
	CMember(ABP_TeleportationDrone_C*)                 Drone                                                       OFFSET(get<T>, {0x668, 8, 0, 0})
	DMember(bool)                                      DEBUG_CHILDCOMPONENTS                                       OFFSET(get<bool>, {0x670, 1, 0, 0})
	CMember(TArray<UFXSystemComponent*>)               Particle_Components                                         OFFSET(get<T>, {0x678, 16, 0, 0})
	CMember(UNiagaraComponent*)                        Spawned_Teleport_VFX                                        OFFSET(get<T>, {0x688, 8, 0, 0})
	CMember(UNiagaraSystem*)                           Teleport_In_Visual_Effect                                   OFFSET(get<T>, {0x690, 8, 0, 0})
	...
	CMember(UNiagaraSystem*)                           Drone_Visual_Effect                                         OFFSET(get<T>, {0x6B8, 8, 0, 0})
	...
	// void Spawn Drone VFX();                                                                                                  // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.Set Timelines' Playrates
	// void Set Timelines' Playrates();                                                                                         // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.Spawn Teleport In VFX
	// void Spawn Teleport In VFX();                                                                                            // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.Restore Character Materials
	// void Restore Character Materials(bool& Fully Completed);                                                                 // [0x101681c] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.Clean-Up Teleportation Light
	// void Clean-Up Teleportation Light();                                                                                     // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.Spawn Teleportation Light
	// void Spawn Teleportation Light();                                                                                        // [0x101681c] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.Spawn Teleportation Drone
	// void Spawn Teleportation Drone();                                                                                        // [0x101681c] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.Stop Looping Audio
	// void Stop Looping Audio();                                                                                               // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.TFX_GlowCharacterMesh__FinishedFunc
	// void TFX_GlowCharacterMesh__FinishedFunc();                                                                              // [0x101681c] BlueprintEvent       
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.TFX_GlowCharacterMesh__UpdateFunc
	// void TFX_GlowCharacterMesh__UpdateFunc();                                                                                // [0x101681c] BlueprintEvent       
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.TFX_ResOutCharacterMesh__FinishedFunc
	// void TFX_ResOutCharacterMesh__FinishedFunc();                                                                            // [0x101681c] BlueprintEvent       
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.TFX_ResOutCharacterMesh__UpdateFunc
	// void TFX_ResOutCharacterMesh__UpdateFunc();                                                                              // [0x101681c] BlueprintEvent       
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.OnBurstGeneric
	// void OnBurstGeneric(AActor* MyTarget, FGameplayCueParameters& Parameters, TArray<UFXSystemComponent*>& ParticleComponents, TArray<UAudioComponent*>& AudioComponents, ULegacyCameraShake* BurstCameraShakeInstance, ADecalActor* BurstDecalInstance); // [0x101681c] Event|Public|HasOutParms|BlueprintEvent|Const 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.Pre-Sequence Change
	// void Pre-Sequence Change();                                                                                              // [0x101681c] BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.Set Additional Niagara Parameters on Spawned FX
	// void Set Additional Niagara Parameters on Spawned FX(UNiagaraComponent* Spawned Teleport In FX);                         // [0x101681c] BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.EndVFX
	// void EndVFX();                                                                                                           // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.Set Additional Niagara Parameter on Drone FX
	// void Set Additional Niagara Parameter on Drone FX(UNiagaraComponent* Drone FX);                                          // [0x101681c] BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.OnCosmeticPart
	// void OnCosmeticPart(AFortPlayerPawn* Pawn, UCustomCharacterPart* Part, USkeletalMeshComponent* MeshPart, TEnumAsByte<EFortCustomPartType> PartType); // [0x101681c] BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.TriggerVFX
	// void TriggerVFX();                                                                                                       // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezIn.GCN_RezIn_C.ExecuteUbergraph_GCN_RezIn
	// void ExecuteUbergraph_GCN_RezIn(int32_t EntryPoint);                                                                     // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	DMember(bool)                                      DEBUG_CHILDCOMPONENTS                                       OFFSET(get<bool>, {0x670, 1, 0, 0})
	CMember(TArray<UFXSystemComponent*>)               Particle_Components                                         OFFSET(get<T>, {0x678, 16, 0, 0})
	CMember(UNiagaraComponent*)                        Spawned_Death_VFX                                           OFFSET(get<T>, {0x688, 8, 0, 0})
	CMember(UNiagaraSystem*)                           Dissolve_Visual_Effect                                      OFFSET(get<T>, {0x690, 8, 0, 0})
	SMember(FName)                                     Dissolve_VFX_Spawn_Point_Name                               OFFSET(getStruct<T>, {0x698, 4, 0, 0})
	CMember(UAnimMontage*)                             Base_Elimination_Montage                                    OFFSET(get<T>, {0x6A0, 8, 0, 0})
	CMember(UAnimMontage*)                             DBNO_Elimination_Montage                                    OFFSET(get<T>, {0x6A8, 8, 0, 0})
	CMember(UAnimMontage*)                             Skydiving_Elimination_Montage                               OFFSET(get<T>, {0x6B0, 8, 0, 0})
	CMember(UAnimMontage*)                             Swimming_Elimination_Montage                                OFFSET(get<T>, {0x6B8, 8, 0, 0})
	CMember(UAnimMontage*)                             DBNO_Swimming_Elimination_Montage                           OFFSET(get<T>, {0x6C0, 8, 0, 0})
	...
	CMember(UNiagaraSystem*)                           Drone_Visual_Effect                                         OFFSET(get<T>, {0x6E8, 8, 0, 0})
	...
	// void Set Timeline Playrates();                                                                                           // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezOut.GCN_RezOut_C.Dissolve Material Setup
	// void Dissolve Material Setup();                                                                                          // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezOut.GCN_RezOut_C.Spawn Dissolve VFX
	// void Spawn Dissolve VFX();                                                                                               // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Play Elmination AnimMontage();                                                                                      // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Set Additional Niagara Parameters on Spawned FX(UNiagaraComponent* Spawned Death FX);                               // [0x101681c] BlueprintCallable|BlueprintEvent 
	// Function /Game/GameplayCueNotifies/Death/GCN_RezOut.GCN_RezOut_C.Set Additional Niagara Parameters on Drone FX
	// void Set Additional Niagara Parameters on Drone FX(UNiagaraComponent* Drone FX);                                         // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCN_RezOut(int32_t EntryPoint);                                                                    // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	CMember(UTimelineComponent*)                       CapsuleFadeTL                                               OFFSET(get<T>, {0x560, 8, 0, 0})
	DMember(double)                                    Starting_Min_Capsule_Shadow_Vis                             OFFSET(get<double>, {0x568, 8, 0, 0})
	CMember(TArray<USkeletalMeshComponent*>)           SkeletalMesh                                                OFFSET(get<T>, {0x570, 16, 0, 0})
	...
	// void SkeletalMeshSetup(AFortPlayerPawnAthena* FortPawn);                                                                 // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void CapsuleFadeTL__FinishedFunc();                                                                                      // [0x101681c] BlueprintEvent       
	...
	// void CapsuleFadeTL__UpdateFunc();                                                                                        // [0x101681c] BlueprintEvent       
	...
	// void ExecuteUbergraph_GC_Abilities_Death_FadeCapsule_Athena(int32_t EntryPoint);                                         // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	// void SkeletalMeshSetup(AFortPlayerPawn* FortPawn);                                                                       // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GC_Abilities_Death_FadeCapsule_StW(int32_t EntryPoint);                                            // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	CMember(USoundBase*)                               SoundOnNPCDeath                                             OFFSET(get<T>, {0x748, 8, 0, 0})
	...
	// void ExecuteUbergraph_GCN_RezOut_NPC(int32_t EntryPoint);                                                                // [0x101681c] Final                
};
...
public:
	...
	// void ExecuteUbergraph_GCN_NPC_Interaction_RezOut_Glitch(int32_t EntryPoint);                                             // [0x101681c] Final|HasDefaults    
};
