...
public:
	SMember(FMovieSceneGeometryCacheParams)            Params                                                      OFFSET(get<T>, {0xF0, 64, 0, 0})
};
...
public:
	...
	SMember(FSoftObjectPath)                           GeometryCache                                               OFFSET(get<T>, {0x28, 24, 0, 0})
};
...
public:
	SMember(FFrameNumber)                              SectionStartTime                                            OFFSET(get<T>, {0x40, 4, 0, 0})
	SMember(FFrameNumber)                              SectionEndTime                                              OFFSET(get<T>, {0x44, 4, 0, 0})
};
...
public:
	SMember(FMovieSceneGeometryCacheSectionTemplateParameters) Params                                              OFFSET(get<T>, {0x20, 72, 0, 0})
};
