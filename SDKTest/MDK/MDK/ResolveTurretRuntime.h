...
public:
	SMember(FVector)                                   HandAttachL                                                 OFFSET(getStruct<T>, {0x15C8, 24, 0, 0})
	SMember(FVector)                                   HandAttachR                                                 OFFSET(getStruct<T>, {0x15E0, 24, 0, 0})
	SMember(FName)                                     HandAttachBoneNameL                                         OFFSET(getStruct<T>, {0x15F8, 4, 0, 0})
	SMember(FName)                                     HandAttachBoneNameR                                         OFFSET(getStruct<T>, {0x15FC, 4, 0, 0})
};
