...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              ___ OFFSET(get<T>, {0x380, 8, 0, 0})
	DMember(float)                                     Timeline_0_Alpha_3D5AA2144E9B8D6D3B409B845315B143           ___ OFFSET(get<float>, {0x388, 4, 0, 0})
	CMember(TEnumAsByte<ETimelineDirection>)           Timeline_0__Direction_3D5AA2144E9B8D6D3B409B845315B143      ___ OFFSET(get<T>, {0x38C, 1, 0, 0})
	CMember(UTimelineComponent*)                       Timeline                                                    ___ OFFSET(get<T>, {0x390, 8, 0, 0})
};
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              ___ OFFSET(get<T>, {0x380, 8, 0, 0})
	CMember(UParticleSystemComponent*)                 P_Camera_Lava_Bouncing                                      ___ OFFSET(get<T>, {0x388, 8, 0, 0})
};
