...
public:
	...
	SMember(FAnimBlueprintGeneratedMutableData)        __AnimBlueprintMutables                                     OFFSET(getStruct<T>, {0x15E8, 168, 0, 0})
	SMember(FAnimSubsystemInstance)                    AnimBlueprintExtension_PropertyAccess                       OFFSET(getStruct<T>, {0x1690, 8, 0, 0})
	SMember(FAnimSubsystemInstance_NodeRelevancy)      AnimBlueprintExtension_NodeRelevancy                        OFFSET(getStruct<T>, {0x1698, 168, 0, 0})
	SMember(FAnimSubsystemInstance)                    AnimBlueprintExtension_Base                                 OFFSET(getStruct<T>, {0x1740, 8, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root                                          OFFSET(getStruct<T>, {0x1748, 32, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool                               OFFSET(getStruct<T>, {0x1768, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool1                              OFFSET(getStruct<T>, {0x17B0, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool2                              OFFSET(getStruct<T>, {0x17F8, 72, 0, 0})
	SMember(FAnimNode_SequenceEvaluator)               AnimGraphNode_SequenceEvaluator                             OFFSET(getStruct<T>, {0x1840, 64, 0, 0})
	SMember(FAnimNode_SequenceEvaluator)               AnimGraphNode_SequenceEvaluator1                            OFFSET(getStruct<T>, {0x1880, 64, 0, 0})
	SMember(FAnimNode_SequenceEvaluator)               AnimGraphNode_SequenceEvaluator2                            OFFSET(getStruct<T>, {0x18C0, 64, 0, 0})
	SMember(FAnimNode_SequenceEvaluator)               AnimGraphNode_SequenceEvaluator3                            OFFSET(getStruct<T>, {0x1900, 64, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool3                              OFFSET(getStruct<T>, {0x1940, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool4                              OFFSET(getStruct<T>, {0x1988, 72, 0, 0})
	SMember(FAnimNode_SequenceEvaluator)               AnimGraphNode_SequenceEvaluator4                            OFFSET(getStruct<T>, {0x19D0, 64, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool5                              OFFSET(getStruct<T>, {0x1A10, 72, 0, 0})
	SMember(FAnimNode_SequenceEvaluator)               AnimGraphNode_SequenceEvaluator5                            OFFSET(getStruct<T>, {0x1A58, 64, 0, 0})
	SMember(FAnimNode_SequenceEvaluator)               AnimGraphNode_SequenceEvaluator6                            OFFSET(getStruct<T>, {0x1A98, 64, 0, 0})
	SMember(FAnimNode_SequenceEvaluator)               AnimGraphNode_SequenceEvaluator7                            OFFSET(getStruct<T>, {0x1AD8, 64, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool6                              OFFSET(getStruct<T>, {0x1B18, 72, 0, 0})
	...
	// void ResetBlendListNode(FAnimUpdateContext& Context, FAnimNodeReference& Node);                                          // [0x1d9241c] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_Player_SourcePose_AnimBP(int32_t EntryPoint);                                                      // [0x1d9241c] Final                
};
...
public:
	...
	// void ExecuteUbergraph_Player_BuildingPose_AnimBP(int32_t EntryPoint);                                                    // [0x1d9241c] Final                
};

/// Class /Game/Characters/Player/AnimationBlueprints/LinkedAnimGraphs/Player_FreeFlying_AnimBP.Player_FreeFlying_AnimBP_C
/// Size: 0x0810 (0x0015E0 - 0x001DF0)
class UPlayer_FreeFlying_AnimBP_C : public UFortPlayerAnimInstanceProxy
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 7664;

public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x15E0, 8, 0, 0})
	SMember(FAnimBlueprintGeneratedMutableData)        __AnimBlueprintMutables                                     OFFSET(getStruct<T>, {0x15E8, 72, 0, 0})
	...
	SMember(FAnimNode_BlendListByEnum)                 AnimGraphNode_BlendListByEnum                               OFFSET(getStruct<T>, {0x1688, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer                                OFFSET(getStruct<T>, {0x16D0, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer1                               OFFSET(getStruct<T>, {0x1718, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer2                               OFFSET(getStruct<T>, {0x1760, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer3                               OFFSET(getStruct<T>, {0x17A8, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool                               OFFSET(getStruct<T>, {0x17F0, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool1                              OFFSET(getStruct<T>, {0x1838, 72, 0, 0})
	SMember(FAnimNode_BlendSpacePlayer)                AnimGraphNode_BlendSpacePlayer                              OFFSET(getStruct<T>, {0x1880, 112, 0, 0})
	SMember(FAnimNode_ApplyAdditive)                   AnimGraphNode_ApplyAdditive                                 OFFSET(getStruct<T>, {0x18F0, 200, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult                                   OFFSET(getStruct<T>, {0x19B8, 32, 0, 0})
	SMember(FAnimNode_BlendListByEnum)                 AnimGraphNode_BlendListByEnum1                              OFFSET(getStruct<T>, {0x19D8, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer4                               OFFSET(getStruct<T>, {0x1A20, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer5                               OFFSET(getStruct<T>, {0x1A68, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer6                               OFFSET(getStruct<T>, {0x1AB0, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer7                               OFFSET(getStruct<T>, {0x1AF8, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool2                              OFFSET(getStruct<T>, {0x1B40, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool3                              OFFSET(getStruct<T>, {0x1B88, 72, 0, 0})
	SMember(FAnimNode_BlendSpacePlayer)                AnimGraphNode_BlendSpacePlayer1                             OFFSET(getStruct<T>, {0x1BD0, 112, 0, 0})
	SMember(FAnimNode_ApplyAdditive)                   AnimGraphNode_ApplyAdditive1                                OFFSET(getStruct<T>, {0x1C40, 200, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult1                                  OFFSET(getStruct<T>, {0x1D08, 32, 0, 0})
	SMember(FAnimNode_StateMachine)                    AnimGraphNode_StateMachine                                  OFFSET(getStruct<T>, {0x1D28, 200, 0, 0})
	...
	// void ExecuteUbergraph_Player_FreeFlying_AnimBP(int32_t EntryPoint);                                                      // [0x1d9241c] Final                
};
...
public:
	...
	SMember(FAnimBlueprintGeneratedMutableData)        __AnimBlueprintMutables                                     OFFSET(getStruct<T>, {0x15F8, 36, 0, 0})
	...
	SMember(FAnimNode_ApplyAdditive)                   AnimGraphNode_ApplyAdditive                                 OFFSET(getStruct<T>, {0x1650, 200, 0, 0})
	SMember(FAnimNode_BlendListByEnum)                 AnimGraphNode_BlendListByEnum                               OFFSET(getStruct<T>, {0x1718, 72, 0, 0})
	SMember(FAnimNode_RefPose)                         AnimGraphNode_IdentityPose                                  OFFSET(getStruct<T>, {0x1760, 16, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer                                OFFSET(getStruct<T>, {0x1770, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer1                               OFFSET(getStruct<T>, {0x17B8, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer2                               OFFSET(getStruct<T>, {0x1800, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer3                               OFFSET(getStruct<T>, {0x1848, 72, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose                               OFFSET(getStruct<T>, {0x1890, 176, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer4                               OFFSET(getStruct<T>, {0x1940, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer5                               OFFSET(getStruct<T>, {0x1988, 72, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root1                                         OFFSET(getStruct<T>, {0x19D0, 32, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose                                 OFFSET(getStruct<T>, {0x19F0, 40, 0, 0})
	SMember(FAnimNode_ApplyAdditive)                   AnimGraphNode_ApplyAdditive1                                OFFSET(getStruct<T>, {0x1A18, 200, 0, 0})
	SMember(FAnimNode_BlendSpacePlayer)                AnimGraphNode_BlendSpacePlayer                              OFFSET(getStruct<T>, {0x1AE0, 112, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult                                   OFFSET(getStruct<T>, {0x1B50, 32, 0, 0})
	SMember(FAnimNode_StateMachine)                    AnimGraphNode_StateMachine                                  OFFSET(getStruct<T>, {0x1B70, 200, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult                              OFFSET(getStruct<T>, {0x1C38, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult1                             OFFSET(getStruct<T>, {0x1C60, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult2                             OFFSET(getStruct<T>, {0x1C88, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult3                             OFFSET(getStruct<T>, {0x1CB0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult4                             OFFSET(getStruct<T>, {0x1CD8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult5                             OFFSET(getStruct<T>, {0x1D00, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult6                             OFFSET(getStruct<T>, {0x1D28, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult7                             OFFSET(getStruct<T>, {0x1D50, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult8                             OFFSET(getStruct<T>, {0x1D78, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult9                             OFFSET(getStruct<T>, {0x1DA0, 40, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer6                               OFFSET(getStruct<T>, {0x1DC8, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult1                                  OFFSET(getStruct<T>, {0x1E10, 32, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult10                            OFFSET(getStruct<T>, {0x1E30, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult11                            OFFSET(getStruct<T>, {0x1E58, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult12                            OFFSET(getStruct<T>, {0x1E80, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult13                            OFFSET(getStruct<T>, {0x1EA8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult14                            OFFSET(getStruct<T>, {0x1ED0, 40, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer7                               OFFSET(getStruct<T>, {0x1EF8, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool                               OFFSET(getStruct<T>, {0x1F40, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer8                               OFFSET(getStruct<T>, {0x1F88, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult2                                  OFFSET(getStruct<T>, {0x1FD0, 32, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool1                              OFFSET(getStruct<T>, {0x1FF0, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer9                               OFFSET(getStruct<T>, {0x2038, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer10                              OFFSET(getStruct<T>, {0x2080, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult3                                  OFFSET(getStruct<T>, {0x20C8, 32, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool2                              OFFSET(getStruct<T>, {0x20E8, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer11                              OFFSET(getStruct<T>, {0x2130, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer12                              OFFSET(getStruct<T>, {0x2178, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult4                                  OFFSET(getStruct<T>, {0x21C0, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer13                              OFFSET(getStruct<T>, {0x21E0, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool3                              OFFSET(getStruct<T>, {0x2228, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer14                              OFFSET(getStruct<T>, {0x2270, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult5                                  OFFSET(getStruct<T>, {0x22B8, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer15                              OFFSET(getStruct<T>, {0x22D8, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool4                              OFFSET(getStruct<T>, {0x2320, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer16                              OFFSET(getStruct<T>, {0x2368, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult6                                  OFFSET(getStruct<T>, {0x23B0, 32, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult15                            OFFSET(getStruct<T>, {0x23D0, 40, 0, 0})
	SMember(FAnimNode_StateMachine)                    AnimGraphNode_StateMachine1                                 OFFSET(getStruct<T>, {0x23F8, 200, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult7                                  OFFSET(getStruct<T>, {0x24C0, 32, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult16                            OFFSET(getStruct<T>, {0x24E0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult17                            OFFSET(getStruct<T>, {0x2508, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult18                            OFFSET(getStruct<T>, {0x2530, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult19                            OFFSET(getStruct<T>, {0x2558, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult20                            OFFSET(getStruct<T>, {0x2580, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult21                            OFFSET(getStruct<T>, {0x25A8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult22                            OFFSET(getStruct<T>, {0x25D0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult23                            OFFSET(getStruct<T>, {0x25F8, 40, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer17                              OFFSET(getStruct<T>, {0x2620, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer18                              OFFSET(getStruct<T>, {0x2668, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool5                              OFFSET(getStruct<T>, {0x26B0, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult8                                  OFFSET(getStruct<T>, {0x26F8, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer19                              OFFSET(getStruct<T>, {0x2718, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool6                              OFFSET(getStruct<T>, {0x2760, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer20                              OFFSET(getStruct<T>, {0x27A8, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult9                                  OFFSET(getStruct<T>, {0x27F0, 32, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool7                              OFFSET(getStruct<T>, {0x2810, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer21                              OFFSET(getStruct<T>, {0x2858, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer22                              OFFSET(getStruct<T>, {0x28A0, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult10                                 OFFSET(getStruct<T>, {0x28E8, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer23                              OFFSET(getStruct<T>, {0x2908, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool8                              OFFSET(getStruct<T>, {0x2950, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer24                              OFFSET(getStruct<T>, {0x2998, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult11                                 OFFSET(getStruct<T>, {0x29E0, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer25                              OFFSET(getStruct<T>, {0x2A00, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool9                              OFFSET(getStruct<T>, {0x2A48, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer26                              OFFSET(getStruct<T>, {0x2A90, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult12                                 OFFSET(getStruct<T>, {0x2AD8, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer27                              OFFSET(getStruct<T>, {0x2AF8, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool10                             OFFSET(getStruct<T>, {0x2B40, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer28                              OFFSET(getStruct<T>, {0x2B88, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult13                                 OFFSET(getStruct<T>, {0x2BD0, 32, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool11                             OFFSET(getStruct<T>, {0x2BF0, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer29                              OFFSET(getStruct<T>, {0x2C38, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer30                              OFFSET(getStruct<T>, {0x2C80, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult14                                 OFFSET(getStruct<T>, {0x2CC8, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer31                              OFFSET(getStruct<T>, {0x2CE8, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool12                             OFFSET(getStruct<T>, {0x2D30, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer32                              OFFSET(getStruct<T>, {0x2D78, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult15                                 OFFSET(getStruct<T>, {0x2DC0, 32, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult24                            OFFSET(getStruct<T>, {0x2DE0, 40, 0, 0})
	SMember(FAnimNode_StateMachine)                    AnimGraphNode_StateMachine2                                 OFFSET(getStruct<T>, {0x2E08, 200, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult16                                 OFFSET(getStruct<T>, {0x2ED0, 32, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult25                            OFFSET(getStruct<T>, {0x2EF0, 40, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer33                              OFFSET(getStruct<T>, {0x2F18, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult17                                 OFFSET(getStruct<T>, {0x2F60, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer34                              OFFSET(getStruct<T>, {0x2F80, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult18                                 OFFSET(getStruct<T>, {0x2FC8, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer35                              OFFSET(getStruct<T>, {0x2FE8, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult19                                 OFFSET(getStruct<T>, {0x3030, 32, 0, 0})
	SMember(FAnimNode_StateMachine)                    AnimGraphNode_StateMachine3                                 OFFSET(getStruct<T>, {0x3050, 200, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose                                OFFSET(getStruct<T>, {0x3118, 120, 0, 0})
	SMember(FAnimNode_RotateRootBone)                  AnimGraphNode_RotateRootBone                                OFFSET(getStruct<T>, {0x3190, 176, 0, 0})
	SMember(FAnimNode_BlendSpacePlayer)                AnimGraphNode_BlendSpacePlayer1                             OFFSET(getStruct<T>, {0x3240, 112, 0, 0})
	SMember(FAnimNode_ApplyAdditive)                   AnimGraphNode_ApplyAdditive2                                OFFSET(getStruct<T>, {0x32B0, 200, 0, 0})
	SMember(FAnimNode_DeadBlending)                    AnimGraphNode_DeadBlending                                  OFFSET(getStruct<T>, {0x3380, 1184, 0, 0})
	...
	// void WeaponBoneFixLayer(FPoseLink InPose, FPoseLink& WeaponBoneFixLayer);                                                // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void TacticalSprintLayer(FPoseLink& TacticalSprintLayer);                                                                // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_Player_TacticalState_AnimBP(int32_t EntryPoint);                                                   // [0x1d9241c] Final                
};
...
/// Size: 0x2038 (0x0015E0 - 0x003618)
class UPlayer_FullBodyAimOffsets_AnimBP_C : public UFortPlayerAnimInstanceProxy
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 13848;

public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x15E0, 8, 0, 0})
	SMember(FAnimBlueprintGeneratedMutableData)        __AnimBlueprintMutables                                     OFFSET(getStruct<T>, {0x15E8, 20, 0, 0})
	SMember(FAnimSubsystemInstance)                    AnimBlueprintExtension_PropertyAccess                       OFFSET(getStruct<T>, {0x1600, 8, 0, 0})
	SMember(FAnimSubsystemInstance)                    AnimBlueprintExtension_Base                                 OFFSET(getStruct<T>, {0x1608, 8, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root                                          OFFSET(getStruct<T>, {0x1610, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose                               OFFSET(getStruct<T>, {0x1630, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root1                                         OFFSET(getStruct<T>, {0x16E0, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose1                              OFFSET(getStruct<T>, {0x1700, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root2                                         OFFSET(getStruct<T>, {0x17B0, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose2                              OFFSET(getStruct<T>, {0x17D0, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root3                                         OFFSET(getStruct<T>, {0x1880, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root4                                         OFFSET(getStruct<T>, {0x18A0, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root5                                         OFFSET(getStruct<T>, {0x18C0, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root6                                         OFFSET(getStruct<T>, {0x18E0, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root7                                         OFFSET(getStruct<T>, {0x1900, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root8                                         OFFSET(getStruct<T>, {0x1920, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root9                                         OFFSET(getStruct<T>, {0x1940, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root10                                        OFFSET(getStruct<T>, {0x1960, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose3                              OFFSET(getStruct<T>, {0x1980, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root11                                        OFFSET(getStruct<T>, {0x1A30, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose4                              OFFSET(getStruct<T>, {0x1A50, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root12                                        OFFSET(getStruct<T>, {0x1B00, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root13                                        OFFSET(getStruct<T>, {0x1B20, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root14                                        OFFSET(getStruct<T>, {0x1B40, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root15                                        OFFSET(getStruct<T>, {0x1B60, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose5                              OFFSET(getStruct<T>, {0x1B80, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root16                                        OFFSET(getStruct<T>, {0x1C30, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose6                              OFFSET(getStruct<T>, {0x1C50, 176, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose7                              OFFSET(getStruct<T>, {0x1D00, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root17                                        OFFSET(getStruct<T>, {0x1DB0, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose8                              OFFSET(getStruct<T>, {0x1DD0, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root18                                        OFFSET(getStruct<T>, {0x1E80, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose9                              OFFSET(getStruct<T>, {0x1EA0, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root19                                        OFFSET(getStruct<T>, {0x1F50, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose10                             OFFSET(getStruct<T>, {0x1F70, 176, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose11                             OFFSET(getStruct<T>, {0x2020, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root20                                        OFFSET(getStruct<T>, {0x20D0, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose12                             OFFSET(getStruct<T>, {0x20F0, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root21                                        OFFSET(getStruct<T>, {0x21A0, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose13                             OFFSET(getStruct<T>, {0x21C0, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root22                                        OFFSET(getStruct<T>, {0x2270, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose14                             OFFSET(getStruct<T>, {0x2290, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root23                                        OFFSET(getStruct<T>, {0x2340, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose15                             OFFSET(getStruct<T>, {0x2360, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root24                                        OFFSET(getStruct<T>, {0x2410, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose16                             OFFSET(getStruct<T>, {0x2430, 176, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose17                             OFFSET(getStruct<T>, {0x24E0, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root25                                        OFFSET(getStruct<T>, {0x2590, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose18                             OFFSET(getStruct<T>, {0x25B0, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root26                                        OFFSET(getStruct<T>, {0x2660, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose19                             OFFSET(getStruct<T>, {0x2680, 176, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose20                             OFFSET(getStruct<T>, {0x2730, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root27                                        OFFSET(getStruct<T>, {0x27E0, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose21                             OFFSET(getStruct<T>, {0x2800, 176, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose22                             OFFSET(getStruct<T>, {0x28B0, 176, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose23                             OFFSET(getStruct<T>, {0x2960, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root28                                        OFFSET(getStruct<T>, {0x2A10, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose24                             OFFSET(getStruct<T>, {0x2A30, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root29                                        OFFSET(getStruct<T>, {0x2AE0, 32, 0, 0})
	SMember(FAnimNode_RotationOffsetBlendSpace)        AnimGraphNode_RotationOffsetBlendSpace                      OFFSET(getStruct<T>, {0x2B00, 280, 0, 0})
	SMember(FAnimNode_RotationOffsetBlendSpace)        AnimGraphNode_RotationOffsetBlendSpace1                     OFFSET(getStruct<T>, {0x2C18, 280, 0, 0})
	SMember(FAnimNode_TwoWayBlend)                     AnimGraphNode_TwoWayBlend                                   OFFSET(getStruct<T>, {0x2D30, 192, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose                                OFFSET(getStruct<T>, {0x2DF0, 120, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose25                             OFFSET(getStruct<T>, {0x2E68, 176, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose                                 OFFSET(getStruct<T>, {0x2F18, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose1                                OFFSET(getStruct<T>, {0x2F40, 40, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root30                                        OFFSET(getStruct<T>, {0x2F68, 32, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose2                                OFFSET(getStruct<T>, {0x2F88, 40, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose1                               OFFSET(getStruct<T>, {0x2FB0, 120, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer                               OFFSET(getStruct<T>, {0x3028, 200, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer1                              OFFSET(getStruct<T>, {0x30F0, 200, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose3                                OFFSET(getStruct<T>, {0x31B8, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose4                                OFFSET(getStruct<T>, {0x31E0, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose5                                OFFSET(getStruct<T>, {0x3208, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose6                                OFFSET(getStruct<T>, {0x3230, 40, 0, 0})
	SMember(FAnimNode_ResetRoot)                       AnimGraphNode_ResetRoot                                     OFFSET(getStruct<T>, {0x3258, 216, 0, 0})
	SMember(FAnimNode_ConvertComponentToLocalSpace)    AnimGraphNode_ComponentToLocalSpace                         OFFSET(getStruct<T>, {0x3330, 32, 0, 0})
	SMember(FAnimNode_ConvertLocalToComponentSpace)    AnimGraphNode_LocalToComponentSpace                         OFFSET(getStruct<T>, {0x3350, 32, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose2                               OFFSET(getStruct<T>, {0x3370, 120, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose7                                OFFSET(getStruct<T>, {0x33E8, 40, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose3                               OFFSET(getStruct<T>, {0x3410, 120, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose26                             OFFSET(getStruct<T>, {0x3488, 176, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer2                              OFFSET(getStruct<T>, {0x3538, 200, 0, 0})
	DMember(double)                                    __CustomProperty_Pitch_61C65E4944F5DB18DC8B6496B9622A88     OFFSET(get<double>, {0x3600, 8, 0, 0})
	DMember(double)                                    __CustomProperty_Yaw_61C65E4944F5DB18DC8B6496B9622A88       OFFSET(get<double>, {0x3608, 8, 0, 0})
	DMember(double)                                    __CustomProperty_AimOffsetAlpha_61C65E4944F5DB18DC8B6496B9622A88 OFFSET(get<double>, {0x3610, 8, 0, 0})
	...
	// void VehicleFullBodyOverride(FPoseLink InPoseFullBody, FPoseLink& VehicleFullBodyOverride);                              // [0x1d9241c] HasOutParms|BlueprintCallable 
	...
	// void VehicleLowerBodyOverride(FPoseLink InPoseLowerBodyDefault, FPoseLink InPoseUpperBody, FPoseLink& VehicleLowerBodyOverride); // [0x1d9241c] HasOutParms|BlueprintCallable 
	...
	// void VehicleSplitBodyOverride(FPoseLink InPoseSplitBody, FPoseLink InPoseUpperAndLowerBody, FPoseLink InPoseUpperAndLowerBodyRemoveRoot, FPoseLink& VehicleSplitBodyOverride); // [0x1d9241c] HasOutParms|BlueprintCallable 
	...
	// void VehicleFinalPoseOverride(FPoseLink InFinalPose, FPoseLink& VehicleFinalPoseOverride);                               // [0x1d9241c] HasOutParms|BlueprintCallable 
	...
	// void FullBodyAimingOffsetsLayer(FPoseLink InFullBodyAimOffsetsBasePose, FPoseLink& FullBodyAimingOffsetsLayer);          // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_Player_FullBodyAimOffsets_AnimBP(int32_t EntryPoint);                                              // [0x1d9241c] Final                
};
...
public:
	...
	// void ExecuteUbergraph_Player_DBNO_AnimBP(int32_t EntryPoint);                                                            // [0x1d9241c] Final                
};
...
public:
	...
	// void ExecuteUbergraph_Player_DBNOCarried_AnimBP(int32_t EntryPoint);                                                     // [0x1d9241c] Final                
};
...
public:
	...
	// void FullBodyOverride(FPoseLink PassThroughFullBodyPose, FPoseLink& FullBodyOverride);                                   // [0x1d9241c] HasOutParms|BlueprintCallable 
	...
	// void CharacterSkeletalControlPostLegIK(FPoseLink InPosePostLegIK, FPoseLink& CharacterSkeletalControlPostLegIK);         // [0x1d9241c] HasOutParms|BlueprintCallable 
	...
	// void PostIKAdjustmentsLayer(FPoseLink InPosePostIkAdjustments, FPoseLink& PostIKAdjustmentsLayer);                       // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void PreIKAdjustmentsLayer(FPoseLink InPosePreIKAdjustments, FPoseLink& PreIKAdjustmentsLayer);                          // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void PlevisAndFeetAdjustmentsLayer(FPoseLink InPosePelvisAndFeetAdjustments, FPoseLink& PlevisAndFeetAdjustmentsLayer);  // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void PushCannonAdjustmentsLayer(FPoseLink InPosePushCannonAdjustments, FPoseLink& PushCannonAdjustmentsLayer);           // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ParaGliderAdjustmentsLayer(FPoseLink InPoseParaGliderAdjustments, FPoseLink& ParaGliderAdjustmentsLayer);           // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void HandIKFixUpLayer(FPoseLink InPoseHandIk, FPoseLink& HandIKFixUpLayer);                                              // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void AnimGraph(FPoseLink InPosePostTurnInPlace, FPoseLink& AnimGraph);                                                   // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_Player_ProceduralAdjustments_AnimBP(int32_t EntryPoint);                                           // [0x1d9241c] Final                
};
...
/// Size: 0x9168 (0x001920 - 0x00AA88)
class UFortnite_M_Avg_Player_AnimBlueprint_C : public UFortPlayerAnimInstance
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 43656;

public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x1920, 8, 0, 0})
	SMember(FAnimBlueprintGeneratedMutableData)        __AnimBlueprintMutables                                     OFFSET(getStruct<T>, {0x1928, 216, 0, 0})
	SMember(FAnimSubsystemInstance)                    AnimBlueprintExtension_Tag                                  OFFSET(getStruct<T>, {0x1A00, 8, 0, 0})
	SMember(FAnimSubsystem_SharedLinkedAnimLayers)     AnimBlueprintExtension_SharedLinkedAnimLayers               OFFSET(getStruct<T>, {0x1A08, 40, 0, 0})
	SMember(FAnimSubsystemInstance)                    AnimBlueprintExtension_PropertyAccess                       OFFSET(getStruct<T>, {0x1A30, 8, 0, 0})
	SMember(FAnimSubsystemInstance)                    AnimBlueprintExtension_Base                                 OFFSET(getStruct<T>, {0x1A38, 8, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose                               OFFSET(getStruct<T>, {0x1A40, 176, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose1                              OFFSET(getStruct<T>, {0x1AF0, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root                                          OFFSET(getStruct<T>, {0x1BA0, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose2                              OFFSET(getStruct<T>, {0x1BC0, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root1                                         OFFSET(getStruct<T>, {0x1C70, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose3                              OFFSET(getStruct<T>, {0x1C90, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root2                                         OFFSET(getStruct<T>, {0x1D40, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose4                              OFFSET(getStruct<T>, {0x1D60, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root3                                         OFFSET(getStruct<T>, {0x1E10, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose5                              OFFSET(getStruct<T>, {0x1E30, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root4                                         OFFSET(getStruct<T>, {0x1EE0, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose6                              OFFSET(getStruct<T>, {0x1F00, 176, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose7                              OFFSET(getStruct<T>, {0x1FB0, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root5                                         OFFSET(getStruct<T>, {0x2060, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose8                              OFFSET(getStruct<T>, {0x2080, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root6                                         OFFSET(getStruct<T>, {0x2130, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose9                              OFFSET(getStruct<T>, {0x2150, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root7                                         OFFSET(getStruct<T>, {0x2200, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose10                             OFFSET(getStruct<T>, {0x2220, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root8                                         OFFSET(getStruct<T>, {0x22D0, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose11                             OFFSET(getStruct<T>, {0x22F0, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root9                                         OFFSET(getStruct<T>, {0x23A0, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose12                             OFFSET(getStruct<T>, {0x23C0, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root10                                        OFFSET(getStruct<T>, {0x2470, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose13                             OFFSET(getStruct<T>, {0x2490, 176, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose14                             OFFSET(getStruct<T>, {0x2540, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root11                                        OFFSET(getStruct<T>, {0x25F0, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose15                             OFFSET(getStruct<T>, {0x2610, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root12                                        OFFSET(getStruct<T>, {0x26C0, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root13                                        OFFSET(getStruct<T>, {0x26E0, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root14                                        OFFSET(getStruct<T>, {0x2700, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root15                                        OFFSET(getStruct<T>, {0x2720, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose16                             OFFSET(getStruct<T>, {0x2740, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root16                                        OFFSET(getStruct<T>, {0x27F0, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose17                             OFFSET(getStruct<T>, {0x2810, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root17                                        OFFSET(getStruct<T>, {0x28C0, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root18                                        OFFSET(getStruct<T>, {0x28E0, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root19                                        OFFSET(getStruct<T>, {0x2900, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root20                                        OFFSET(getStruct<T>, {0x2920, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root21                                        OFFSET(getStruct<T>, {0x2940, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root22                                        OFFSET(getStruct<T>, {0x2960, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root23                                        OFFSET(getStruct<T>, {0x2980, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root24                                        OFFSET(getStruct<T>, {0x29A0, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose18                             OFFSET(getStruct<T>, {0x29C0, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root25                                        OFFSET(getStruct<T>, {0x2A70, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose19                             OFFSET(getStruct<T>, {0x2A90, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root26                                        OFFSET(getStruct<T>, {0x2B40, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose20                             OFFSET(getStruct<T>, {0x2B60, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root27                                        OFFSET(getStruct<T>, {0x2C10, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose21                             OFFSET(getStruct<T>, {0x2C30, 176, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose22                             OFFSET(getStruct<T>, {0x2CE0, 176, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose23                             OFFSET(getStruct<T>, {0x2D90, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root28                                        OFFSET(getStruct<T>, {0x2E40, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose24                             OFFSET(getStruct<T>, {0x2E60, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root29                                        OFFSET(getStruct<T>, {0x2F10, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_SubInput                                      OFFSET(getStruct<T>, {0x2F30, 176, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose25                             OFFSET(getStruct<T>, {0x2FE0, 176, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root30                                        OFFSET(getStruct<T>, {0x3090, 32, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool                               OFFSET(getStruct<T>, {0x30B0, 72, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose26                             OFFSET(getStruct<T>, {0x30F8, 176, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose                                OFFSET(getStruct<T>, {0x31A8, 120, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose                                 OFFSET(getStruct<T>, {0x3220, 40, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph                               OFFSET(getStruct<T>, {0x3248, 184, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose1                                OFFSET(getStruct<T>, {0x3300, 40, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root31                                        OFFSET(getStruct<T>, {0x3328, 32, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot                                          OFFSET(getStruct<T>, {0x3348, 72, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose2                                OFFSET(getStruct<T>, {0x3390, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose3                                OFFSET(getStruct<T>, {0x33B8, 40, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot1                                         OFFSET(getStruct<T>, {0x33E0, 72, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult                              OFFSET(getStruct<T>, {0x3428, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult1                             OFFSET(getStruct<T>, {0x3450, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult2                             OFFSET(getStruct<T>, {0x3478, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult3                             OFFSET(getStruct<T>, {0x34A0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult4                             OFFSET(getStruct<T>, {0x34C8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult5                             OFFSET(getStruct<T>, {0x34F0, 40, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer                                OFFSET(getStruct<T>, {0x3518, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult                                   OFFSET(getStruct<T>, {0x3560, 32, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer                               OFFSET(getStruct<T>, {0x3580, 200, 0, 0})
	SMember(FAnimNode_RefPose)                         AnimGraphNode_LocalRefPose                                  OFFSET(getStruct<T>, {0x3648, 16, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult1                                  OFFSET(getStruct<T>, {0x3658, 32, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose4                                OFFSET(getStruct<T>, {0x3678, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose5                                OFFSET(getStruct<T>, {0x36A0, 40, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool1                              OFFSET(getStruct<T>, {0x36C8, 72, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot2                                         OFFSET(getStruct<T>, {0x3710, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult2                                  OFFSET(getStruct<T>, {0x3758, 32, 0, 0})
	SMember(FAnimNode_StateMachine)                    AnimGraphNode_StateMachine                                  OFFSET(getStruct<T>, {0x3778, 200, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose1                               OFFSET(getStruct<T>, {0x3840, 120, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose2                               OFFSET(getStruct<T>, {0x38B8, 120, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer1                              OFFSET(getStruct<T>, {0x3930, 200, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph1                              OFFSET(getStruct<T>, {0x39F8, 184, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool2                              OFFSET(getStruct<T>, {0x3AB0, 72, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph2                              OFFSET(getStruct<T>, {0x3AF8, 184, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer2                              OFFSET(getStruct<T>, {0x3BB0, 200, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool3                              OFFSET(getStruct<T>, {0x3C78, 72, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer3                              OFFSET(getStruct<T>, {0x3CC0, 200, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose3                               OFFSET(getStruct<T>, {0x3D88, 120, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose6                                OFFSET(getStruct<T>, {0x3E00, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose7                                OFFSET(getStruct<T>, {0x3E28, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose8                                OFFSET(getStruct<T>, {0x3E50, 40, 0, 0})
	SMember(FAnimNode_LayeredBoneBlend)                AnimGraphNode_LayeredBoneBlend                              OFFSET(getStruct<T>, {0x3E78, 240, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose4                               OFFSET(getStruct<T>, {0x3F68, 120, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose9                                OFFSET(getStruct<T>, {0x3FE0, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose10                               OFFSET(getStruct<T>, {0x4008, 40, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot3                                         OFFSET(getStruct<T>, {0x4030, 72, 0, 0})
	SMember(FAnimNode_LayeredBoneBlend)                AnimGraphNode_LayeredBoneBlend1                             OFFSET(getStruct<T>, {0x4078, 240, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_Layer                                         OFFSET(getStruct<T>, {0x4168, 200, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer4                              OFFSET(getStruct<T>, {0x4230, 200, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root32                                        OFFSET(getStruct<T>, {0x42F8, 32, 0, 0})
	SMember(FAnimNode_LayeredBoneBlend)                AnimGraphNode_LayeredBoneBlend2                             OFFSET(getStruct<T>, {0x4318, 240, 0, 0})
	SMember(FAnimNode_ApplyAdditive)                   AnimGraphNode_ApplyAdditive                                 OFFSET(getStruct<T>, {0x4408, 200, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose11                               OFFSET(getStruct<T>, {0x44D0, 40, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer1                               OFFSET(getStruct<T>, {0x44F8, 72, 0, 0})
	SMember(FAnimNode_LayeredBoneBlend)                AnimGraphNode_LayeredBoneBlend3                             OFFSET(getStruct<T>, {0x4540, 240, 0, 0})
	SMember(FAnimNode_BlendListByEnum)                 AnimGraphNode_BlendListByEnum                               OFFSET(getStruct<T>, {0x4630, 72, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot4                                         OFFSET(getStruct<T>, {0x4678, 72, 0, 0})
	SMember(FAnimNode_ApplyAdditive)                   AnimGraphNode_ApplyAdditive1                                OFFSET(getStruct<T>, {0x46C0, 200, 0, 0})
	SMember(FAnimNode_ApplyAdditive)                   AnimGraphNode_ApplyAdditive2                                OFFSET(getStruct<T>, {0x4788, 200, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose12                               OFFSET(getStruct<T>, {0x4850, 40, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool4                              OFFSET(getStruct<T>, {0x4878, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer2                               OFFSET(getStruct<T>, {0x48C0, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer3                               OFFSET(getStruct<T>, {0x4908, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool5                              OFFSET(getStruct<T>, {0x4950, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool6                              OFFSET(getStruct<T>, {0x4998, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer4                               OFFSET(getStruct<T>, {0x49E0, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer5                               OFFSET(getStruct<T>, {0x4A28, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer6                               OFFSET(getStruct<T>, {0x4A70, 72, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose27                             OFFSET(getStruct<T>, {0x4AB8, 176, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose5                               OFFSET(getStruct<T>, {0x4B68, 120, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose13                               OFFSET(getStruct<T>, {0x4BE0, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose14                               OFFSET(getStruct<T>, {0x4C08, 40, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose28                             OFFSET(getStruct<T>, {0x4C30, 176, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose6                               OFFSET(getStruct<T>, {0x4CE0, 120, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root33                                        OFFSET(getStruct<T>, {0x4D58, 32, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot5                                         OFFSET(getStruct<T>, {0x4D78, 72, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot6                                         OFFSET(getStruct<T>, {0x4DC0, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool7                              OFFSET(getStruct<T>, {0x4E08, 72, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose15                               OFFSET(getStruct<T>, {0x4E50, 40, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot7                                         OFFSET(getStruct<T>, {0x4E78, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer7                               OFFSET(getStruct<T>, {0x4EC0, 72, 0, 0})
	SMember(FAnimNode_LayeredBoneBlend)                AnimGraphNode_LayeredBoneBlend4                             OFFSET(getStruct<T>, {0x4F08, 240, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer8                               OFFSET(getStruct<T>, {0x4FF8, 72, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose16                               OFFSET(getStruct<T>, {0x5040, 40, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool8                              OFFSET(getStruct<T>, {0x5068, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer9                               OFFSET(getStruct<T>, {0x50B0, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool9                              OFFSET(getStruct<T>, {0x50F8, 72, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose29                             OFFSET(getStruct<T>, {0x5140, 176, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose7                               OFFSET(getStruct<T>, {0x51F0, 120, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose17                               OFFSET(getStruct<T>, {0x5268, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose18                               OFFSET(getStruct<T>, {0x5290, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose19                               OFFSET(getStruct<T>, {0x52B8, 40, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool10                             OFFSET(getStruct<T>, {0x52E0, 72, 0, 0})
	SMember(FAnimNode_LayeredBoneBlend)                AnimGraphNode_LayeredBoneBlend5                             OFFSET(getStruct<T>, {0x5328, 240, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose8                               OFFSET(getStruct<T>, {0x5418, 120, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot8                                         OFFSET(getStruct<T>, {0x5490, 72, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose20                               OFFSET(getStruct<T>, {0x54D8, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose21                               OFFSET(getStruct<T>, {0x5500, 40, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool11                             OFFSET(getStruct<T>, {0x5528, 72, 0, 0})
	SMember(FAnimNode_LayeredBoneBlend)                AnimGraphNode_LayeredBoneBlend6                             OFFSET(getStruct<T>, {0x5570, 240, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root34                                        OFFSET(getStruct<T>, {0x5660, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose30                             OFFSET(getStruct<T>, {0x5680, 176, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool12                             OFFSET(getStruct<T>, {0x5730, 72, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph3                              OFFSET(getStruct<T>, {0x5778, 184, 0, 0})
	SMember(FAnimNode_ApplyAdditive)                   AnimGraphNode_ApplyAdditive3                                OFFSET(getStruct<T>, {0x5830, 200, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose9                               OFFSET(getStruct<T>, {0x58F8, 120, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose22                               OFFSET(getStruct<T>, {0x5970, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose23                               OFFSET(getStruct<T>, {0x5998, 40, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root35                                        OFFSET(getStruct<T>, {0x59C0, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose31                             OFFSET(getStruct<T>, {0x59E0, 176, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose10                              OFFSET(getStruct<T>, {0x5A90, 120, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph4                              OFFSET(getStruct<T>, {0x5B08, 184, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose24                               OFFSET(getStruct<T>, {0x5BC0, 40, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool13                             OFFSET(getStruct<T>, {0x5BE8, 72, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose25                               OFFSET(getStruct<T>, {0x5C30, 40, 0, 0})
	SMember(FAnimNode_LayeredBoneBlend)                AnimGraphNode_LayeredBoneBlend7                             OFFSET(getStruct<T>, {0x5C58, 240, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root36                                        OFFSET(getStruct<T>, {0x5D48, 32, 0, 0})
	SMember(FAnimNode_LayeredBoneBlend)                AnimGraphNode_LayeredBoneBlend8                             OFFSET(getStruct<T>, {0x5D68, 240, 0, 0})
	SMember(FAnimNode_RefPose)                         AnimGraphNode_IdentityPose                                  OFFSET(getStruct<T>, {0x5E58, 16, 0, 0})
	SMember(FAnimNode_LayeredBoneBlend)                AnimGraphNode_LayeredBoneBlend9                             OFFSET(getStruct<T>, {0x5E68, 240, 0, 0})
	SMember(FAnimNode_RefPose)                         AnimGraphNode_IdentityPose1                                 OFFSET(getStruct<T>, {0x5F58, 16, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot9                                         OFFSET(getStruct<T>, {0x5F68, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool14                             OFFSET(getStruct<T>, {0x5FB0, 72, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph5                              OFFSET(getStruct<T>, {0x5FF8, 184, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult6                             OFFSET(getStruct<T>, {0x60B0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult7                             OFFSET(getStruct<T>, {0x60D8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult8                             OFFSET(getStruct<T>, {0x6100, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult9                             OFFSET(getStruct<T>, {0x6128, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult10                            OFFSET(getStruct<T>, {0x6150, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult11                            OFFSET(getStruct<T>, {0x6178, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult12                            OFFSET(getStruct<T>, {0x61A0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult13                            OFFSET(getStruct<T>, {0x61C8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult14                            OFFSET(getStruct<T>, {0x61F0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult15                            OFFSET(getStruct<T>, {0x6218, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult16                            OFFSET(getStruct<T>, {0x6240, 40, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph6                              OFFSET(getStruct<T>, {0x6268, 184, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult3                                  OFFSET(getStruct<T>, {0x6320, 32, 0, 0})
	SMember(FAnimNode_BlendSpacePlayer)                AnimGraphNode_BlendSpacePlayer                              OFFSET(getStruct<T>, {0x6340, 112, 0, 0})
	SMember(FAnimNode_BlendSpacePlayer)                AnimGraphNode_BlendSpacePlayer1                             OFFSET(getStruct<T>, {0x63B0, 112, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool15                             OFFSET(getStruct<T>, {0x6420, 72, 0, 0})
	SMember(FAnimNode_BlendSpacePlayer)                AnimGraphNode_BlendSpacePlayer2                             OFFSET(getStruct<T>, {0x6468, 112, 0, 0})
	SMember(FAnimNode_BlendSpacePlayer)                AnimGraphNode_BlendSpacePlayer3                             OFFSET(getStruct<T>, {0x64D8, 112, 0, 0})
	SMember(FAnimNode_BlendListByEnum)                 AnimGraphNode_BlendListByEnum1                              OFFSET(getStruct<T>, {0x6548, 72, 0, 0})
	SMember(FAnimNode_BlendSpacePlayer)                AnimGraphNode_BlendSpacePlayer4                             OFFSET(getStruct<T>, {0x6590, 112, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer10                              OFFSET(getStruct<T>, {0x6600, 72, 0, 0})
	SMember(FAnimNode_ApplyAdditive)                   AnimGraphNode_ApplyAdditive4                                OFFSET(getStruct<T>, {0x6648, 200, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult4                                  OFFSET(getStruct<T>, {0x6710, 32, 0, 0})
	SMember(FAnimNode_RefPose)                         AnimGraphNode_IdentityPose2                                 OFFSET(getStruct<T>, {0x6730, 16, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult5                                  OFFSET(getStruct<T>, {0x6740, 32, 0, 0})
	SMember(FAnimNode_StateMachine)                    AnimGraphNode_StateMachine1                                 OFFSET(getStruct<T>, {0x6760, 200, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose32                             OFFSET(getStruct<T>, {0x6828, 176, 0, 0})
	SMember(FAnimNode_ApplyAdditive)                   AnimGraphNode_ApplyAdditive5                                OFFSET(getStruct<T>, {0x68D8, 200, 0, 0})
	SMember(FAnimNode_ConvertLocalToComponentSpace)    AnimGraphNode_LocalToComponentSpace                         OFFSET(getStruct<T>, {0x69A0, 32, 0, 0})
	SMember(FAnimNode_HandIKRetargeting)               AnimGraphNode_HandIKRetargeting                             OFFSET(getStruct<T>, {0x69C0, 272, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot10                                        OFFSET(getStruct<T>, {0x6AD0, 72, 0, 0})
	SMember(FAnimNode_ConvertComponentToLocalSpace)    AnimGraphNode_ComponentToLocalSpace                         OFFSET(getStruct<T>, {0x6B18, 32, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root37                                        OFFSET(getStruct<T>, {0x6B38, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose33                             OFFSET(getStruct<T>, {0x6B58, 176, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose11                              OFFSET(getStruct<T>, {0x6C08, 120, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose26                               OFFSET(getStruct<T>, {0x6C80, 40, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose12                              OFFSET(getStruct<T>, {0x6CA8, 120, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph7                              OFFSET(getStruct<T>, {0x6D20, 184, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose27                               OFFSET(getStruct<T>, {0x6DD8, 40, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_Layer1                                        OFFSET(getStruct<T>, {0x6E00, 200, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer5                              OFFSET(getStruct<T>, {0x6EC8, 200, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph8                              OFFSET(getStruct<T>, {0x6F90, 184, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose28                               OFFSET(getStruct<T>, {0x7048, 40, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer6                              OFFSET(getStruct<T>, {0x7070, 200, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose13                              OFFSET(getStruct<T>, {0x7138, 120, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose29                               OFFSET(getStruct<T>, {0x71B0, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose30                               OFFSET(getStruct<T>, {0x71D8, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose31                               OFFSET(getStruct<T>, {0x7200, 40, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot11                                        OFFSET(getStruct<T>, {0x7228, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool16                             OFFSET(getStruct<T>, {0x7270, 72, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose32                               OFFSET(getStruct<T>, {0x72B8, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose33                               OFFSET(getStruct<T>, {0x72E0, 40, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose14                              OFFSET(getStruct<T>, {0x7308, 120, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root38                                        OFFSET(getStruct<T>, {0x7380, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose34                             OFFSET(getStruct<T>, {0x73A0, 176, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose35                             OFFSET(getStruct<T>, {0x7450, 176, 0, 0})
	SMember(FAnimNode_RotateRootBone)                  AnimGraphNode_RotateRootBone                                OFFSET(getStruct<T>, {0x7500, 176, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool17                             OFFSET(getStruct<T>, {0x75B0, 72, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose15                              OFFSET(getStruct<T>, {0x75F8, 120, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose34                               OFFSET(getStruct<T>, {0x7670, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose35                               OFFSET(getStruct<T>, {0x7698, 40, 0, 0})
	SMember(FAnimNode_LayeredBoneBlend)                AnimGraphNode_LayeredBoneBlend10                            OFFSET(getStruct<T>, {0x76C0, 240, 0, 0})
	SMember(FAnimNode_RefPose)                         AnimGraphNode_LocalRefPose1                                 OFFSET(getStruct<T>, {0x77B0, 16, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool18                             OFFSET(getStruct<T>, {0x77C0, 72, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root39                                        OFFSET(getStruct<T>, {0x7808, 32, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose36                             OFFSET(getStruct<T>, {0x7828, 176, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot12                                        OFFSET(getStruct<T>, {0x78D8, 72, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose16                              OFFSET(getStruct<T>, {0x7920, 120, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot13                                        OFFSET(getStruct<T>, {0x7998, 72, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose17                              OFFSET(getStruct<T>, {0x79E0, 120, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose36                               OFFSET(getStruct<T>, {0x7A58, 40, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool19                             OFFSET(getStruct<T>, {0x7A80, 72, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose37                               OFFSET(getStruct<T>, {0x7AC8, 40, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot14                                        OFFSET(getStruct<T>, {0x7AF0, 72, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose38                               OFFSET(getStruct<T>, {0x7B38, 40, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot15                                        OFFSET(getStruct<T>, {0x7B60, 72, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose18                              OFFSET(getStruct<T>, {0x7BA8, 120, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose39                               OFFSET(getStruct<T>, {0x7C20, 40, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool20                             OFFSET(getStruct<T>, {0x7C48, 72, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer7                              OFFSET(getStruct<T>, {0x7C90, 200, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose40                               OFFSET(getStruct<T>, {0x7D58, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose41                               OFFSET(getStruct<T>, {0x7D80, 40, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose19                              OFFSET(getStruct<T>, {0x7DA8, 120, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose42                               OFFSET(getStruct<T>, {0x7E20, 40, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root40                                        OFFSET(getStruct<T>, {0x7E48, 32, 0, 0})
	SMember(FAnimNode_RotationOffsetBlendSpace)        AnimGraphNode_RotationOffsetBlendSpace                      OFFSET(getStruct<T>, {0x7E68, 280, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool21                             OFFSET(getStruct<T>, {0x7F80, 72, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool22                             OFFSET(getStruct<T>, {0x7FC8, 72, 0, 0})
	SMember(FAnimNode_RotationOffsetBlendSpace)        AnimGraphNode_RotationOffsetBlendSpace1                     OFFSET(getStruct<T>, {0x8010, 280, 0, 0})
	SMember(FAnimNode_RotationOffsetBlendSpace)        AnimGraphNode_RotationOffsetBlendSpace2                     OFFSET(getStruct<T>, {0x8128, 280, 0, 0})
	SMember(FAnimNode_LinkedInputPose)                 AnimGraphNode_LinkedInputPose37                             OFFSET(getStruct<T>, {0x8240, 176, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose20                              OFFSET(getStruct<T>, {0x82F0, 120, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose43                               OFFSET(getStruct<T>, {0x8368, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose44                               OFFSET(getStruct<T>, {0x8390, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose45                               OFFSET(getStruct<T>, {0x83B8, 40, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root41                                        OFFSET(getStruct<T>, {0x83E0, 32, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose21                              OFFSET(getStruct<T>, {0x8400, 120, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult17                            OFFSET(getStruct<T>, {0x8478, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult18                            OFFSET(getStruct<T>, {0x84A0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult19                            OFFSET(getStruct<T>, {0x84C8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult20                            OFFSET(getStruct<T>, {0x84F0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult21                            OFFSET(getStruct<T>, {0x8518, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult22                            OFFSET(getStruct<T>, {0x8540, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult23                            OFFSET(getStruct<T>, {0x8568, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult24                            OFFSET(getStruct<T>, {0x8590, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult25                            OFFSET(getStruct<T>, {0x85B8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult26                            OFFSET(getStruct<T>, {0x85E0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult27                            OFFSET(getStruct<T>, {0x8608, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult28                            OFFSET(getStruct<T>, {0x8630, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult29                            OFFSET(getStruct<T>, {0x8658, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult30                            OFFSET(getStruct<T>, {0x8680, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult31                            OFFSET(getStruct<T>, {0x86A8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult32                            OFFSET(getStruct<T>, {0x86D0, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult33                            OFFSET(getStruct<T>, {0x86F8, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult34                            OFFSET(getStruct<T>, {0x8720, 40, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult35                            OFFSET(getStruct<T>, {0x8748, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose46                               OFFSET(getStruct<T>, {0x8770, 40, 0, 0})
	SMember(FAnimNode_RefPose)                         AnimGraphNode_LocalRefPose2                                 OFFSET(getStruct<T>, {0x8798, 16, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool23                             OFFSET(getStruct<T>, {0x87A8, 72, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph9                              OFFSET(getStruct<T>, {0x87F0, 184, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph10                             OFFSET(getStruct<T>, {0x88A8, 184, 0, 0})
	SMember(FAnimNode_TwoWayBlend)                     AnimGraphNode_TwoWayBlend                                   OFFSET(getStruct<T>, {0x8960, 192, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose47                               OFFSET(getStruct<T>, {0x8A20, 40, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer8                              OFFSET(getStruct<T>, {0x8A48, 200, 0, 0})
	SMember(FAnimNode_ApplyAdditive)                   AnimGraphNode_ApplyAdditive6                                OFFSET(getStruct<T>, {0x8B10, 200, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult6                                  OFFSET(getStruct<T>, {0x8BD8, 32, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose48                               OFFSET(getStruct<T>, {0x8BF8, 40, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph11                             OFFSET(getStruct<T>, {0x8C20, 184, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult7                                  OFFSET(getStruct<T>, {0x8CD8, 32, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult36                            OFFSET(getStruct<T>, {0x8CF8, 40, 0, 0})
	SMember(FAnimNode_StateMachine)                    AnimGraphNode_StateMachine2                                 OFFSET(getStruct<T>, {0x8D20, 200, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult8                                  OFFSET(getStruct<T>, {0x8DE8, 32, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph12                             OFFSET(getStruct<T>, {0x8E08, 184, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult9                                  OFFSET(getStruct<T>, {0x8EC0, 32, 0, 0})
	SMember(FAnimNode_TransitionResult)                AnimGraphNode_TransitionResult37                            OFFSET(getStruct<T>, {0x8EE0, 40, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer11                              OFFSET(getStruct<T>, {0x8F08, 72, 0, 0})
	SMember(FAnimNode_BlendListByEnum)                 AnimGraphNode_BlendListByEnum2                              OFFSET(getStruct<T>, {0x8F50, 72, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer12                              OFFSET(getStruct<T>, {0x8F98, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult10                                 OFFSET(getStruct<T>, {0x8FE0, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer13                              OFFSET(getStruct<T>, {0x9000, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult11                                 OFFSET(getStruct<T>, {0x9048, 32, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph13                             OFFSET(getStruct<T>, {0x9068, 184, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult12                                 OFFSET(getStruct<T>, {0x9120, 32, 0, 0})
	SMember(FAnimNode_SequencePlayer)                  AnimGraphNode_SequencePlayer14                              OFFSET(getStruct<T>, {0x9140, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult13                                 OFFSET(getStruct<T>, {0x9188, 32, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph14                             OFFSET(getStruct<T>, {0x91A8, 184, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult14                                 OFFSET(getStruct<T>, {0x9260, 32, 0, 0})
	SMember(FAnimNode_StateMachine)                    AnimGraphNode_StateMachine3                                 OFFSET(getStruct<T>, {0x9280, 200, 0, 0})
	SMember(FAnimNode_Root)                            AnimGraphNode_Root42                                        OFFSET(getStruct<T>, {0x9348, 32, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose22                              OFFSET(getStruct<T>, {0x9368, 120, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_Layer2                                        OFFSET(getStruct<T>, {0x93E0, 200, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer9                              OFFSET(getStruct<T>, {0x94A8, 200, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose23                              OFFSET(getStruct<T>, {0x9570, 120, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer10                             OFFSET(getStruct<T>, {0x95E8, 200, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer11                             OFFSET(getStruct<T>, {0x96B0, 200, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose49                               OFFSET(getStruct<T>, {0x9778, 40, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph15                             OFFSET(getStruct<T>, {0x97A0, 184, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool24                             OFFSET(getStruct<T>, {0x9858, 72, 0, 0})
	SMember(FFortAnimNode_ScaleCharacterBones)         FortAnimGraphNode_ScaleCharacterBones                       OFFSET(getStruct<T>, {0x98A0, 216, 0, 0})
	SMember(FAnimNode_Inertialization)                 AnimGraphNode_Inertialization                               OFFSET(getStruct<T>, {0x9978, 272, 0, 0})
	SMember(FAnimNode_ConvertLocalToComponentSpace)    AnimGraphNode_LocalToComponentSpace1                        OFFSET(getStruct<T>, {0x9A88, 32, 0, 0})
	SMember(FAnimNode_ConvertComponentToLocalSpace)    AnimGraphNode_ComponentToLocalSpace1                        OFFSET(getStruct<T>, {0x9AA8, 32, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer12                             OFFSET(getStruct<T>, {0x9AC8, 200, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer13                             OFFSET(getStruct<T>, {0x9B90, 200, 0, 0})
	SMember(FAnimNode_BlendListByBool)                 AnimGraphNode_BlendListByBool25                             OFFSET(getStruct<T>, {0x9C58, 72, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose24                              OFFSET(getStruct<T>, {0x9CA0, 120, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer14                             OFFSET(getStruct<T>, {0x9D18, 200, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer15                             OFFSET(getStruct<T>, {0x9DE0, 200, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose50                               OFFSET(getStruct<T>, {0x9EA8, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose51                               OFFSET(getStruct<T>, {0x9ED0, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose52                               OFFSET(getStruct<T>, {0x9EF8, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose53                               OFFSET(getStruct<T>, {0x9F20, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose54                               OFFSET(getStruct<T>, {0x9F48, 40, 0, 0})
	SMember(FAnimNode_BlendListByInt)                  AnimGraphNode_BlendListByInt                                OFFSET(getStruct<T>, {0x9F70, 72, 0, 0})
	SMember(FAnimNode_StateResult)                     AnimGraphNode_StateResult15                                 OFFSET(getStruct<T>, {0x9FB8, 32, 0, 0})
	SMember(FAnimNode_StateMachine)                    AnimGraphNode_StateMachine4                                 OFFSET(getStruct<T>, {0x9FD8, 200, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer16                             OFFSET(getStruct<T>, {0xA0A0, 200, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer17                             OFFSET(getStruct<T>, {0xA168, 200, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer18                             OFFSET(getStruct<T>, {0xA230, 200, 0, 0})
	SMember(FAnimNode_LinkedAnimGraph)                 AnimGraphNode_LinkedAnimGraph16                             OFFSET(getStruct<T>, {0xA2F8, 184, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer19                             OFFSET(getStruct<T>, {0xA3B0, 200, 0, 0})
	SMember(FAnimNode_LinkedAnimLayer)                 AnimGraphNode_LinkedAnimLayer20                             OFFSET(getStruct<T>, {0xA478, 200, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose55                               OFFSET(getStruct<T>, {0xA540, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose56                               OFFSET(getStruct<T>, {0xA568, 40, 0, 0})
	SMember(FAnimNode_UseCachedPose)                   AnimGraphNode_UseCachedPose57                               OFFSET(getStruct<T>, {0xA590, 40, 0, 0})
	SMember(FAnimNode_Slot)                            AnimGraphNode_Slot16                                        OFFSET(getStruct<T>, {0xA5B8, 72, 0, 0})
	SMember(FAnimNode_LayeredBoneBlend)                AnimGraphNode_LayeredBoneBlend11                            OFFSET(getStruct<T>, {0xA600, 240, 0, 0})
	SMember(FAnimNode_SaveCachedPose)                  AnimGraphNode_SaveCachedPose25                              OFFSET(getStruct<T>, {0xA6F0, 120, 0, 0})
	SMember(FFortAnimInput_AdjustedAim)                __CustomProperty_InputParam_68C70D6347F81F8476C87EA798A19370 OFFSET(getStruct<T>, {0xA768, 604, 0, 0})
	DMember(bool)                                      __CustomProperty_ParaGlide_TriggerAnim_EE06BC0D4AF7A3598BB824A5286F89C8 OFFSET(get<bool>, {0xA9C4, 1, 0, 0})
	SMember(FName)                                     __CustomProperty_EmoteAnimOffsetCurveName_D066576F42932FCE06C5E8B658C15225 OFFSET(getStruct<T>, {0xA9C8, 4, 0, 0})
	SMember(FVector)                                   __CustomProperty_LeftHandOverride_D066576F42932FCE06C5E8B658C15225 OFFSET(getStruct<T>, {0xA9D0, 24, 0, 0})
	SMember(FVector)                                   __CustomProperty_RightHandOverride_D066576F42932FCE06C5E8B658C15225 OFFSET(getStruct<T>, {0xA9E8, 24, 0, 0})
	DMember(bool)                                      __CustomProperty_IsHidingInProp_D066576F42932FCE06C5E8B658C15225 OFFSET(get<bool>, {0xAA00, 1, 0, 0})
	SMember(FMulticastInlineDelegate)                  MenuScreenDispatcher                                        OFFSET(getStruct<T>, {0xAA08, 16, 0, 0})
	DMember(double)                                    StartAnimBlendTime                                          OFFSET(get<double>, {0xAA18, 8, 0, 0})
	DMember(double)                                    PivotAnimBlendTime                                          OFFSET(get<double>, {0xAA20, 8, 0, 0})
	DMember(double)                                    CrouchPlayRate                                              OFFSET(get<double>, {0xAA28, 8, 0, 0})
	DMember(bool)                                      IsSnowman                                                   OFFSET(get<bool>, {0xAA30, 1, 0, 0})
	SMember(FMulticastInlineDelegate)                  Indigo_Boost                                                OFFSET(getStruct<T>, {0xAA38, 16, 0, 0})
	DMember(bool)                                      ParaGlide_UseAltGliderCam                                   OFFSET(get<bool>, {0xAA48, 1, 0, 0})
	SMember(FVector)                                   LeftHandOverride                                            OFFSET(getStruct<T>, {0xAA50, 24, 0, 0})
	SMember(FVector)                                   RightHandOverride                                           OFFSET(getStruct<T>, {0xAA68, 24, 0, 0})
	DMember(bool)                                      ParaGlide_TriggerAnim                                       OFFSET(get<bool>, {0xAA80, 1, 0, 0})
	SMember(FName)                                     EmoteAnimOffsetCurveName                                    OFFSET(getStruct<T>, {0xAA84, 4, 0, 0})
	...
	// void RigidBodyPBAProto(FPoseLink InPoseRigidBodyPBA, FPoseLink& RigidBodyPBAProto);                                      // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void SourcePoseLayer(FPoseLink& SourcePoseLayer);                                                                        // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void UpperBodyAdjustmentsLayer(FPoseLink InPoseUpperBodyAdjustments, FPoseLink InPosePostUpperBodySlot, FPoseLink& UpperBodyAdjustmentsLayer); // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void FullBodySlotLayer(FPoseLink InFullBodyPose, FPoseLink& FullBodySlotLayer);                                          // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void DebugLayer(FPoseLink InPoseDebug, FPoseLink& DebugLayer);                                                           // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void FacialCurvesLayer(FPoseLink InPoseFacialCurves, FPoseLink& FacialCurvesLayer);                                      // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void FullBodyAdditivesLayer(FPoseLink InPoseFullBodyAdditives, FPoseLink& FullBodyAdditivesLayer);                       // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void LocomotionLayer(FPoseLink InSourcePoseLoco, FPoseLink& LocomotionLayer);                                            // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void LowerBodyBlendLayer(FPoseLink BasePose, FPoseLink LowerBody, FPoseLink& LowerBodyBlendLayer);                       // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void SourcePoseAdjustmentsLayer(FPoseLink InSourcePose, FPoseLink& SourcePoseAdjustmentsLayer);                          // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void UpperBodyAimingOffsetsLayer(FPoseLink InPose, FPoseLink& UpperBodyAimingOffsetsLayer);                              // [0x1d9241c] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void AnimNotify_Melee_Swing_L();                                                                                         // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void AnimNotify_Melee_Swing_R();                                                                                         // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void AnimNotify_playFacialAnim();                                                                                        // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void AnimNotify_IndigoLaunch();                                                                                          // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void AnimNotify_Melee_Swing_L_End();                                                                                     // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void AnimNotify_Melee_Swing_R_End();                                                                                     // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	// Function /Game/Characters/Player/Male/Male_Avg_Base/Fortnite_M_Avg_Player_AnimBlueprint.Fortnite_M_Avg_Player_AnimBlueprint_C.AnimNotify_Melee_Swing_L
	// void AnimNotify_Melee_Swing_L();                                                                                         // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	// Function /Game/Characters/Player/Male/Male_Avg_Base/Fortnite_M_Avg_Player_AnimBlueprint.Fortnite_M_Avg_Player_AnimBlueprint_C.AnimNotify_Melee_Swing_R
	// void AnimNotify_Melee_Swing_R();                                                                                         // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void AnimNotify_CreateToolFlyModeLoop_Entered();                                                                         // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void AnimNotify_CreateToolFlyModeStart_Entered();                                                                        // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void AnimNotify_OpenGlider();                                                                                            // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_Fortnite_M_Avg_Player_AnimBlueprint(int32_t EntryPoint);                                           // [0x1d9241c] Final                
	...
	// void Indigo_Boost__DelegateSignature();                                                                                  // [0x1d9241c] Public|Delegate|BlueprintCallable|BlueprintEvent 
	...
	// void MenuScreenDispatcher__DelegateSignature(UFortPlayerAnimInstance* CharPart);                                         // [0x1d9241c] Public|Delegate|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void On Dive Jump Ground Land Update(FAnimUpdateContext& Context, FAnimNodeReference& Node);                             // [0x1d9241c] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_SwimmingAnimBP_AnimGraphNode_TransitionResult_63C0C596447D773617BA3F81E189DD6A(); // [0x1d9241c] BlueprintEvent       
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_SwimmingAnimBP_AnimGraphNode_TransitionResult_A2BC0C1C4C08F505008D78822E2CDA35(); // [0x1d9241c] BlueprintEvent       
	...
	// void AnimNotify_SwimSprintStart_Entered_Layer();                                                                         // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void AnimNotify_SwimSprintStart_Exited_Layer();                                                                          // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void AnimNotify_SwimSprint_Entered_Layer();                                                                              // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void AnimNotify_SwimSprintSlow_Entered_Layer();                                                                          // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void AnimNotify_SwimStartAdditive_Entered_Layer();                                                                       // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void AnimNotify_SwimMovementAccelAdditive_Exited_Layer();                                                                // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_SwimmingAnimBP(int32_t EntryPoint);                                                                // [0x1d9241c] Final                
};
...
public:
	...
	// void InitRim();                                                                                                          // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	// Function /Game/Characters/Player/Common/PhysicalRimlight/PhysicalRimlight.PhysicalRimlight_C.Day Phase 
	// void Day Phase (EFortDayPhase CurrentDayPhase, EFortDayPhase PreviousDayPhase, bool bAtCreation);                        // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_PhysicalRimlight(int32_t EntryPoint);                                                              // [0x1d9241c] Final|HasDefaults    
};
...
public:
	...
	// void EvaluateGraphExposedInputs_ExecuteUbergraph_SlidingLayerAnimBP_AnimGraphNode_ApplyMeshSpaceAdditive_CA45D1154A0385BF8F15FBB40CA66AD6(); // [0x1d9241c] BlueprintEvent       
	...
	// void ExecuteUbergraph_SlidingLayerAnimBP(int32_t EntryPoint);                                                            // [0x1d9241c] Final                
};
...
public:
	...
	// void ExecuteUbergraph_F_MED_Ramirez_Fallback_Skeleton_AnimBlueprint(int32_t EntryPoint);                                 // [0x1d9241c] Final                
};
