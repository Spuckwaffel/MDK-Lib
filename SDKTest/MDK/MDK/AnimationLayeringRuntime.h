...
public:
	...
	CMember(UBoneMaskDefinitionDataAsset*)             BoneMaskDefinitionDataAsset                                 OFFSET(get<T>, {0x90, 8, 0, 0})
...
public:
	...
	CMember(UCurveVector*)                             TranslationRemapCurve                                       OFFSET(get<T>, {0x1B0, 8, 0, 0})
	DMember(float)                                     RotationScale                                               OFFSET(get<float>, {0x1B8, 4, 0, 0})
	CMember(UCurveFloat*)                              RotationRemapCurve                                          OFFSET(get<T>, {0x1C0, 8, 0, 0})
};

/// Enum /Script/AnimationLayeringRuntime.ECopyMotion_Component
/// Size: 0x05
enum ECopyMotion_Component : uint8_t
{
	ECopyMotion_Component__TranslationX0                                             = 0,
	ECopyMotion_Component__TranslationY1                                             = 1,
	ECopyMotion_Component__TranslationZ2                                             = 2,
	ECopyMotion_Component__RotationAngle3                                            = 3,
	ECopyMotion_Component__ECopyMotion_MAX4                                          = 4
};
