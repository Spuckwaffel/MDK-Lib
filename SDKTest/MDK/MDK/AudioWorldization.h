...
public:
	...
	SMember(FAudioWorldizationSettings)                DefaultSettings                                             OFFSET(getStruct<T>, {0x60, 88, 0, 0})
...
public:
	...
	SMember(FAudioWorldizationSettings)                CurrentSettings                                             OFFSET(getStruct<T>, {0x88, 88, 0, 0})
	...
	// void SetWorldizationSettings(FAudioWorldizationSettings& InSettings);                                                    // [0x754d064] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/AudioWorldization.AudioWorldizationSubsystem.SetEnabled
	// void SetEnabled(bool bNewEnabled);                                                                                       // [0x754cfe4] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioWorldization.AudioWorldizationSubsystem.SetDefaultSettings
	// void SetDefaultSettings();                                                                                               // [0x754cfd0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioWorldization.AudioWorldizationSubsystem.RemoveWorldizationSettings
	// void RemoveWorldizationSettings(FName InIdentifier);                                                                     // [0x754cf50] Final|Native|Public|BlueprintCallable 
	// Function /Script/AudioWorldization.AudioWorldizationSubsystem.GetTraceResults
	// TArray<FAudioSphereTraceResult> GetTraceResults();                                                                       // [0x754ced4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioWorldization.AudioWorldizationSubsystem.GetEnclosureFactor
	// float GetEnclosureFactor();                                                                                              // [0x754cebc] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/AudioWorldization.AudioWorldizationSubsystem.GetAverageTraceDistance
	// float GetAverageTraceDistance();                                                                                         // [0x754cea4] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	SMember(FAudioWorldizationSettings)                Settings                                                    OFFSET(getStruct<T>, {0x28, 88, 0, 0})
};
...
public:
	...
	SMember(FVector)                                   TraceOrigin                                                 OFFSET(getStruct<T>, {0x28, 24, 0, 0})
