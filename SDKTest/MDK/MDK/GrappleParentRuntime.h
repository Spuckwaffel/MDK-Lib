...
public:
	...
	SMember(FSpeedScaledAxisOffsetData)                ForwardOffsetData                                           OFFSET(get<T>, {0x60, 96, 0, 0})
	SMember(FVector2D)                                 TotalForwardOffsetBounds                                    OFFSET(get<T>, {0xC0, 16, 0, 0})
	SMember(FSpeedScaledAxisOffsetData)                RightOffsetData                                             OFFSET(get<T>, {0xD0, 96, 0, 0})
	SMember(FVector2D)                                 RightForwardOffsetMultiplierBounds                          OFFSET(get<T>, {0x130, 16, 0, 0})
	SMember(FSpeedScaledAxisOffsetData)                UpOffsetData                                                OFFSET(get<T>, {0x140, 96, 0, 0})
	SMember(FVector2D)                                 UpPositiveForwardOffsetMultiplierBounds                     OFFSET(get<T>, {0x1A0, 16, 0, 0})
	SMember(FVector2D)                                 UpNegativeForwardOffsetMultiplierBounds                     OFFSET(get<T>, {0x1B0, 16, 0, 0})
	DMember(float)                                     FOVInterpSpeed                                              OFFSET(get<float>, {0x1C0, 4, 0, 0})
	SMember(FVector2D)                                 FOVBounds                                                   OFFSET(get<T>, {0x1C8, 16, 0, 0})
	CMember(UCurveFloat*)                              BoostCurve                                                  OFFSET(get<T>, {0x1D8, 8, 0, 0})
	SMember(FScalableFloat)                            BoostModifier                                               OFFSET(get<T>, {0x1E0, 40, 0, 0})
	...
	SMember(FGameplayTag)                              SlidingGameplayTag                                          OFFSET(get<T>, {0x220, 4, 0, 0})
...
public:
	...
	SMember(FScalableFloat)                            ForwardInfluenceOnRotation                                  OFFSET(get<T>, {0x468, 40, 0, 0})
	SMember(FScalableFloat)                            TimeForMaxRotationSpeed                                     OFFSET(get<T>, {0x490, 40, 0, 0})
	SMember(FScalableFloat)                            MaxRotationSpeed                                            OFFSET(get<T>, {0x4B8, 40, 0, 0})
	SMember(FScalableFloat)                            RotationSpeedWhileNotAttached                               OFFSET(get<T>, {0x4E0, 40, 0, 0})
	SMember(FScalableFloat)                            RotationSpeedWhileNotRotated                                OFFSET(get<T>, {0x508, 40, 0, 0})
	...
	SMember(FVector)                                   Velocity                                                    OFFSET(get<T>, {0x540, 24, 0, 0})
	SMember(FVector)                                   XYVelocity                                                  OFFSET(get<T>, {0x558, 24, 0, 0})
	SMember(FVector)                                   VecFromPlayerToAttachPoint                                  OFFSET(get<T>, {0x570, 24, 0, 0})
	...
	SMember(FName)                                     CurveName_SwingPhase                                        OFFSET(get<T>, {0x594, 4, 0, 0})
	SMember(FName)                                     CurveName_BlendOut                                          OFFSET(get<T>, {0x598, 4, 0, 0})
	DMember(float)                                     SwingPhase                                                  OFFSET(get<float>, {0x59C, 4, 0, 0})
	SMember(FRotator)                                  CurrentRootRotation                                         OFFSET(get<T>, {0x5A0, 24, 0, 0})
	SMember(FVector)                                   CurrentRootTranslation                                      OFFSET(get<T>, {0x5B8, 24, 0, 0})
...
public:
	SMember(FScalableFloat)                            OffsetModifier                                              OFFSET(get<T>, {0x0, 40, 0, 0})
	DMember(float)                                     BaseOffset                                                  OFFSET(get<float>, {0x28, 4, 0, 0})
	DMember(float)                                     SpeedScaledOffset                                           OFFSET(get<float>, {0x2C, 4, 0, 0})
	SMember(FVector2D)                                 SpeedBounds                                                 OFFSET(get<T>, {0x30, 16, 0, 0})
	SMember(FVector2D)                                 SpeedMultiplierBounds                                       OFFSET(get<T>, {0x40, 16, 0, 0})
};
