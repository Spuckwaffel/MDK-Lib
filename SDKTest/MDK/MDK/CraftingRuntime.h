...
public:
	...
	SMember(FName)                                     LastCraftedItemFormulaRow                                   OFFSET(getStruct<T>, {0x130, 4, 0, 0})
	SMember(FString)                                   LastIngredientStringForAnalytics                            OFFSET(getStruct<T>, {0x138, 16, 0, 0})
	SMember(FString)                                   LastFormulaStringForAnalytics                               OFFSET(getStruct<T>, {0x148, 16, 0, 0})
	SMember(FString)                                   LastResultsStringForAnalytics                               OFFSET(getStruct<T>, {0x158, 16, 0, 0})
	SMember(FGameplayAbilitySpecHandle)                WhileCraftingAbilitySpecHandle                              OFFSET(getStruct<T>, {0x168, 4, 0, 0})
	SMember(FGameplayAbilitySpecHandle)                OwnerCraftingAbilitySpecHandle                              OFFSET(getStruct<T>, {0x16C, 4, 0, 0})
	SMember(FGameplayTag)                              CraftingObjectTag                                           OFFSET(getStruct<T>, {0x170, 4, 0, 0})
	SMember(FGameplayTagContainer)                     CraftingObjectTags                                          OFFSET(getStruct<T>, {0x178, 32, 0, 0})
	SMember(FScalableFloat)                            CraftingTimeLength                                          OFFSET(getStruct<T>, {0x198, 40, 0, 0})
	SMember(FScalableFloat)                            ReadyTimeLength                                             OFFSET(getStruct<T>, {0x1C0, 40, 0, 0})
	SMember(FScalableFloat)                            OverCraftingTimeLength                                      OFFSET(getStruct<T>, {0x1E8, 40, 0, 0})
	SMember(FScalableFloat)                            ResettingTimeLength                                         OFFSET(getStruct<T>, {0x210, 40, 0, 0})
	SMember(FName)                                     OverCraftingLootTierKey                                     OFFSET(getStruct<T>, {0x238, 4, 0, 0})
	...
	SMember(FVector)                                   IngredientSpawnOffset                                       OFFSET(getStruct<T>, {0x248, 24, 0, 0})
