...
public:
	...
	// FString GetSelectedHostName();                                                                                           // [0x7070370] Final|Native|Public|BlueprintCallable 
	// Function /Script/EpicMediaCDNHostnames.EpicMediaCDNHostnames.GetHostnames
	// TArray<FString> GetHostnames();                                                                                          // [0x7070334] Final|Native|Public|BlueprintCallable 
};
