...
public:
	...
	// void SetDelayedMaterialParameters();                                                                                     // [0x9a073e8] Final|Native|Protected|BlueprintCallable 
	// Function /Script/CaretakerRuntime.FortAIAnimInstance_Caretaker.GetWorldStriderComponent
	// UFortAnimWorldStriderComponent* GetWorldStriderComponent();                                                              // [0x9a072c4] Native|Public|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/CaretakerRuntime.FortAIAnimInstance_Caretaker.GetWalkSpeedWarpingValue
	// float GetWalkSpeedWarpingValue();                                                                                        // [0x9a07298] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
