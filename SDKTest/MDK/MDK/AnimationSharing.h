...
public:
	...
	// void RegisterActorWithSkeletonBP(AActor* InActor, USkeleton* SharingSkeleton);                                           // [0x71f46e0] Final|Native|Public|BlueprintCallable 
	// Function /Script/AnimationSharing.AnimationSharingManager.GetAnimationSharingManager
	// UAnimationSharingManager* GetAnimationSharingManager(UObject* WorldContextObject);                                       // [0x71f422c] Final|Native|Static|Public|BlueprintCallable 
