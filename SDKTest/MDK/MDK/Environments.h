...
public:
	...
	// void Assign Background Dynamic Materials(AStaticMeshActor* TargetBackground);                                            // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/VaultWorld.VaultWorld_C.GetVaultRotator
	// void GetVaultRotator(AVaultRotator_C*& VaultRotator);                                                                    // [0x101681c] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_VaultWorld(int32_t EntryPoint);                                                                    // [0x101681c] Final                
};
...
public:
	...
	CMember(UTimelineComponent*)                       ItemDetails                                                 OFFSET(get<T>, {0x368, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       Floor_Visibility                                            OFFSET(get<T>, {0x378, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       Background_Effects                                          OFFSET(get<T>, {0x388, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       TransitionForward                                           OFFSET(get<T>, {0x3A0, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       TransitionBackward                                          OFFSET(get<T>, {0x3B8, 8, 0, 0})
	CMember(UMaterialInstance*)                        FloorMI                                                     OFFSET(get<T>, {0x3C0, 8, 0, 0})
	CMember(UMaterialInstanceDynamic*)                 FloorMID                                                    OFFSET(get<T>, {0x3C8, 8, 0, 0})
	...
	// void TransitionBackgroundBackward(double Backward, double PreTransitionOffset, double FXTransitionFade, UMaterialInstanceDynamic* Mid); // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void TransitionBackgroundForward(double Forward, double PreTransitionOffset, double FXTransitionFade, UMaterialInstanceDynamic* Mid); // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void SetupBackgroundMaterial(UTexture2D*& TextureBackground, FVaultWorldBackgroundData& BackgroundInfo, UMaterialInstanceDynamic* Mid); // [0x101681c] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void TransitionBackward__FinishedFunc();                                                                                 // [0x101681c] BlueprintEvent       
	...
	// void TransitionBackward__UpdateFunc();                                                                                   // [0x101681c] BlueprintEvent       
	...
	// void Background-Effects__FinishedFunc();                                                                                 // [0x101681c] BlueprintEvent       
	...
	// void Background-Effects__UpdateFunc();                                                                                   // [0x101681c] BlueprintEvent       
	...
	// void Floor-Visibility__FinishedFunc();                                                                                   // [0x101681c] BlueprintEvent       
	...
	// void Floor-Visibility__UpdateFunc();                                                                                     // [0x101681c] BlueprintEvent       
	...
	// void ItemDetails__FinishedFunc();                                                                                        // [0x101681c] BlueprintEvent       
	...
	// void ItemDetails__UpdateFunc();                                                                                          // [0x101681c] BlueprintEvent       
	...
	// void OnSetupBackground(UTexture2D* LoadedBackgroundTexture, FVaultWorldBackgroundData& BackgroundInfo);                  // [0x101681c] HasOutParms|BlueprintEvent 
	...
	// void OnTransitionItemDetails(bool bShowItemDetails);                                                                     // [0x101681c] Event|Protected|BlueprintEvent 
	...
	// void OnUpdateMaterialIndex(int32_t MaterialIndex);                                                                       // [0x101681c] Event|Protected|BlueprintEvent 
	...
	// void ExecuteUbergraph_SpecialEventVaultWorld(int32_t EntryPoint);                                                        // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	CMember(UPostProcessComponent*)                    PostProcess_Mobile                                          OFFSET(get<T>, {0x3F0, 8, 0, 0})
	CMember(USkyLightComponent*)                       SkyLightLowMobile                                           OFFSET(get<T>, {0x3F8, 8, 0, 0})
	CMember(USkyLightComponent*)                       SkyLight                                                    OFFSET(get<T>, {0x400, 8, 0, 0})
	CMember(USkyLightComponent*)                       SkyLight_LOWPC                                              OFFSET(get<T>, {0x408, 8, 0, 0})
	CMember(UArrowComponent*)                          Arrow                                                       OFFSET(get<T>, {0x410, 8, 0, 0})
	CMember(UPostProcessComponent*)                    PostProcess_LOWPC                                           OFFSET(get<T>, {0x418, 8, 0, 0})
	CMember(UDirectionalLightComponent*)               DirectionalLight_LOWPC                                      OFFSET(get<T>, {0x420, 8, 0, 0})
	CMember(UDirectionalLightComponent*)               DirectionalLightMobile                                      OFFSET(get<T>, {0x428, 8, 0, 0})
	CMember(USceneComponent*)                          DirectionalLights                                           OFFSET(get<T>, {0x430, 8, 0, 0})
	CMember(USceneComponent*)                          GenericLighting                                             OFFSET(get<T>, {0x438, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       Timeline                                                    OFFSET(get<T>, {0x448, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       Timeline1                                                   OFFSET(get<T>, {0x458, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       MoveOutRight                                                OFFSET(get<T>, {0x480, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       MoveInRight                                                 OFFSET(get<T>, {0x4A8, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       MoveInLeft                                                  OFFSET(get<T>, {0x4D0, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       MoveOutLeft                                                 OFFSET(get<T>, {0x4F8, 8, 0, 0})
	...
	CMember(UFortAccountItemDefinition*)               Primary_Requested_Item                                      OFFSET(get<T>, {0x558, 8, 0, 0})
	CMember(UFortAccountItemDefinition*)               Previous_Requested_Item                                     OFFSET(get<T>, {0x560, 8, 0, 0})


	/// Functions
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/ItemPreviewSideSwap.ItemPreviewSideSwap_C.LightControl
	// void LightControl(bool Active);                                                                                          // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/ItemPreviewSideSwap.ItemPreviewSideSwap_C.SwitchPCLighting
	// void SwitchPCLighting(bool Visibility);                                                                                  // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void SwitchPCLighting_LOWDetail(bool Visibility);                                                                        // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void SwitchMobileLighting(bool Visibility);                                                                              // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void MoveOutLeft__FinishedFunc();                                                                                        // [0x101681c] BlueprintEvent       
	...
	// void MoveOutLeft__UpdateFunc();                                                                                          // [0x101681c] BlueprintEvent       
	...
	// void MoveInLeft__FinishedFunc();                                                                                         // [0x101681c] BlueprintEvent       
	...
	// void MoveInLeft__UpdateFunc();                                                                                           // [0x101681c] BlueprintEvent       
	...
	// void MoveInRight__FinishedFunc();                                                                                        // [0x101681c] BlueprintEvent       
	...
	// void MoveInRight__UpdateFunc();                                                                                          // [0x101681c] BlueprintEvent       
	...
	// void MoveOutRight__FinishedFunc();                                                                                       // [0x101681c] BlueprintEvent       
	...
	// void MoveOutRight__UpdateFunc();                                                                                         // [0x101681c] BlueprintEvent       
	...
	// void Timeline_0__FinishedFunc();                                                                                         // [0x101681c] BlueprintEvent       
	...
	// void Timeline_0__UpdateFunc();                                                                                           // [0x101681c] BlueprintEvent       
	...
	// void Timeline_1__FinishedFunc();                                                                                         // [0x101681c] BlueprintEvent       
	...
	// void Timeline_1__UpdateFunc();                                                                                           // [0x101681c] BlueprintEvent       
	...
	// void OnReadyToSwap(UFortAccountItemDefinition* PrimaryRequestedItem, FSceneTransitionOptions& Options);                  // [0x101681c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/ItemPreviewSideSwap.ItemPreviewSideSwap_C.OnNewSceneRequested
	// void OnNewSceneRequested(UFortAccountItemDefinition* PrimaryRequestedItem, FSceneTransitionOptions& TransitionOptions);  // [0x101681c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/ItemPreviewSideSwap.ItemPreviewSideSwap_C.UpdateSettings
	// void UpdateSettings();                                                                                                   // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void OnTargetZoomLevelSet(float TargetZoomLevel);                                                                        // [0x101681c] Event|Protected|BlueprintEvent 
	...
	// void OnTargetRotationOffsetSet(FRotator& TargetRotationOffset);                                                          // [0x101681c] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void ExecuteUbergraph_ItemPreviewSideSwap(int32_t EntryPoint);                                                           // [0x101681c] Final|HasDefaults    
	...
	// void On New Item Spawned__DelegateSignature(bool Should Show Floor);                                                     // [0x101681c] Public|Delegate|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	CMember(UTimelineComponent*)                       TransitionForward                                           OFFSET(get<T>, {0x370, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       BackgroundIntenstiy                                         OFFSET(get<T>, {0x380, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       ItemDetailsIntensity                                        OFFSET(get<T>, {0x390, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       Background_Effects                                          OFFSET(get<T>, {0x3A0, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       IconDissolve                                                OFFSET(get<T>, {0x3B0, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       ItemDetails                                                 OFFSET(get<T>, {0x3C8, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       Floor_Visibility                                            OFFSET(get<T>, {0x3D8, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       TransitionBackward                                          OFFSET(get<T>, {0x3F0, 8, 0, 0})
	CMember(UMaterialInstance*)                        FloorMI                                                     OFFSET(get<T>, {0x3F8, 8, 0, 0})
	CMember(UMaterialInstanceDynamic*)                 FloorMID                                                    OFFSET(get<T>, {0x400, 8, 0, 0})
	...
	// void Set Backgrounds Scalar Value(FName Param, double FloatValue);                                                       // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void PageTransitionIntensityUpdate(UMaterialInstanceDynamic* MID_Background, UMaterialInstanceDynamic* MID_Floor);       // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void TransitionBackgroundBackward(double Backward, double Fade, double FXTransitionFade, UMaterialInstanceDynamic* Mid); // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void TransitionBackgroundForward(double Forward, double Fade, double FXTransitionFade, UMaterialInstanceDynamic* Mid);   // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void IconDissolve__FinishedFunc();                                                                                       // [0x101681c] BlueprintEvent       
	...
	// void IconDissolve__UpdateFunc();                                                                                         // [0x101681c] BlueprintEvent       
	...
	// void ItemDetailsIntensity__FinishedFunc();                                                                               // [0x101681c] BlueprintEvent       
	...
	// void ItemDetailsIntensity__UpdateFunc();                                                                                 // [0x101681c] BlueprintEvent       
	...
	// void BackgroundIntenstiy__FinishedFunc();                                                                                // [0x101681c] BlueprintEvent       
	...
	// void BackgroundIntenstiy__UpdateFunc();                                                                                  // [0x101681c] BlueprintEvent       
	...
	// void OnIntensityChange(bool bToLowIntensity);                                                                            // [0x101681c] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_BattlePassVaultWorld(int32_t EntryPoint);                                                          // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	CMember(UDirectionalLightComponent*)               DirectionalLightMobile                                      OFFSET(get<T>, {0x3E8, 8, 0, 0})
	CMember(UDirectionalLightComponent*)               DirectionalLight_LOWPC                                      OFFSET(get<T>, {0x3F0, 8, 0, 0})
	CMember(USceneComponent*)                          DirectionalLights                                           OFFSET(get<T>, {0x3F8, 8, 0, 0})
	CMember(USkyLightComponent*)                       SkyLightLowMobile                                           OFFSET(get<T>, {0x400, 8, 0, 0})
	CMember(USkyLightComponent*)                       SkyLight                                                    OFFSET(get<T>, {0x408, 8, 0, 0})
	CMember(USkyLightComponent*)                       SkyLight_LOWPC                                              OFFSET(get<T>, {0x410, 8, 0, 0})
	CMember(UArrowComponent*)                          Arrow                                                       OFFSET(get<T>, {0x418, 8, 0, 0})
	CMember(UPostProcessComponent*)                    PostProcess_Mobile                                          OFFSET(get<T>, {0x420, 8, 0, 0})
	CMember(UPostProcessComponent*)                    PostProcess_LOWPC                                           OFFSET(get<T>, {0x428, 8, 0, 0})
	CMember(USceneComponent*)                          GenericLighting                                             OFFSET(get<T>, {0x430, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       Timeline_YawRotation                                        OFFSET(get<T>, {0x440, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       Timeline_Zoom                                               OFFSET(get<T>, {0x450, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       CameraTurn_180_to                                           OFFSET(get<T>, {0x498, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       CameraTurn_0_to                                             OFFSET(get<T>, {0x4E0, 8, 0, 0})
	SMember(FTransform)                                InitialCameraTransform                                      OFFSET(getStruct<T>, {0x4F0, 96, 0, 0})
	CMember(USoundBase*)                               ClockwiseSound                                              OFFSET(get<T>, {0x550, 8, 0, 0})
	CMember(USoundBase*)                               CounterClockwiseSound                                       OFFSET(get<T>, {0x558, 8, 0, 0})
	...
	// void PlaySoundWhenEnabled(USoundBase* sound);                                                                            // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/VaultRotator.VaultRotator_C.SetBackgroundColor
	// void SetBackgroundColor(FLinearColor RGBA0, FLinearColor RGBA1);                                                         // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/VaultRotator.VaultRotator_C.ToggleBackgroundText
	// void ToggleBackgroundText(bool bDisplayText);                                                                            // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Timeline_YawRotation__FinishedFunc();                                                                               // [0x101681c] BlueprintEvent       
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/VaultRotator.VaultRotator_C.Timeline_YawRotation__UpdateFunc
	// void Timeline_YawRotation__UpdateFunc();                                                                                 // [0x101681c] BlueprintEvent       
	...
	// void OnCameraTransitionReady(bool bPrimaryToSecondary, UFortAccountItemDefinition* PrimaryRequestedItem, FSceneTransitionOptions& Options); // [0x101681c] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void OnSetBackgroundMessageText(FText& BackgroundMessageText);                                                           // [0x101681c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/VaultRotator.VaultRotator_C.OnUpdateBackgroundColor
	// void OnUpdateBackgroundColor(bool bEnableAutotestBackground);                                                            // [0x101681c] Event|Protected|BlueprintEvent 
	...
	// void OnTargetRotationOffsetCanceled();                                                                                   // [0x101681c] Event|Protected|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/VaultRotator.VaultRotator_C.OnTargetZoomLevelCanceled
	// void OnTargetZoomLevelCanceled();                                                                                        // [0x101681c] Event|Protected|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/VaultRotator.VaultRotator_C.ExecuteUbergraph_VaultRotator
	// void ExecuteUbergraph_VaultRotator(int32_t EntryPoint);                                                                  // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_ItemPreviewPedestal(int32_t EntryPoint);                                                           // [0x101681c] Final                
};

/// Class /Game/Environments/FrontEnd/Blueprints/ItemPreview/WrapPreview.WrapPreview_C
/// Size: 0x00C8 (0x000580 - 0x000648)
...
public:
	...
	CMember(USkyLightComponent*)                       SkyLightPC                                                  OFFSET(get<T>, {0x588, 8, 0, 0})
	CMember(USkeletalMeshComponent*)                   AssaultRiflePreview                                         OFFSET(get<T>, {0x590, 8, 0, 0})
	CMember(USkeletalMeshComponent*)                   MechPreview                                                 OFFSET(get<T>, {0x598, 8, 0, 0})
	CMember(USkyLightComponent*)                       SkyLightLowMobile                                           OFFSET(get<T>, {0x5A0, 8, 0, 0})
	CMember(UArrowComponent*)                          Arrow                                                       OFFSET(get<T>, {0x5A8, 8, 0, 0})
	CMember(UDirectionalLightComponent*)               DirectionalLightMobile                                      OFFSET(get<T>, {0x5B0, 8, 0, 0})
	CMember(USpotLightComponent*)                      KeyLight_StandaloneForSwitch                                OFFSET(get<T>, {0x5B8, 8, 0, 0})
	CMember(USpotLightComponent*)                      KeyLigh4                                                    OFFSET(get<T>, {0x5C0, 8, 0, 0})
	CMember(USpotLightComponent*)                      KeyLight7                                                   OFFSET(get<T>, {0x5C8, 8, 0, 0})
	CMember(USpotLightComponent*)                      KeyLight8                                                   OFFSET(get<T>, {0x5D0, 8, 0, 0})
	CMember(USpotLightComponent*)                      KeyLight3                                                   OFFSET(get<T>, {0x5D8, 8, 0, 0})
	CMember(USpotLightComponent*)                      RimLowerRight2                                              OFFSET(get<T>, {0x5E0, 8, 0, 0})
	CMember(USpotLightComponent*)                      RimLeft2                                                    OFFSET(get<T>, {0x5E8, 8, 0, 0})
	CMember(USpotLightComponent*)                      Bounce2                                                     OFFSET(get<T>, {0x5F0, 8, 0, 0})
	CMember(USpotLightComponent*)                      BounceRear2                                                 OFFSET(get<T>, {0x5F8, 8, 0, 0})
	CMember(USpotLightComponent*)                      RimTopRight2                                                OFFSET(get<T>, {0x600, 8, 0, 0})
	CMember(USpotLightComponent*)                      RimBottomLeft2                                              OFFSET(get<T>, {0x608, 8, 0, 0})
	CMember(USceneComponent*)                          LightingPivot                                               OFFSET(get<T>, {0x610, 8, 0, 0})
	CMember(UStaticMeshComponent*)                     Plane                                                       OFFSET(get<T>, {0x618, 8, 0, 0})
	DMember(bool)                                      bLightsScaledForVehicle                                     OFFSET(get<bool>, {0x620, 1, 0, 0})
	DMember(double)                                    DeltaScale                                                  OFFSET(get<double>, {0x628, 8, 0, 0})
	DMember(bool)                                      IsActive                                                    OFFSET(get<bool>, {0x630, 1, 0, 0})
	DMember(bool)                                      AlwaysOn                                                    OFFSET(get<bool>, {0x631, 1, 0, 0})
	DMember(bool)                                      FloorEverAllowed                                            OFFSET(get<bool>, {0x632, 1, 0, 0})
	DMember(bool)                                      debugConstructionLighting                                   OFFSET(get<bool>, {0x633, 1, 0, 0})
	SMember(FStateTransitionPauseRequestHandle)        ItemsPendingTransitionOutHandle                             OFFSET(getStruct<T>, {0x638, 16, 0, 0})


	/// Functions
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/WrapPreview.WrapPreview_C.UpdateFloorVisibility
	// void UpdateFloorVisibility();                                                                                            // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/WrapPreview.WrapPreview_C.SwitchErebusLighting
	// void SwitchErebusLighting(bool Visibility);                                                                              // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/WrapPreview.WrapPreview_C.UpdateLightingScale
	// void UpdateLightingScale();                                                                                              // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/WrapPreview.WrapPreview_C.SetFloorEnabled
	// void SetFloorEnabled(bool Floor Enabled);                                                                                // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void SwitchMobileLighting(bool NewParam);                                                                                // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/WrapPreview.WrapPreview_C.HandleLightingScale
	// void HandleLightingScale();                                                                                              // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/WrapPreview.WrapPreview_C.OnSetFloorMaterial
	// void OnSetFloorMaterial(UMaterialInterface* InMaterialInstance);                                                         // [0x101681c] Event|Public|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/WrapPreview.WrapPreview_C.OnUpdateFloorMaterial
	// void OnUpdateFloorMaterial(bool bEnableAutotestBackground);                                                              // [0x101681c] Event|Protected|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/WrapPreview.WrapPreview_C.OnItemsPendingTransitionOut
	// void OnItemsPendingTransitionOut(FStateTransitionControllerHandle& TransitionController);                                // [0x101681c] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void Internal_ItemsPendingTransitionOutComplete(FStateTransitionControllerHandle TransitionController);                  // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void OnItemsPendingTransitionOut_SpawnResOutEffects();                                                                   // [0x101681c] BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/WrapPreview.WrapPreview_C.FinishShowingResOutEffects
	// void FinishShowingResOutEffects();                                                                                       // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void OnItemsPendingTransitionOut_EnsureAllResOutEffectsAreCleanedUp();                                                   // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void OnPreviewVisualsSpawned(bool bUseSecondaryTransitionEffects, bool bShowFloor);                                      // [0x101681c] Event|Protected|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/WrapPreview.WrapPreview_C.ExecuteUbergraph_WrapPreview
	// void ExecuteUbergraph_WrapPreview(int32_t EntryPoint);                                                                   // [0x101681c] Final|HasDefaults    
};
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x6C0, 8, 0, 0})
	CMember(UArrowComponent*)                          Temp_IASDerezAbsorbPoint                                    OFFSET(get<T>, {0x6C8, 8, 0, 0})
	CMember(UArrowComponent*)                          Arrow1                                                      OFFSET(get<T>, {0x6D0, 8, 0, 0})
	CMember(UDirectionalLightComponent*)               Directional_Light_For_Atmosphere_PC                         OFFSET(get<T>, {0x6D8, 8, 0, 0})
	CMember(USkyLightComponent*)                       SkyLightPC                                                  OFFSET(get<T>, {0x6E0, 8, 0, 0})
	CMember(UArrowComponent*)                          Arrow                                                       OFFSET(get<T>, {0x6E8, 8, 0, 0})
	CMember(USkyLightComponent*)                       SkyLightLowMobile                                           OFFSET(get<T>, {0x6F0, 8, 0, 0})
	CMember(UDirectionalLightComponent*)               DirectionalLightMobile                                      OFFSET(get<T>, {0x6F8, 8, 0, 0})
	CMember(USpotLightComponent*)                      KeyLight_StandaloneForSwitch                                OFFSET(get<T>, {0x700, 8, 0, 0})
	CMember(USpotLightComponent*)                      KeyLight5                                                   OFFSET(get<T>, {0x708, 8, 0, 0})
	CMember(USpotLightComponent*)                      KeyLight6                                                   OFFSET(get<T>, {0x710, 8, 0, 0})
	CMember(USpotLightComponent*)                      KeyLigh3                                                    OFFSET(get<T>, {0x718, 8, 0, 0})
	CMember(USpotLightComponent*)                      KeyLight2                                                   OFFSET(get<T>, {0x720, 8, 0, 0})
	CMember(USpotLightComponent*)                      BounceRear1                                                 OFFSET(get<T>, {0x728, 8, 0, 0})
	CMember(USpotLightComponent*)                      RimLowerRight1                                              OFFSET(get<T>, {0x730, 8, 0, 0})
	CMember(USpotLightComponent*)                      RimLeft1                                                    OFFSET(get<T>, {0x738, 8, 0, 0})
	CMember(USpotLightComponent*)                      RimTopRight1                                                OFFSET(get<T>, {0x740, 8, 0, 0})
	CMember(USpotLightComponent*)                      RimBottomLeft1                                              OFFSET(get<T>, {0x748, 8, 0, 0})
	CMember(USpotLightComponent*)                      Bounce1                                                     OFFSET(get<T>, {0x750, 8, 0, 0})
	CMember(USceneComponent*)                          LightTransform                                              OFFSET(get<T>, {0x758, 8, 0, 0})
	CMember(UStaticMeshComponent*)                     Plane                                                       OFFSET(get<T>, {0x760, 8, 0, 0})
	CMember(USkeletalMeshComponent*)                   Sample_Mesh                                                 OFFSET(get<T>, {0x768, 8, 0, 0})
	DMember(float)                                     RezInMaterialEffectTimeLine2_NewTrack_0_FBE08AE14EC4BA399756F0BBFA6ABC31 OFFSET(get<float>, {0x770, 4, 0, 0})
	CMember(TEnumAsByte<ETimelineDirection>)           RezInMaterialEffectTimeLine2__Direction_FBE08AE14EC4BA399756F0BBFA6ABC31 OFFSET(get<T>, {0x774, 1, 0, 0})
	CMember(UTimelineComponent*)                       RezInMaterialEffectTimeLine2                                OFFSET(get<T>, {0x778, 8, 0, 0})
	DMember(float)                                     RezInMaterialEffectTimeLine_NewTrack_0_963A663B4B1DFB2954D581893C8ACFD8 OFFSET(get<float>, {0x780, 4, 0, 0})
	CMember(TEnumAsByte<ETimelineDirection>)           RezInMaterialEffectTimeLine__Direction_963A663B4B1DFB2954D581893C8ACFD8 OFFSET(get<T>, {0x784, 1, 0, 0})
	CMember(UTimelineComponent*)                       RezInMaterialEffectTimeLine                                 OFFSET(get<T>, {0x788, 8, 0, 0})
	DMember(bool)                                      AlwaysOn                                                    OFFSET(get<bool>, {0x790, 1, 0, 0})
	DMember(bool)                                      IsActive                                                    OFFSET(get<bool>, {0x791, 1, 0, 0})
	DMember(bool)                                      debugConstructionLighting                                   OFFSET(get<bool>, {0x792, 1, 0, 0})
	CMember(UParticleSystemComponent*)                 ObscuringLoopEmitter                                        OFFSET(get<T>, {0x798, 8, 0, 0})
	SMember(FRotator)                                  ToonLightRotatio                                            OFFSET(getStruct<T>, {0x7A0, 24, 0, 0})
	DMember(bool)                                      bIsBattlePassReward                                         OFFSET(get<bool>, {0x7B8, 1, 0, 0})
	SMember(FTimerHandle)                              LOD_StreamingSafetyTimer                                    OFFSET(getStruct<T>, {0x7C0, 8, 0, 0})
	CMember(UMaterialInterface*)                       DefaultFloorMaterial                                        OFFSET(get<T>, {0x7C8, 8, 0, 0})
	CMember(UMaterialInterface*)                       CustomFloorMaterial                                         OFFSET(get<T>, {0x7D0, 8, 0, 0})
	SMember(FStateTransitionPauseRequestHandle)        ItemsPendingTransitionOutHandle                             OFFSET(getStruct<T>, {0x7D8, 16, 0, 0})
	CMember(UFXSystemComponent*)                       IASLoadingFX_LoopFX                                         OFFSET(get<T>, {0x7E8, 8, 0, 0})
	DMember(bool)                                      Use_Secondary_Transition_Effects                            OFFSET(get<bool>, {0x7F0, 1, 0, 0})
	DMember(bool)                                      Show_Floor                                                  OFFSET(get<bool>, {0x7F1, 1, 0, 0})
	SMember(FTimerHandle)                              IASLoadingDelayTimer                                        OFFSET(getStruct<T>, {0x7F8, 8, 0, 0})
	SMember(FTimerHandle)                              IASLoadingFXDestroyDelayTimer                               OFFSET(getStruct<T>, {0x800, 8, 0, 0})
	SMember(FTimerHandle)                              IASResinDelayTimer                                          OFFSET(getStruct<T>, {0x808, 8, 0, 0})
	...
	// void OutroAndDestroyLoadingEffects();                                                                                    // [0x101681c] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Get LOD Streaming Safety Duration();                                                                                // [0x101681c] Public|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/ItemOnPawnPreview.ItemOnPawnPreview_C.SwitchErebusLighting
	// void SwitchErebusLighting(bool Visibility);                                                                              // [0x101681c] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/ItemOnPawnPreview.ItemOnPawnPreview_C.SetFloorEnabled
	// void SetFloorEnabled(bool Show Floor);                                                                                   // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void RezInMaterialEffectTimeLine__FinishedFunc();                                                                        // [0x101681c] BlueprintEvent       
	...
	// void RezInMaterialEffectTimeLine__UpdateFunc();                                                                          // [0x101681c] BlueprintEvent       
	...
	// void RezInMaterialEffectTimeLine2__FinishedFunc();                                                                       // [0x101681c] BlueprintEvent       
	...
	// void RezInMaterialEffectTimeLine2__UpdateFunc();                                                                         // [0x101681c] BlueprintEvent       
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/ItemOnPawnPreview.ItemOnPawnPreview_C.SpawnSoundPlayback
	// void SpawnSoundPlayback();                                                                                               // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void OnAllLODStreamingComplete();                                                                                        // [0x101681c] Event|Public|BlueprintEvent 
	...
	// void OnPreviewVisualsBeginLoading();                                                                                     // [0x101681c] Event|Protected|BlueprintEvent 
	...
	// void OnCurrentVisualsCleanedUp();                                                                                        // [0x101681c] Event|Public|BlueprintEvent 
	...
	// void Backup_LODStreamingFailed();                                                                                        // [0x101681c] BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/ItemPreview/ItemOnPawnPreview.ItemOnPawnPreview_C.RezInMaterialEffect
	// void RezInMaterialEffect();                                                                                              // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_ItemOnPawnPreview(int32_t EntryPoint);                                                             // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	// void MoveCameraUp();                                                                                                     // [0x101681c] BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/CameraAnimationTransition.CameraAnimationTransition_C.MoveCameraDown
	// void MoveCameraDown();                                                                                                   // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_CameraAnimationTransition(int32_t EntryPoint);                                                     // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	// void SetVisiblityofDetailSpecificMeshes();                                                                               // [0x101681c] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void SetVisiblityofSceneLighting(bool Activate);                                                                         // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void EnableLobbySetLighting();                                                                                           // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void DisableLobbySetLighting();                                                                                          // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_FortniteLobbyLightSwitcher(int32_t EntryPoint);                                                 // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	// void Reset Location();                                                                                                   // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void ManualActivate();                                                                                                   // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_FortnitePartyBackdrop_Camera(int32_t EntryPoint);                                                  // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_BP_DetailLevelMesh(int32_t EntryPoint);                                                            // [0x101681c] Final                
};
...
public:
	...
	// void GetFrontendAnimInstance();                                                                                          // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void OnFrontEndCameraChanged(EFrontEndCamera NewCamera, EFrontEndCamera OldCamera);                                      // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void InitializeContextEvents();                                                                                          // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void ItemRez();                                                                                                          // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_VaultWeaponPlacementHelper(int32_t EntryPoint);                                                    // [0x101681c] Final                
	...
	// void NewEventDispatcher_0__DelegateSignature();                                                                          // [0x101681c] Public|Delegate|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void UpdatePosition For Camera(EFrontEndCamera FrontendCamera);                                                          // [0x101681c] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void SubGameChanged_Event(ESubGame SubGame);                                                                             // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void OnFrontEndCameraChanged(EFrontEndCamera NewCamera, EFrontEndCamera OldCamera);                                      // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_VaultCharacterPlacementHelper(int32_t EntryPoint);                                                 // [0x101681c] Final|HasDefaults    
	...
	// void OnZoomLevelUpdated__DelegateSignature(double CurrentZoomLevel);                                                     // [0x101681c] Public|Delegate|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	CMember(UCommonRichTextBlock*)                     CustomString                                                OFFSET(get<T>, {0x2C8, 8, 0, 0})
	...
	// void ExecuteUbergraph_UI_Background_Strings(int32_t EntryPoint);                                                         // [0x101681c] Final                
};
...
public:
	...
	// void ReceiveEndPlay(TEnumAsByte<EEndPlayReason> EndPlayReason);                                                          // [0x101681c] Event|Protected|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_CharacterRimlightDisabler(int32_t EntryPoint);                                                  // [0x101681c] Final                
};
...
public:
	...
	// void HandleMousePress();                                                                                                 // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void HandleMouseRelease();                                                                                               // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void InpActEvt_LeftMouseButton_K2Node_InputKeyEvent(FKey Key);                                                           // [0x101681c] BlueprintEvent       
	// Function /Game/Environments/FrontEnd/Blueprints/FortnitePartyHeroSelect_Camera.FortnitePartyHeroSelect_Camera_C.InpActEvt_LeftMouseButton_K2Node_InputKeyEvent
	// void InpActEvt_LeftMouseButton_K2Node_InputKeyEvent(FKey Key);                                                           // [0x101681c] BlueprintEvent       
	...
	// void InpActEvt_RightMouseButton_K2Node_InputKeyEvent(FKey Key);                                                          // [0x101681c] BlueprintEvent       
	// Function /Game/Environments/FrontEnd/Blueprints/FortnitePartyHeroSelect_Camera.FortnitePartyHeroSelect_Camera_C.InpActEvt_RightMouseButton_K2Node_InputKeyEvent
	// void InpActEvt_RightMouseButton_K2Node_InputKeyEvent(FKey Key);                                                          // [0x101681c] BlueprintEvent       
	...
	// void ExecuteUbergraph_FortnitePartyHeroSelect_Camera(int32_t EntryPoint);                                                // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	// void SwitchMobileLighting(bool Visibilty);                                                                               // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_VaultCharacterLightingBP(int32_t EntryPoint);                                                      // [0x101681c] Final                
};
...
public:
	...
	CMember(UChildActorComponent*)                     PrefabActorComp                                             OFFSET(get<T>, {0x560, 8, 0, 0})
	CMember(USkeletalMeshComponent*)                   SkeletalMesh                                                OFFSET(get<T>, {0x568, 8, 0, 0})
	CMember(UStaticMeshComponent*)                     StaticMesh                                                  OFFSET(get<T>, {0x570, 8, 0, 0})
	CMember(UStaticMeshComponent*)                     ScalePivot                                                  OFFSET(get<T>, {0x578, 8, 0, 0})
	CMember(UStaticMeshComponent*)                     PivotHolder                                                 OFFSET(get<T>, {0x580, 8, 0, 0})
	CMember(UParticleSystemComponent*)                 CelebratoryFX                                               OFFSET(get<T>, {0x588, 8, 0, 0})
	CMember(USceneComponent*)                          DefaultSceneRoot                                            OFFSET(get<T>, {0x590, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       HoloMatColorPulse                                           OFFSET(get<T>, {0x5A0, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       ScaleAnimEvolve                                             OFFSET(get<T>, {0x5B0, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       ScaleAnimLevel                                              OFFSET(get<T>, {0x5C0, 8, 0, 0})
	SMember(FTimerHandle)                              TimerHandle                                                 OFFSET(getStruct<T>, {0x5C8, 8, 0, 0})
	DMember(double)                                    Rotation                                                    OFFSET(get<double>, {0x5D0, 8, 0, 0})
	CMember(UFortItem*)                                ItemToRepresent                                             OFFSET(get<T>, {0x5D8, 8, 0, 0})
	DMember(bool)                                      PreviewRotation                                             OFFSET(get<bool>, {0x5E0, 1, 0, 0})
	CMember(UCurveFloat*)                              RotationAnimation                                           OFFSET(get<T>, {0x5E8, 8, 0, 0})
	CMember(UParticleSystem*)                          LevelUpFX                                                   OFFSET(get<T>, {0x5F0, 8, 0, 0})
	CMember(UParticleSystem*)                          EvolveUpFX                                                  OFFSET(get<T>, {0x5F8, 8, 0, 0})
	...
	CMember(UParticleSystem*)                          CharLevelUpFX                                               OFFSET(get<T>, {0x620, 8, 0, 0})
	CMember(UParticleSystem*)                          CharEvolveUpFX                                              OFFSET(get<T>, {0x628, 8, 0, 0})
	CMember(UMaterialInstanceDynamic*)                 UIoverrideMID                                               OFFSET(get<T>, {0x630, 8, 0, 0})
	DMember(bool)                                      HasResetVisuals                                             OFFSET(get<bool>, {0x638, 1, 0, 0})
	CMember(UParticleSystemComponent*)                 ParticleSystem1                                             OFFSET(get<T>, {0x640, 8, 0, 0})
	CMember(UParticleSystemComponent*)                 ParticleSystem2                                             OFFSET(get<T>, {0x648, 8, 0, 0})
	CMember(UParticleSystem*)                          CharSwapTransitionFX                                        OFFSET(get<T>, {0x650, 8, 0, 0})
	DMember(bool)                                      IsCharacterVisible                                          OFFSET(get<bool>, {0x658, 1, 0, 0})
	CMember(AFortPlayerPawn*)                          HeroPawn                                                    OFFSET(get<T>, {0x660, 8, 0, 0})
	DMember(bool)                                      SanityChecker                                               OFFSET(get<bool>, {0x668, 1, 0, 0})
	CMember(UMaterialInstanceDynamic*)                 MID_HoloMaterial                                            OFFSET(get<T>, {0x670, 8, 0, 0})
	...
	CMember(UParticleSystemComponent*)                 GhostPistolVFX                                              OFFSET(get<T>, {0x708, 8, 0, 0})
	CMember(UParticleSystemComponent*)                 Ghost_Sword_VFX                                             OFFSET(get<T>, {0x710, 8, 0, 0})
	CMember(UStaticMeshComponent*)                     Ghost_Sword_Mesh                                            OFFSET(get<T>, {0x718, 8, 0, 0})
	CMember(UParticleSystemComponent*)                 TransitionFXComponent                                       OFFSET(get<T>, {0x720, 8, 0, 0})
	CMember(UParticleSystem*)                          CharSwapTransitionFXLoop                                    OFFSET(get<T>, {0x728, 8, 0, 0})
	...
	// void ResetPreScaleLocations();                                                                                           // [0x101681c] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void RestoreTeleportMIDsInProgress(AFortPlayerPawn* Pawn);                                                               // [0x101681c] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void HandlePartyMemberInProgressDisplayChanges(AFortPlayerPawn* Pawn);                                                   // [0x101681c] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/PartyDisplayManagerBP.PartyDisplayManagerBP_C.PartyMemberInProgressCheck
	// void PartyMemberInProgressCheck(AFortPlayerPawn* Pawn);                                                                  // [0x101681c] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// AActor* GetPrefabActorForCurrentDisplayedItem();                                                                         // [0x101681c] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
	// Function /Game/Environments/FrontEnd/Blueprints/PartyDisplayManagerBP.PartyDisplayManagerBP_C.PostSetupPrefabVisuals
	// void PostSetupPrefabVisuals();                                                                                           // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	...
	// void GetMeshForCurrentDisplayedItem(UMeshComponent*& OutDisplayedMesh);                                                  // [0x101681c] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/PartyDisplayManagerBP.PartyDisplayManagerBP_C.GetItemDefinitionToShow
	// void GetItemDefinitionToShow(UFortItemDefinition*& ItemDefinition);                                                      // [0x101681c] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Environments/FrontEnd/Blueprints/PartyDisplayManagerBP.PartyDisplayManagerBP_C.SetUIOverrideVisuals
	// void SetUIOverrideVisuals(UTexture2D* Large Texture, UFortItemDefinition* Item, EFortRarity Rarity);                     // [0x101681c] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/PartyDisplayManagerBP.PartyDisplayManagerBP_C.GetWeaponPlacementTransform
	// FTransform GetWeaponPlacementTransform();                                                                                // [0x101681c] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/PartyDisplayManagerBP.PartyDisplayManagerBP_C.UpdatePreviewMeshTransforms
	// void UpdatePreviewMeshTransforms();                                                                                      // [0x101681c] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/PartyDisplayManagerBP.PartyDisplayManagerBP_C.GetItemPreviewOffset
	// FTransform GetItemPreviewOffset(UFortItemDefinition* ItemDefinition);                                                    // [0x101681c] Private|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// FTransform GetPreviewMeshWorldTransform();                                                                               // [0x101681c] Private|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Environments/FrontEnd/Blueprints/PartyDisplayManagerBP.PartyDisplayManagerBP_C.SetupStaticMeshVisuals
	// void SetupStaticMeshVisuals(UStaticMesh* NewMesh);                                                                       // [0x101681c] Private|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/PartyDisplayManagerBP.PartyDisplayManagerBP_C.SetupSkeletalMeshVisuals
	// void SetupSkeletalMeshVisuals(USkeletalMesh* NewMesh);                                                                   // [0x101681c] Private|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Environments/FrontEnd/Blueprints/PartyDisplayManagerBP.PartyDisplayManagerBP_C.ResetVisuals
	// void ResetVisuals();                                                                                                     // [0x101681c] Private|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void HoloMatColorPulse__FinishedFunc();                                                                                  // [0x101681c] BlueprintEvent       
	...
	// void HoloMatColorPulse__UpdateFunc();                                                                                    // [0x101681c] BlueprintEvent       
	...
	// void HandleLoadingAssetsForItemCompleted(UFortItem* ItemWhoseAssetsWereLoaded, TArray<UObject*>& LoadedAssets, FGuid& RequestID); // [0x101681c] Event|Public|HasOutParms|BlueprintEvent 
	...
	// void Set Character Parts Visibility(bool NewVisible);                                                                    // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void CharacterCustomizationFinished(AFortPlayerPawn* Pawn);                                                              // [0x101681c] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_PartyDisplayManagerBP(int32_t EntryPoint);                                                         // [0x101681c] Final|HasDefaults    
};
