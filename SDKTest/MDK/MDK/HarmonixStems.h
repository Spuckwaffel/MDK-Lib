...
public:
	CMember(UMidiFile*)                                MidiFile                                                    OFFSET(get<T>, {0x30, 8, 0, 0})
	CMember(UStemConfiguration*)                       StemConfiguration                                           OFFSET(get<T>, {0x38, 8, 0, 0})
};
...
public:
	CMember(UMediaPlayer*)                             MediaPlayer                                                 OFFSET(get<T>, {0x40, 8, 0, 0})
