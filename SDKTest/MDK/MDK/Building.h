...
public:
	...
	DMember(int32_t)                                   GnomeWallChance                                             OFFSET(get<int32_t>, {0xD40, 4, 0, 0})
	DMember(int32_t)                                   GnomeWallMax                                                OFFSET(get<int32_t>, {0xD44, 4, 0, 0})
	DMember(bool)                                      Gnomed                                                      OFFSET(get<bool>, {0xD48, 1, 0, 0})
	CMember(UMaterialInstanceConstant*)                GnomeMaterial                                               OFFSET(get<T>, {0xD50, 8, 0, 0})
	CMember(UStaticMesh*)                              GnomeWall                                                   OFFSET(get<T>, {0xD58, 8, 0, 0})
	...
	// void ExecuteUbergraph_PBWA_S1_Solid(int32_t EntryPoint);                                                                 // [0x101681c] Final|HasDefaults    
};
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0xD38, 8, 0, 0})
	CMember(TArray<UStaticMesh*>)                      StaticMeshAlternateArray                                    OFFSET(get<T>, {0xD40, 16, 0, 0})


	/// Functions
	// Function /Game/Building/ActorBlueprints/Player/Master/PBW_BP_Parent.PBW_BP_Parent_C.OnRep_Random Chance
	// void OnRep_Random Chance();                                                                                              // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_PBW_BP_Parent(int32_t EntryPoint);                                                                 // [0x101681c] Final                
};
