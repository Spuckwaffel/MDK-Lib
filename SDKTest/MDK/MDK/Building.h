...
public:
	...
	// void ExecuteUbergraph_PBWA_S1_Solid(int32_t EntryPoint);                                                                 // [0x1d9241c] Final|HasDefaults    
};
...
public:
	...
	// void OnRep_Random Chance();                                                                                              // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_PBW_BP_Parent(int32_t EntryPoint);                                                                 // [0x1d9241c] Final                
};
