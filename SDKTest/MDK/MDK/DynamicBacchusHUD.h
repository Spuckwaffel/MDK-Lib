...
public:
	...
	CMember(UFortMobileHUDWidgetRegistry*)             BaseHUDWidgetRegistry                                       OFFSET(get<T>, {0x310, 8, 0, 0})
	CMember(UDynamicUIScene*)                          WatermarkScene                                              OFFSET(get<T>, {0x318, 8, 0, 0})
	CMember(TMap<FGameplayTag, UDynamicUIMobileScene*>) ScenesPool                                                 OFFSET(get<T>, {0x320, 80, 0, 0})
	CMember(UFortMobileHUDWidgetRegistry*)             HUDWidgetRegistry                                           OFFSET(get<T>, {0x370, 8, 0, 0})
