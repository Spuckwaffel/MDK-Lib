...
public:
	...
	SMember(FFootPlacementPelvisSettings)              PelvisSettings                                              OFFSET(getStruct<T>, {0xE4, 28, 0, 0})
	CMember(TArray<FFootPlacemenLegDefinition>)        LegDefinitions                                              OFFSET(get<T>, {0x100, 16, 0, 0})
	SMember(FFootPlacementPlantSettings)               PlantSettings                                               OFFSET(getStruct<T>, {0x110, 52, 0, 0})
	SMember(FFootPlacementInterpolationSettings)       InterpolationSettings                                       OFFSET(getStruct<T>, {0x144, 36, 0, 0})
	SMember(FFootPlacementTraceSettings)               TraceSettings                                               OFFSET(getStruct<T>, {0x168, 28, 0, 0})
};
...
public:
	...
	SMember(FBoneReference)                            IKFootRootBone                                              OFFSET(getStruct<T>, {0xF0, 12, 0, 0})
