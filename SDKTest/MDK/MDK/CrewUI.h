...
public:
	CMember(EBattlePassPurchaseButtonCurrencyType)     CurrencyType                                                OFFSET(get<T>, {0x1508, 1, 0, 0})
	CMember(UCommonTextBlock*)                         Text_Label                                                  OFFSET(get<T>, {0x1510, 8, 0, 0})
	CMember(UCommonTextBlock*)                         Text_SecondaryLabel                                         OFFSET(get<T>, {0x1518, 8, 0, 0})
	CMember(UCommonTextBlock*)                         Text_FinalCost                                              OFFSET(get<T>, {0x1520, 8, 0, 0})
	CMember(UWidget*)                                  Container_SecondaryLabel                                    OFFSET(get<T>, {0x1528, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.BattlePassCrewPurchaseButton.OnCurrencyUpdated
	// void OnCurrencyUpdated();                                                                                                // [0x1ebf994] Event|Protected|BlueprintEvent 
};
...
public:
	DMember(float)                                     CrewUpsellTransitionDelayTime                               OFFSET(get<float>, {0x408, 4, 0, 0})
	CMember(UCommonActivatableWidgetSwitcher*)         Switcher_ContentContainer                                   OFFSET(get<T>, {0x418, 8, 0, 0})
	CMember(UBattlePassPurchaseScreen*)                BattlePassPurchaseScreen                                    OFFSET(get<T>, {0x420, 8, 0, 0})
	CMember(UWidgetAnimation*)                         Intro                                                       OFFSET(get<T>, {0x428, 8, 0, 0})
	CMember(UWidgetAnimation*)                         QuickIntro                                                  OFFSET(get<T>, {0x430, 8, 0, 0})
	CMember(UWidgetAnimation*)                         CrewBenefitsIntro                                           OFFSET(get<T>, {0x438, 8, 0, 0})
	CMember(UClass*)                                   CrewSubscriptionErrorModalClass                             OFFSET(get<T>, {0x440, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.BattlePassCrewPurchaseContainer.OnTriggerIntroAnimation
	// void OnTriggerIntroAnimation(bool bCanClaimRewards);                                                                     // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassCrewPurchaseContainer.OnContentStateUpdated
	// void OnContentStateUpdated(EBattlePassCrewContentState InState, bool bInScreenOpened);                                   // [0x1ebf994] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(UCommonRichTextBlock*)                     Text_Season                                                 OFFSET(get<T>, {0x2D0, 8, 0, 0})
};
...
public:
	DMember(float)                                     CrewTransitionDelayTime                                     OFFSET(get<float>, {0x464, 4, 0, 0})
	CMember(UClass*)                                   PurchaseCompleteModal                                       OFFSET(get<T>, {0x4D8, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_ToCrew                                               OFFSET(get<T>, {0x4E0, 8, 0, 0})
	CMember(UBattlePassCrewPurchaseButton*)            Button_Purchase                                             OFFSET(get<T>, {0x4E8, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_MoreInfo                                             OFFSET(get<T>, {0x4F0, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_GiftBattlePass                                       OFFSET(get<T>, {0x4F8, 8, 0, 0})
	CMember(UBattlePassCrewPurchaseButton*)            Button_ConfirmBase                                          OFFSET(get<T>, {0x500, 8, 0, 0})
	CMember(UBattlePassCrewPurchaseButton*)            Button_ConfirmBundle                                        OFFSET(get<T>, {0x508, 8, 0, 0})
	CMember(UBattlePassSeasonHeading*)                 Heading_Primary                                             OFFSET(get<T>, {0x510, 8, 0, 0})
	CMember(UBattlePassSeasonHeading*)                 Heading_Secondary                                           OFFSET(get<T>, {0x518, 8, 0, 0})
	CMember(UCommonRichTextBlock*)                     RichText_Disclaimer                                         OFFSET(get<T>, {0x520, 8, 0, 0})
	CMember(UCommonTextBlock*)                         Text_Description                                            OFFSET(get<T>, {0x528, 8, 0, 0})
	CMember(UCommonAnimatedSwitcher*)                  Switcher_PurchaseState                                      OFFSET(get<T>, {0x530, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.BattlePassPurchaseScreen.RefreshFocus
	// void RefreshFocus();                                                                                                     // [0x9b04830] Final|Native|Protected|BlueprintCallable 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnShowNavButtonNotification
	// void OnShowNavButtonNotification(bool bShowNotification);                                                                // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnSetScreenInteractable
	// void OnSetScreenInteractable(bool bInteractable);                                                                        // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnSetNavButtonNotificationText
	// void OnSetNavButtonNotificationText(FText& NotificationText);                                                            // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnPurchaseStateChanged
	// void OnPurchaseStateChanged(EBattlePassPurchaseState InCurrentState);                                                    // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.BattlePassPurchaseScreen.OnPurchaseConfirmed
	// void OnPurchaseConfirmed();                                                                                              // [0x1ebf994] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(UDynamicEntryBox*)                         EntryBox_BulletPoints                                       OFFSET(get<T>, {0x3F0, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_OpenHowToURL                                         OFFSET(get<T>, {0x3F8, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_TextURL                                              OFFSET(get<T>, {0x400, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_DoNotRemind                                          OFFSET(get<T>, {0x408, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_Close                                                OFFSET(get<T>, {0x410, 8, 0, 0})
	...
	// void OnSetHowToCancelURL(FString MoreInfoUrl);                                                                           // [0x1ebf994] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(UCommonButtonBase*)                        Button_Accept                                               OFFSET(get<T>, {0x3F0, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_CancelSubscription                                   OFFSET(get<T>, {0x3F8, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_MoreInfo                                             OFFSET(get<T>, {0x400, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_TextURL                                              OFFSET(get<T>, {0x408, 8, 0, 0})
	CMember(TWeakObjectPtr<UClass*>)                   CancellationInfoModalClass                                  OFFSET(get<T>, {0x410, 32, 0, 0})


	/// Functions
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeTitle
	// void OnSetPriceChangeAcknowledgeTitle(FText& Title);                                                                     // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeMoreInfoUrl
	// void OnSetPriceChangeAcknowledgeMoreInfoUrl(FText& MoreInfoUrl);                                                         // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeMoreInfoText
	// void OnSetPriceChangeAcknowledgeMoreInfoText(FText& ConfirmButtonText);                                                  // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeConfirmButtonText
	// void OnSetPriceChangeAcknowledgeConfirmButtonText(FText& ConfirmButtonText);                                             // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeCheckboxText
	// void OnSetPriceChangeAcknowledgeCheckboxText(FText& CheckboxText);                                                       // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeCancelSubscriptionButtonText
	// void OnSetPriceChangeAcknowledgeCancelSubscriptionButtonText(FText& CancelSubscriptionButtonText);                       // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeBodyText
	// void OnSetPriceChangeAcknowledgeBodyText(FText& BodyText);                                                               // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPriceChangeAcknowledgeModal.OnSetPriceChangeAcknowledgeBodyTable
	// void OnSetPriceChangeAcknowledgeBodyTable(TArray<FCrewTableRow>& PriceChangeByRegionRows);                               // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void ExitModal();                                                                                                        // [0x6644d08] Final|Native|Protected|BlueprintCallable 
};
...
public:
	DMember(bool)                                      bManagementModeEnabled                                      OFFSET(get<bool>, {0x490, 1, 0, 0})
	CMember(UWidget*)                                  ContentPurchasedFocusWidget                                 OFFSET(get<T>, {0x498, 8, 0, 0})
	CMember(UWidget*)                                  FocusWidget                                                 OFFSET(get<T>, {0x4A0, 8, 0, 0})
	CMember(UCommonButtonGroupBase*)                   ButtonGroup_BenefitsTiles                                   OFFSET(get<T>, {0x4A8, 8, 0, 0})
	CMember(TWeakObjectPtr<UClass*>)                   CancellationInfoModalClass                                  OFFSET(get<T>, {0x4B0, 32, 0, 0})
	CMember(TWeakObjectPtr<UClass*>)                   LegalInfoModalClass                                         OFFSET(get<T>, {0x4D0, 32, 0, 0})
	CMember(TWeakObjectPtr<UClass*>)                   ResolveIssueModalClass                                      OFFSET(get<T>, {0x4F0, 32, 0, 0})
	CMember(TWeakObjectPtr<UClass*>)                   RejoinModalClass                                            OFFSET(get<T>, {0x510, 32, 0, 0})
	CMember(UCommonButtonBase*)                        Button_ToBattlePass                                         OFFSET(get<T>, {0x530, 8, 0, 0})
	CMember(UBattlePassCrewPurchaseButton*)            Button_Purchase                                             OFFSET(get<T>, {0x538, 8, 0, 0})
	CMember(UBattlePassCrewPurchaseButton*)            Button_Rejoin                                               OFFSET(get<T>, {0x540, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_ResolvePayment                                       OFFSET(get<T>, {0x548, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_WatchTrailer                                         OFFSET(get<T>, {0x550, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_Terms                                                OFFSET(get<T>, {0x558, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_CancellationInfo                                     OFFSET(get<T>, {0x560, 8, 0, 0})
	CMember(UDynamicEntryBox*)                         EntryBox_RecurringRewards                                   OFFSET(get<T>, {0x568, 8, 0, 0})
	CMember(UDynamicEntryBox*)                         EntryBox_LimitedTimeRewards                                 OFFSET(get<T>, {0x570, 8, 0, 0})
	CMember(UCrewTileDetails*)                         Details_CurrentCrewTile                                     OFFSET(get<T>, {0x578, 8, 0, 0})
	CMember(UCommonTextBlock*)                         Text_LimitedTime                                            OFFSET(get<T>, {0x580, 8, 0, 0})
	CMember(UOverlay*)                                 Overlay_UserInformation                                     OFFSET(get<T>, {0x588, 8, 0, 0})
	CMember(UCommonTextBlock*)                         Text_UserInformation                                        OFFSET(get<T>, {0x590, 8, 0, 0})
	CMember(UCommonTextBlock*)                         Text_CrewDisclaimer                                         OFFSET(get<T>, {0x598, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.CrewPurchaseScreen.OnUserInformationTextsUpdated
	// void OnUserInformationTextsUpdated(FText& UserInformationText1, FText& UserInformationText2, EMcpSubscriptionState SubscriptionState); // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.CrewPurchaseScreen.OnUpdateVBuckRefundVisibility
	// void OnUpdateVBuckRefundVisibility(bool bVisible);                                                                       // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewPurchaseScreen.OnUpdatePurchaseButtonState
	// void OnUpdatePurchaseButtonState(ECrewPurchaseButtonState ButtonState);                                                  // [0x1ebf994] Event|Protected|BlueprintEvent 
	...
	// void OnSetPaymentLegalText(FText& LegalText);                                                                            // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void OnContainerTabVisibilityUpdated(bool bTabsVisible, float SpacingAdjustmentForTabs);                                 // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewPurchaseScreen.EndProgress
	// void EndProgress();                                                                                                      // [0x1ebf994] Event|Protected|BlueprintEvent 
	...
	// void BeginProgress(FText& ProgressLabel);                                                                                // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	DMember(float)                                     TileImageStreamoutSeconds                                   OFFSET(get<float>, {0x14B0, 4, 0, 0})
	CMember(UImage*)                                   Image_TileImage                                             OFFSET(get<T>, {0x14B8, 8, 0, 0})
	CMember(UCommonTextBlock*)                         Text_TileLabel                                              OFFSET(get<T>, {0x14C0, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.CrewRewardTile.OnUpdateOwnedState
	// void OnUpdateOwnedState(bool bOwned);                                                                                    // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewRewardTile.OnStartingDownloadTileImage
	// void OnStartingDownloadTileImage();                                                                                      // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewRewardTile.OnDownloadTileImageComplete
	// void OnDownloadTileImageComplete(UTexture2D* Texture);                                                                   // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.CrewRewardTile.IsMonthlyBenefit
	// bool IsMonthlyBenefit();                                                                                                 // [0x9b04804] Final|Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	CMember(TWeakObjectPtr<UClass*>)                   ResolveIssueModalClass                                      OFFSET(get<T>, {0x460, 32, 0, 0})
	CMember(UBattlePassSeasonHeading*)                 Heading_SeasonInfo                                          OFFSET(get<T>, {0x480, 8, 0, 0})
	CMember(UCommonTextBlock*)                         Text_Description                                            OFFSET(get<T>, {0x488, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_Claim                                                OFFSET(get<T>, {0x490, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_ResolveIssue                                         OFFSET(get<T>, {0x498, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_GiftBattlePass                                       OFFSET(get<T>, {0x4A0, 8, 0, 0})
	CMember(UCommonRichTextBlock*)                     RichText_Disclaimer                                         OFFSET(get<T>, {0x4A8, 8, 0, 0})
};
...
public:
	CMember(UCrewSubscriptionContentContainer*)        Widget_CrewContentContainer                                 OFFSET(get<T>, {0x710, 8, 0, 0})
};
...
public:
	...
	// void OnTabSelected(int32_t TabIndex);                                                                                    // [0x1ebf994] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(UCommonButtonBase*)                        Button_Close                                                OFFSET(get<T>, {0x3E8, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_TouchClose                                           OFFSET(get<T>, {0x3F0, 8, 0, 0})
};
...
public:
	...
	CMember(UDynamicEntryBox*)                         EntryBox_Tags                                               OFFSET(get<T>, {0x308, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_MobileMoreInfo                                       OFFSET(get<T>, {0x310, 8, 0, 0})
};
...
public:
	CMember(UCommonRichTextBlock*)                     Text_Label                                                  OFFSET(get<T>, {0x2D0, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.CrewTileDetailsTag.OnTagSetup
	// void OnTagSetup(ECrewDetailsTag RewardTag, bool bIsOwnedTag);                                                            // [0x1ebf994] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(UCommonActivatableWidgetSwitcher*)         Switcher_PrimaryContent                                     OFFSET(get<T>, {0x420, 8, 0, 0})
	CMember(UFortProgressiveTableOfContentsScreen*)    Widget_ProgressiveTableOfContentsScreen                     OFFSET(get<T>, {0x428, 8, 0, 0})
	CMember(UFortProgressiveItemScreen*)               Widget_ProgressiveItemScreen                                OFFSET(get<T>, {0x430, 8, 0, 0})
};
...
public:
	CMember(UCommonTextBlock*)                         Text_CosmeticStage                                          OFFSET(get<T>, {0x2A8, 8, 0, 0})
	CMember(UCommonRichTextBlock*)                     Text_UnlockCriteria                                         OFFSET(get<T>, {0x2B0, 8, 0, 0})
	CMember(UWidget*)                                  Widget_UnlockCriteriaContainer                              OFFSET(get<T>, {0x2B8, 8, 0, 0})
	CMember(UAthenaRewardItemTypeRarityTag*)           Widget_ItemTypeRarityTag                                    OFFSET(get<T>, {0x2C0, 8, 0, 0})
	CMember(UWidget*)                                  Tag_Owned                                                   OFFSET(get<T>, {0x2C8, 8, 0, 0})
};
...
public:
	DMember(float)                                     RewardPreviewTime                                           OFFSET(get<float>, {0x75C, 4, 0, 0})


	/// Functions
	// Function /Script/CrewUI.FortProgressiveScreenBase.BP_OnContainerTabVisibilityUpdated
	// void BP_OnContainerTabVisibilityUpdated(bool bTabsVisible, float SpacingAdjustmentForTabs);                              // [0x1ebf994] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(UWidget*)                                  ContentPurchasedFocusWidget                                 OFFSET(get<T>, {0x770, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_Back                                                 OFFSET(get<T>, {0x778, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_TouchBack                                            OFFSET(get<T>, {0x780, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_MoreInfo                                             OFFSET(get<T>, {0x788, 8, 0, 0})
	CMember(UBattlePassCrewPurchaseButton*)            Button_Subscribe                                            OFFSET(get<T>, {0x790, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_PreviewStyles                                        OFFSET(get<T>, {0x798, 8, 0, 0})
	CMember(UCommonTextBlock*)                         Text_ExpirationFinePrint                                    OFFSET(get<T>, {0x7A0, 8, 0, 0})
	CMember(UCommonTextBlock*)                         Text_NewStagesUnlockFinePrint                               OFFSET(get<T>, {0x7A8, 8, 0, 0})
	CMember(UDynamicEntryBox*)                         EntryBox_StagesPips                                         OFFSET(get<T>, {0x7B0, 8, 0, 0})
	CMember(UCommonButtonGroupBase*)                   ButtonGroup_StagesPips                                      OFFSET(get<T>, {0x7B8, 8, 0, 0})
	CMember(UFortProgressiveItemDetailsWidget*)        Widget_ProgressiveItemDetails                               OFFSET(get<T>, {0x7C0, 8, 0, 0})
	...
	// void OnUpdateSubscriptionState(bool bSubscribed);                                                                        // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemScreen.OnSetIsSoloScreen
	// void OnSetIsSoloScreen(bool bInIsSoloScreen);                                                                            // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemScreen.OnItemSelected
	// void OnItemSelected();                                                                                                   // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemScreen.OnErrorStateTextUpdated
	// void OnErrorStateTextUpdated(FText& ErrorStateText);                                                                     // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
...
public:
	...
	// void OnTileMaterialLoaded(bool bSubscribed);                                                                             // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemWidget.OnStageItemChanged
	// void OnStageItemChanged(FProgressiveStageItemInfo& InStageItemInfo);                                                     // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveItemWidget.OnPeekStateChanged
	// void OnPeekStateChanged(bool bIsInPeekState);                                                                            // [0x1ebf994] Event|Protected|BlueprintEvent 
...
public:
	CMember(UCommonButtonBase*)                        Button_MoreInfo                                             OFFSET(get<T>, {0x2A8, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.FortProgressiveSetDetailsWidget.BP_OnUpdateSetDetails
	// void BP_OnUpdateSetDetails(FText& SetName, FText& ExpiringText, bool bCompleted);                                        // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	CMember(UAthenaScrollBox*)                         ScrollBox_SetList                                           OFFSET(get<T>, {0x3F0, 8, 0, 0})
	CMember(UFortSwipePanel*)                          SwipePanel_Navigation                                       OFFSET(get<T>, {0x3F8, 8, 0, 0})
	CMember(UCommonButtonGroupBase*)                   ButtonGroup_SetTiles                                        OFFSET(get<T>, {0x400, 8, 0, 0})
	DMember(int32_t)                                   NumTilesPerPage                                             OFFSET(get<int32_t>, {0x408, 4, 0, 0})
	CMember(TArray<UFortProgressiveSetTile*>)          SetTiles                                                    OFFSET(get<T>, {0x410, 16, 0, 0})


	/// Functions
	// Function /Script/CrewUI.FortProgressiveSetList.ClearSetTiles
	// void ClearSetTiles();                                                                                                    // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveSetList.AddSetTile
	// UFortProgressiveSetTile* AddSetTile();                                                                                   // [0x1ebf994] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(UCommonButtonGroupBase*)                   ButtonGroup_StageItems                                      OFFSET(get<T>, {0x400, 8, 0, 0})
	CMember(UAthenaScrollBox*)                         ScrollBox_StageList                                         OFFSET(get<T>, {0x408, 8, 0, 0})
	CMember(UFortSwipePanel*)                          SwipePanel_Navigation                                       OFFSET(get<T>, {0x410, 8, 0, 0})
	CMember(TArray<UFortProgressiveStageWidget*>)      Stages                                                      OFFSET(get<T>, {0x420, 16, 0, 0})


	/// Functions
	// Function /Script/CrewUI.FortProgressiveStageList.SelectStageInDirection
	// void SelectStageInDirection(int32_t Direction);                                                                          // [0x9b0484c] Final|Native|Public|BlueprintCallable 
	// Function /Script/CrewUI.FortProgressiveStageList.ClearStageWidgets
	// void ClearStageWidgets();                                                                                                // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveStageList.AddStageWidget
	// UFortProgressiveStageWidget* AddStageWidget();                                                                           // [0x1ebf994] Event|Protected|BlueprintEvent 
};
...
public:
	CMember(UCommonTextBlock*)                         Text_Month                                                  OFFSET(get<T>, {0x2D0, 8, 0, 0})


	/// Functions
	// Function /Script/CrewUI.FortProgressiveStageWidget.OnSetTooltipVisible
	// void OnSetTooltipVisible(bool bVisible);                                                                                 // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveStageWidget.OnSetTooltipText
	// void OnSetTooltipText(FText& InToolTipText);                                                                             // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
	...
	// void ClearStageItemWidgets();                                                                                            // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveStageWidget.AddStageItemWidget
	// UFortProgressiveItemWidget* AddStageItemWidget();                                                                        // [0x1ebf994] Event|Protected|BlueprintEvent 
};
...
public:
	...
	CMember(UCommonButtonBase*)                        Button_MoreInfo                                             OFFSET(get<T>, {0x788, 8, 0, 0})
	CMember(UBattlePassCrewPurchaseButton*)            Button_Subscribe                                            OFFSET(get<T>, {0x790, 8, 0, 0})
	CMember(UFortProgressiveSetList*)                  Widget_SetList                                              OFFSET(get<T>, {0x798, 8, 0, 0})
	CMember(UFortProgressiveSetDetailsWidget*)         Widget_SetDetails                                           OFFSET(get<T>, {0x7A0, 8, 0, 0})
	CMember(UFortProgressiveItemStateTitleWidget*)     Widget_ItemStateTitle                                       OFFSET(get<T>, {0x7A8, 8, 0, 0})
	...
	// void BP_OnUpdateSubscriptionState(bool bSubscribed);                                                                     // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateNumTilesAvailable
	// void BP_OnUpdateNumTilesAvailable(int32_t NumTiles);                                                                     // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateErrorStateText
	// void BP_OnUpdateErrorStateText(FText& ErrorStateText);                                                                   // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveTableOfContentsScreen.BP_OnUpdateBanner
	// void BP_OnUpdateBanner(FText& BannerText, bool bAllSetsCompleted, bool bSubscribed);                                     // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/CrewUI.FortProgressiveTableOfContentsScreen.BP_OnSetDescriptionText
	// void BP_OnSetDescriptionText(FText& ProductDescription);                                                                 // [0x1ebf994] Event|Protected|HasOutParms|BlueprintEvent 
