...
public:
	...
	// void PlaySoundCue(USoundCue* SoundToPlay, UAudioComponent* AudioComponent, bool& Success);                               // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void SetSourceEffectChainToApply(USoundEffectSourcePresetChain* SourceEffectChain);                                      // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Internal Get Voice Sound Bank(UFortTaggedSoundBank*& Sound Bank);                                                   // [0x1ebf994] Private|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void Deprecated Set Sound Bank(UFortTaggedSoundBank* SoundBank);                                                         // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Sounds/Fort_Audio_Blueprints/VoiceComponent/NPC_VoiceComponent.NPC_VoiceComponent_C.PlayVoiceLine
	// void PlayVoiceLine(FGameplayTag& Gameplay Tag, UAudioComponent* AudioComponent, bool& Success);                          // [0x1ebf994] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void ActuallyPlaySound();                                                                                                // [0x1ebf994] Private|BlueprintCallable|BlueprintEvent 
	...
	// void SetSurfaceType(TEnumAsByte<EPhysicalSurface> SurfaceType, AActor* Actor);                                           // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	...
	// void PlaySound(FVector Location);                                                                                        // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Test Delay();                                                                                                       // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_SurfaceTypeSoundComponent(int32_t EntryPoint);                                                  // [0x1ebf994] Final                
};
...
public:
	...
	// void Change Music(USoundBase* New Music, double StartTime, FGameplayTag Event Tag);                                      // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void ListenToMusicPacks();                                                                                               // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void OnMusicPackChanged(UAthenaMusicPackItemDefinition* NewMusicPack, float StartTimeOffset);                            // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void Lobby Music Override(bool Lobby Music Activate, USoundBase* New Music);                                             // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void SetCanRetriggerNextMusicPack(bool bCanRetriggerNextMusicPack);                                                      // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void PlayEquippedMusicPack();                                                                                            // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /Game/Sounds/Fort_Audio_Blueprints/Fort_Entry_Music_Controller_BP.Fort_Entry_Music_Controller_BP_C.StartMusic
	// void StartMusic();                                                                                                       // [0x1ebf994] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_Fort_Entry_Music_Controller_BP(int32_t EntryPoint);                                                // [0x1ebf994] Final|HasDefaults    
};
...
public:
	...
	// void OnPaint(FPaintContext& Context);                                                                                    // [0x1ebf994] BlueprintCosmetic|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|Const 
	// Function /Game/Sounds/AudioAnalysis/DebugHUD/WB_AudioAnalysis_FloatGraph.WB_AudioAnalysis_FloatGraph_C.calcWidgetSize
	// void calcWidgetSize(FGeometry geom);                                                                                     // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/Sounds/AudioAnalysis/DebugHUD/WB_AudioAnalysis_FloatGraph.WB_AudioAnalysis_FloatGraph_C.Set Value
	// void Set Value(double Value);                                                                                            // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Initialize MPC(FName Parameter, UMaterialParameterCollection* Collection, int32_t VectorIndex);                     // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_WB_AudioAnalysis_FloatGraph(int32_t EntryPoint);                                                   // [0x1ebf994] Final|HasDefaults    
};
...
public:
	...
	// void AddScalarParameter(FAudioAnalysisParameterScalar& Param);                                                           // [0x1ebf994] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Game/Sounds/AudioAnalysis/DebugHUD/WB_AudioAnalysis_UI.WB_AudioAnalysis_UI_C.AddVectorParameter
	// void AddVectorParameter(FAudioAnalysisParameterVector& Param);                                                           // [0x1ebf994] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Game/Sounds/AudioAnalysis/DebugHUD/WB_AudioAnalysis_UI.WB_AudioAnalysis_UI_C.ClearParameters
	// void ClearParameters();                                                                                                  // [0x1ebf994] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_WB_AudioAnalysis_UI(int32_t EntryPoint);                                                           // [0x1ebf994] Final|HasDefaults    
};
...
public:
	...
	// void FilterInstances();                                                                                                  // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /Game/Sounds/MusicEventSubsystem/B_MusicEventDebugWidget.B_MusicEventDebugWidget_C.SetEventInstances
	// void SetEventInstances(TArray<UMusicEventInstance*>& Instances);                                                         // [0x1ebf994] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Game/Sounds/MusicEventSubsystem/B_MusicEventDebugWidget.B_MusicEventDebugWidget_C.SetMusicEventPos
	// void SetMusicEventPos(double X, double Y);                                                                               // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /Game/Sounds/MusicEventSubsystem/B_MusicEventDebugWidget.B_MusicEventDebugWidget_C.SetMusicEventAssetFilter
	// void SetMusicEventAssetFilter(FString Filter);                                                                           // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /Game/Sounds/MusicEventSubsystem/B_MusicEventDebugWidget.B_MusicEventDebugWidget_C.SetMusicEventFontSize
	// void SetMusicEventFontSize(int32_t Size);                                                                                // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_B_MusicEventDebugWidget(int32_t EntryPoint);                                                       // [0x1ebf994] Final|HasDefaults    
};
...
public:
	...
	CMember(UB_MusicEventDebugWidget_C*)               DebugWidget                                                 OFFSET(get<T>, {0x2C8, 8, 0, 0})


	/// Functions
	// Function /Game/Sounds/MusicEventSubsystem/B_MusicEventInstanceWidget.B_MusicEventInstanceWidget_C.GetTextColor
	// FSlateColor GetTextColor();                                                                                              // [0x1ebf994] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/Sounds/MusicEventSubsystem/B_MusicEventInstanceWidget.B_MusicEventInstanceWidget_C.GetFormatText
	// void GetFormatText(FText& Result);                                                                                       // [0x1ebf994] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void ExecuteUbergraph_B_MusicEventInstanceWidget(int32_t EntryPoint);                                                    // [0x1ebf994] Final|HasDefaults    
};
...
public:
	...
	// void OnWaterDepthSwitch();                                                                                               // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	...
	// void OnWaterUpdate();                                                                                                    // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Movement Mode Change(ACharacter* Character, TEnumAsByte<EMovementMode> PrevMovementMode, char PreviousCustomMode);  // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	...
	// void OnExitWater(AFortPlayerPawn* FortPlayerPawn, bool bPawnIsOutsideOfAllWaterBodies);                                  // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	...
	// void OnEnterWater(AFortPlayerPawn* FortPlayerPawn);                                                                      // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	...
	// float GetWaterDepthValue();                                                                                              // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void PrintParameter(FAudioParameterQueryData& Parameter, bool Condition);                                                // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void OnViewTargetSet(AActor* Actor);                                                                                     // [0x1ebf994] Event|Public|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_AudioParameterComponent_Pawn(int32_t EntryPoint);                                               // [0x1ebf994] Final                
};
...
public:
	...
	// void OnSoundPlayed(FGameplayTag InEventName, UAudioComponent* InComponent);                                              // [0x1ebf994] Event|Public|BlueprintCallable|BlueprintEvent 
	...
	// void OnSoundStopped(FGameplayTag InEventName, UAudioComponent* InComponent, bool& bStopped);                             // [0x1ebf994] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void TryHandleFireEvent(FGameplayTag Event, UAudioComponent* Component);                                                 // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
};
...
public:
	...
	// void OnEventPlayed(FGameplayTag InEventName);                                                                            // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_BP_SkydiveSoundLibraryComponent(int32_t EntryPoint);                                               // [0x1ebf994] Final                
};
