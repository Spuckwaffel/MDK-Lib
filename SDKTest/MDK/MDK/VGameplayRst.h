...
public:
	...
	// void OnRep_LightComponent();                                                                                             // [0x9724c10] Final|Native|Protected 
