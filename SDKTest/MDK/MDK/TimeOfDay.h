...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(get<T>, {0xFF0, 8, 0, 0})
	CMember(UPostProcessComponent*)                    HeavySSAO_Postprocess                                       OFFSET(get<T>, {0xFF8, 8, 0, 0})
	CMember(UPostProcessComponent*)                    EditorPostProcessMaterial_HackToWorkAroundTheOutlineShaderBeingInjectedByCodeAtRuntime_ OFFSET(get<T>, {0x1000, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       New_Storm_Timeline                                          OFFSET(get<T>, {0x1020, 8, 0, 0})
	...
	CMember(UTimelineComponent*)                       FlashLightning                                              OFFSET(get<T>, {0x1038, 8, 0, 0})
	...
	CMember(UParticleSystemComponent*)                 Storm_Foot_Particle_Outdoor                                 OFFSET(get<T>, {0x1098, 8, 0, 0})
	CMember(UParticleSystem*)                          Storm_Foot_Particle_While_on_Terrain                        OFFSET(get<T>, {0x10A0, 8, 0, 0})
	CMember(UParticleSystemComponent*)                 Storm_Foot_Particle_Indoor                                  OFFSET(get<T>, {0x10A8, 8, 0, 0})
	CMember(UParticleSystem*)                          Storm_Foot_Particle_While_NOT_on_Terrain                    OFFSET(get<T>, {0x10B0, 8, 0, 0})
	...
	SMember(FTimerHandle)                              LightningStrikeTimerHandle                                  OFFSET(get<T>, {0x10C8, 8, 0, 0})
	SMember(FLinearColor)                              PreviousDirectionalLightColor                               OFFSET(get<T>, {0x10D0, 16, 0, 0})
	SMember(FLinearColor)                              Lightning_Flash_Color                                       OFFSET(get<T>, {0x10E0, 16, 0, 0})
	...
	SMember(FLinearColor)                              SkyboxFogMorningColor                                       OFFSET(get<T>, {0x1100, 16, 0, 0})
	SMember(FLinearColor)                              SkyboxFogMorningLitColor                                    OFFSET(get<T>, {0x1110, 16, 0, 0})
	...
	SMember(FLinearColor)                              SkyboxFogDayColor                                           OFFSET(get<T>, {0x1150, 16, 0, 0})
	SMember(FLinearColor)                              SkyboxFogDayLitColor                                        OFFSET(get<T>, {0x1160, 16, 0, 0})
	...
	SMember(FLinearColor)                              SkyboxFogEveningColor                                       OFFSET(get<T>, {0x11A0, 16, 0, 0})
	SMember(FLinearColor)                              SkyboxFogEveningLitColor                                    OFFSET(get<T>, {0x11B0, 16, 0, 0})
	...
	SMember(FLinearColor)                              SkyboxFogNightColor                                         OFFSET(get<T>, {0x11F0, 16, 0, 0})
	SMember(FLinearColor)                              SkyboxFogNightLitColor                                      OFFSET(get<T>, {0x1200, 16, 0, 0})
	...
	SMember(FLinearColor)                              World_Border_Cloud_Sub_Surface_Color_and_Opacity            OFFSET(get<T>, {0x1248, 16, 0, 0})
	DMember(bool)                                      EnableCometDynamicPlacement                                 OFFSET(get<bool>, {0x1258, 1, 0, 0})
	SMember(FVector4)                                  Night                                                       OFFSET(get<T>, {0x1260, 32, 0, 0})
	...
	// void EmptyTransform(FTransform& Transform);                                                                              // [0x1ebf994] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /Game/TimeOfDay/TODM/MASTER_TODM.MASTER_TODM_C.SetHeavySSAO
	// void SetHeavySSAO();                                                                                                     // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	...
	// void DisableLightAndFog(bool Enable);                                                                                    // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /Game/TimeOfDay/TODM/MASTER_TODM.MASTER_TODM_C.EnableHDRRendering
	// void EnableHDRRendering();                                                                                               // [0x1ebf994] BlueprintCallable|BlueprintEvent 
...
public:
	...
	// void SetReflectionQualityMPC();                                                                                          // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	// Function /Game/TimeOfDay/TODM/TODM_Disabled.TODM_Disabled_C.SetGlobalIlluminationMPC
	// void SetGlobalIlluminationMPC();                                                                                         // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
