...
public:
	...
	SMember(FRotator)                                  SwingArmRotation                                            OFFSET(get<T>, {0x600, 24, 0, 0})
...
public:
	...
	SMember(FFortAnimInput_Motorcycle)                 MotorcycleInput                                             OFFSET(get<T>, {0x458, 84, 0, 0})
	CMember(AFortPlayerPawn*)                          FortPlayerPawn                                              OFFSET(get<T>, {0x4B0, 8, 0, 0})
	SMember(FVector)                                   WorldVelocity                                               OFFSET(get<T>, {0x4B8, 24, 0, 0})
	SMember(FVector)                                   LocalVelocity                                               OFFSET(get<T>, {0x4D0, 24, 0, 0})
	...
	SMember(FRotator)                                  RiderCatchupRotation                                        OFFSET(get<T>, {0x4F8, 24, 0, 0})
	...
	SMember(FFortAnimInput_VelocityImpact)             VelocityImpact                                              OFFSET(get<T>, {0x538, 240, 0, 0})
	SMember(FVector)                                   ImpactDisplacement                                          OFFSET(get<T>, {0x628, 24, 0, 0})
	...
	SMember(FVector)                                   FootTraceLocation                                           OFFSET(get<T>, {0x650, 24, 0, 0})
	...
	SMember(FVector)                                   LocalLeftOffset                                             OFFSET(get<T>, {0x678, 24, 0, 0})
	SMember(FVector)                                   WorldPosLeft                                                OFFSET(get<T>, {0x690, 24, 0, 0})
	SMember(FRotator)                                  LocalRotLeftOffset                                          OFFSET(get<T>, {0x6A8, 24, 0, 0})
	SMember(FRotator)                                  WorldRotLeft                                                OFFSET(get<T>, {0x6C0, 24, 0, 0})
	SMember(FVector)                                   LocalRightOffset                                            OFFSET(get<T>, {0x6D8, 24, 0, 0})
	SMember(FVector)                                   WorldPosRight                                               OFFSET(get<T>, {0x6F0, 24, 0, 0})
	SMember(FRotator)                                  LocalRotRightOffset                                         OFFSET(get<T>, {0x708, 24, 0, 0})
	SMember(FRotator)                                  WorldRotRight                                               OFFSET(get<T>, {0x720, 24, 0, 0})
	...
	SMember(FVector2D)                                 JumpPlayRateInRange                                         OFFSET(get<T>, {0x778, 16, 0, 0})
	SMember(FVector2D)                                 JumpPlayRateOutRange                                        OFFSET(get<T>, {0x788, 16, 0, 0})
	...
	SMember(FVector2D)                                 LandStartPosInRange                                         OFFSET(get<T>, {0x7B8, 16, 0, 0})
	SMember(FVector2D)                                 LandStartPosOutRange                                        OFFSET(get<T>, {0x7C8, 16, 0, 0})
	...
	SMember(FCachedAnimRelevancyData)                  IntroCachedTime                                             OFFSET(get<T>, {0x808, 20, 0, 0})
	...
	SMember(FRotator)                                  MeleeTwistRot                                               OFFSET(get<T>, {0x830, 24, 0, 0})
...
public:
	...
	SMember(FSoftObjectPath)                           ScytheMontage                                               OFFSET(get<T>, {0x8D8, 24, 0, 0})
	SMember(FName)                                     JumpTrickIntroPositionCurveName                             OFFSET(get<T>, {0x8F0, 4, 0, 0})
	SMember(FCachedAnimRelevancyData)                  FallStartCachedTime                                         OFFSET(get<T>, {0x8F4, 20, 0, 0})
	SMember(FCachedAnimRelevancyData)                  TrickCachedTime                                             OFFSET(get<T>, {0x908, 20, 0, 0})
};
...
public:
	...
	SMember(FCachedAnimRelevancyData)                  JumpIntroCachedTime                                         OFFSET(get<T>, {0x88C, 20, 0, 0})
...
public:
	SMember(FMulticastInlineDelegate)                  OnStartChargingJumpDelegate                                 OFFSET(get<T>, {0x1BF0, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnCancelChargingJumpDelegate                                OFFSET(get<T>, {0x1C00, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnJumpDelegate                                              OFFSET(get<T>, {0x1C10, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnChargingJumpDelegate                                      OFFSET(get<T>, {0x1C20, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnStartAirTrickDelegate                                     OFFSET(get<T>, {0x1C30, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnFinishAirTrickDelegate                                    OFFSET(get<T>, {0x1C40, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnStartWheelieDelegate                                      OFFSET(get<T>, {0x1C50, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnReleaseWheelieDelegate                                    OFFSET(get<T>, {0x1C60, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnLandWheelieDelegate                                       OFFSET(get<T>, {0x1C70, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnFailWheelieDelegate                                       OFFSET(get<T>, {0x1C80, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnStartStoppieDelegate                                      OFFSET(get<T>, {0x1C90, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnReleaseStoppieDelegate                                    OFFSET(get<T>, {0x1CA0, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnLandStoppieDelegate                                       OFFSET(get<T>, {0x1CB0, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnInventoryModeChangedDelegate                              OFFSET(get<T>, {0x1CC0, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  OnSuperSlidingChangedDelegate                               OFFSET(get<T>, {0x1CD0, 16, 0, 0})
	...
	SMember(FName)                                     RearAxleSocket                                              OFFSET(get<T>, {0x1D08, 4, 0, 0})
	...
	SMember(FString)                                   RoadAndExhaustNiagaraComponentName                          OFFSET(get<T>, {0x1E20, 16, 0, 0})
	SMember(FName)                                     RoadAndExhaustVehicleSpeedName                              OFFSET(get<T>, {0x1E30, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustSlideDirectionName                            OFFSET(get<T>, {0x1E34, 4, 0, 0})
	DMember(float)                                     RoadAndExhaustMinSpeedForDust                               OFFSET(get<float>, {0x1E38, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustDustRearName                                  OFFSET(get<T>, {0x1E3C, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustDustColorLerpName                             OFFSET(get<T>, {0x1E40, 4, 0, 0})
	DMember(float)                                     RoadAndExhaustDustColorLerp                                 OFFSET(get<float>, {0x1E44, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustDustAlphaMultiplierName                       OFFSET(get<T>, {0x1E48, 4, 0, 0})
	DMember(float)                                     RoadAndExhaustDustAlphaMultiplier                           OFFSET(get<float>, {0x1E4C, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustPeelOutColorIndexName                         OFFSET(get<T>, {0x1E50, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustPeelOutRearName                               OFFSET(get<T>, {0x1E54, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustIsPeelOutOnRoadName                           OFFSET(get<T>, {0x1E58, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustIsPeelOutOnRoadRewindName                     OFFSET(get<T>, {0x1E5C, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustIsInAirName                                   OFFSET(get<T>, {0x1E60, 4, 0, 0})
	SMember(FGameplayTag)                              RoadAndExhaustCameraDirtGameplayCueTag                      OFFSET(get<T>, {0x1E64, 4, 0, 0})
	SMember(FGameplayTag)                              RoadAndExhaustCameraWaterGameplayCueTag                     OFFSET(get<T>, {0x1E68, 4, 0, 0})
	...
	SMember(FName)                                     RoadAndExhaustHeadlightsName                                OFFSET(get<T>, {0x1E98, 4, 0, 0})
	SMember(FName)                                     RoadAndExhaustBrakelightsName                               OFFSET(get<T>, {0x1E9C, 4, 0, 0})
	SMember(FScalableFloat)                            DoorBashMinSpeed                                            OFFSET(get<T>, {0x1EA0, 40, 0, 0})
	SMember(FScalableFloat)                            DoorBashMaxSpeed                                            OFFSET(get<T>, {0x1EC8, 40, 0, 0})
	SMember(FScalableFloat)                            DoorBashForwardDistanceMin                                  OFFSET(get<T>, {0x1EF0, 40, 0, 0})
	SMember(FScalableFloat)                            DoorBashForwardDistanceMax                                  OFFSET(get<T>, {0x1F18, 40, 0, 0})
	SMember(FGameplayTag)                              DoorBashGameplayCueTag                                      OFFSET(get<T>, {0x1F40, 4, 0, 0})
	...
	SMember(FScalableFloat)                            DoorBashSphereRadiusForPawnLaunch                           OFFSET(get<T>, {0x1F68, 40, 0, 0})
	SMember(FScalableFloat)                            DoorBashScalarForPawnLaunch                                 OFFSET(get<T>, {0x1F90, 40, 0, 0})
	SMember(FGameplayTag)                              DoorBashPawnLaunchGameplayCueTag                            OFFSET(get<T>, {0x1FB8, 4, 0, 0})
...
public:
	...
	SMember(FVector)                                   WallPushXTraceOffset                                        OFFSET(get<T>, {0x8D0, 24, 0, 0})
	...
	SMember(FVector)                                   WallPushRightTraceOffset                                    OFFSET(get<T>, {0x8F8, 24, 0, 0})
	SMember(FVector)                                   WallPushRearRightTraceOffset                                OFFSET(get<T>, {0x910, 24, 0, 0})
	...
	SMember(FVector)                                   JumpForceMinCOMOffset                                       OFFSET(get<T>, {0x948, 24, 0, 0})
	SMember(FVector)                                   JumpForceMaxCOMOffset                                       OFFSET(get<T>, {0x960, 24, 0, 0})
	...
	SMember(FScalableFloat)                            TopSpeedKmh                                                 OFFSET(get<T>, {0xB50, 40, 0, 0})
};
...
public:
	SMember(FName)                                     WheelSocket                                                 OFFSET(get<T>, {0x0, 4, 0, 0})
