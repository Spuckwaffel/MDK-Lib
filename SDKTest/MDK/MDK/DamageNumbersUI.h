...
public:
	SMember(FVector)                                   WorldSpacePos                                               OFFSET(getStruct<T>, {0x2E0, 24, 0, 0})
	SMember(FGameplayTag)                              CheckAnimalTag                                              OFFSET(getStruct<T>, {0x2F8, 4, 0, 0})
	...
	SMember(FVector2D)                                 DamageNumberScaleVector                                     OFFSET(getStruct<T>, {0x310, 16, 0, 0})
	SMember(FVector2D)                                 ScreenSpaceOffsetFromHitActor                               OFFSET(getStruct<T>, {0x320, 16, 0, 0})
	SMember(FVector2D)                                 InverseHUDScaleVector                                       OFFSET(getStruct<T>, {0x330, 16, 0, 0})
	...
	SMember(FLinearColor)                              HitColor                                                    OFFSET(getStruct<T>, {0x34C, 16, 0, 0})
	SMember(FLinearColor)                              VehicleColor                                                OFFSET(getStruct<T>, {0x35C, 16, 0, 0})
	SMember(FLinearColor)                              CritColor                                                   OFFSET(getStruct<T>, {0x36C, 16, 0, 0})
	SMember(FLinearColor)                              HealthColor                                                 OFFSET(getStruct<T>, {0x37C, 16, 0, 0})
	SMember(FLinearColor)                              ShieldColor                                                 OFFSET(getStruct<T>, {0x38C, 16, 0, 0})
	SMember(FLinearColor)                              CritColor_Text                                              OFFSET(getStruct<T>, {0x39C, 16, 0, 0})
	SMember(FLinearColor)                              ShieldColor_Text                                            OFFSET(getStruct<T>, {0x3AC, 16, 0, 0})
	SMember(FLinearColor)                              HealthColor_InnerStroke                                     OFFSET(getStruct<T>, {0x3BC, 16, 0, 0})
	SMember(FLinearColor)                              ShieldColor_InnerStroke                                     OFFSET(getStruct<T>, {0x3CC, 16, 0, 0})
	SMember(FLinearColor)                              CritColor_InnerStroke                                       OFFSET(getStruct<T>, {0x3DC, 16, 0, 0})
	SMember(FLinearColor)                              DamageIconVehicleColor                                      OFFSET(getStruct<T>, {0x3EC, 16, 0, 0})
	SMember(FLinearColor)                              DamageIconShieldColor                                       OFFSET(getStruct<T>, {0x3FC, 16, 0, 0})
	SMember(FLinearColor)                              DamageIconShieldOutline1Color                               OFFSET(getStruct<T>, {0x40C, 16, 0, 0})
	SMember(FLinearColor)                              DamageIconShieldOutline2Color                               OFFSET(getStruct<T>, {0x41C, 16, 0, 0})
	SMember(FLinearColor)                              DamageIconVehicleOutline1Color                              OFFSET(getStruct<T>, {0x42C, 16, 0, 0})
	SMember(FLinearColor)                              DamageIconVehicleOutline2Color                              OFFSET(getStruct<T>, {0x43C, 16, 0, 0})
...
public:
	...
	SMember(FVector)                                   OffsetFromPawnLocationDBNO                                  OFFSET(getStruct<T>, {0x2D0, 24, 0, 0})
	SMember(FVector)                                   OffsetFromPawnLocation                                      OFFSET(getStruct<T>, {0x2E8, 24, 0, 0})
	CMember(AFortPlayerPawn*)                          BoundPawn                                                   OFFSET(get<T>, {0x300, 8, 0, 0})
	SMember(FGameplayTag)                              HideDamageNumbersTag                                        OFFSET(getStruct<T>, {0x308, 4, 0, 0})
	SMember(FGameplayTag)                              DamageAtLocTag                                              OFFSET(getStruct<T>, {0x30C, 4, 0, 0})
	SMember(FGameplayTagContainer)                     TagsToNotDisplayDmgNumbersOnSpecificActors                  OFFSET(getStruct<T>, {0x310, 32, 0, 0})
	CMember(UDynamicEntryBox*)                         DynamicEntryBox_Numbers                                     OFFSET(get<T>, {0x330, 8, 0, 0})
	SMember(FGameplayTag)                              DamageCueEMPTag                                             OFFSET(getStruct<T>, {0x338, 4, 0, 0})
