...
public:
	...
	// void OnVariantChangedEvent__DelegateSignature(FMcpVariantChannelInfo& InChannelInfo);                                    // [0x101681c] MulticastDelegate|Public|Delegate|HasOutParms 
	// Function /Script/MeshCosmeticsUI.FortVariantRedirectorTile.HandleBoundaryNavigation
	// UWidget* HandleBoundaryNavigation(EUINavigation InNavigation);                                                           // [0xa19db80] Final|Native|Private 
	// Function /Script/MeshCosmeticsUI.FortVariantRedirectorTile.GetButtonToFocus
	// UWidget* GetButtonToFocus();                                                                                             // [0xa19db58] Native|Protected|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	CMember(UCommonButtonBase*)                        Button_Back                                                 OFFSET(get<T>, {0x730, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_Confirm                                              OFFSET(get<T>, {0x738, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_HideArchivedItems                                    OFFSET(get<T>, {0x740, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_ShowArchivedItems                                    OFFSET(get<T>, {0x748, 8, 0, 0})
	CMember(UWidget*)                                  Widget_ArchivedItemsButtons                                 OFFSET(get<T>, {0x750, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_SpraysTab                                            OFFSET(get<T>, {0x758, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_SettingsTab                                          OFFSET(get<T>, {0x760, 8, 0, 0})
	CMember(UCommonButtonBase*)                        Button_TouchClose                                           OFFSET(get<T>, {0x768, 8, 0, 0})
	CMember(UCommonActionWidget*)                      ActionWidget_TabLeft                                        OFFSET(get<T>, {0x770, 8, 0, 0})
	CMember(UCommonActionWidget*)                      ActionWidget_TabRight                                       OFFSET(get<T>, {0x778, 8, 0, 0})
	CMember(UCommonActivatableWidgetSwitcher*)         Switcher_Tabs                                               OFFSET(get<T>, {0x780, 8, 0, 0})
	CMember(UWidget*)                                  Widget_Sprays                                               OFFSET(get<T>, {0x788, 8, 0, 0})
	CMember(UWidget*)                                  Widget_Settings                                             OFFSET(get<T>, {0x790, 8, 0, 0})
	CMember(UFortVariantItemTexturePicker*)            TexturePicker_Sprays                                        OFFSET(get<T>, {0x798, 8, 0, 0})
	CMember(UFortVariantSprayCustomizerSetting*)       Setting_Saturation                                          OFFSET(get<T>, {0x7A0, 8, 0, 0})
	CMember(UFortVariantSprayCustomizerSetting*)       Setting_Wear                                                OFFSET(get<T>, {0x7A8, 8, 0, 0})
	CMember(UFortVariantSprayCustomizerSetting*)       Setting_Scale                                               OFFSET(get<T>, {0x7B0, 8, 0, 0})
	...
	CMember(UCommonButtonGroupLegacy*)                 TabButtonGroup                                              OFFSET(get<T>, {0x7E0, 8, 0, 0})
	CMember(TWeakObjectPtr<UAthenaCosmeticItemDefinition*>) ItemDefinition                                         OFFSET(get<T>, {0x7E8, 8, 0, 0})
	CMember(UFortCustomizableObjectSprayVariant*)      SprayVariant                                                OFFSET(get<T>, {0x7F0, 8, 0, 0})


	/// Functions
	// Function /Script/MeshCosmeticsUI.FortVariantSprayCustomizer.BP_SetVariantEditorMode
	// void BP_SetVariantEditorMode(bool bIsLockerMode);                                                                        // [0x101681c] Event|Protected|BlueprintEvent 
	// Function /Script/MeshCosmeticsUI.FortVariantSprayCustomizer.BP_SetChannelSlotIcon
	// void BP_SetChannelSlotIcon(TWeakObjectPtr<UObject*>& ChannelSlotIcon);                                                   // [0x101681c] Event|Protected|HasOutParms|BlueprintEvent 
};
...
public:
	...
	// void HandleSliderValueChanged(float NormalizedValue);                                                                    // [0xa19dc10] Final|Native|Private 
	// Function /Script/MeshCosmeticsUI.FortVariantSprayCustomizerSetting.BP_OnSetConstraints
	// void BP_OnSetConstraints(FFloatRange& Constraints);                                                                      // [0x101681c] Event|Protected|HasOutParms|BlueprintEvent 
	// Function /Script/MeshCosmeticsUI.FortVariantSprayCustomizerSetting.BP_OnChangeValue
	// void BP_OnChangeValue(float Value, float NormalizedValue);                                                               // [0x101681c] Event|Protected|BlueprintEvent 
};
