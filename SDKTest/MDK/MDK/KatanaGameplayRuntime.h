...
public:
	...
	SMember(FVector)                                   LeftAttachedHandIKLoc                                       OFFSET(getStruct<T>, {0x15F0, 24, 0, 0})
	SMember(FRotator)                                  LeftAttachedhandIKRot                                       OFFSET(getStruct<T>, {0x1608, 24, 0, 0})
	SMember(FVector)                                   RightWeaponLoc                                              OFFSET(getStruct<T>, {0x1620, 24, 0, 0})
	SMember(FRotator)                                  RightWeaponRot                                              OFFSET(getStruct<T>, {0x1638, 24, 0, 0})
	SMember(FVector)                                   LeftAttachedHandIKLocOffsetMED                              OFFSET(getStruct<T>, {0x1650, 24, 0, 0})
	SMember(FRotator)                                  LeftAttachedHandIKRotOffset                                 OFFSET(getStruct<T>, {0x1668, 24, 0, 0})
	SMember(FVector)                                   RightWeaponLocOffsetMED                                     OFFSET(getStruct<T>, {0x1680, 24, 0, 0})
	SMember(FRotator)                                  RightWeaponRotOffset                                        OFFSET(getStruct<T>, {0x1698, 24, 0, 0})
	...
	SMember(FVector)                                   LeftAttachedHandIKLocOffsetLRG                              OFFSET(getStruct<T>, {0x16D0, 24, 0, 0})
	SMember(FVector)                                   RightWeaponLocOffsetLRG                                     OFFSET(getStruct<T>, {0x16E8, 24, 0, 0})
	...
	SMember(FScalableFloat)                            DashRootMotionDuration                                      OFFSET(getStruct<T>, {0x1708, 40, 0, 0})
...
public:
	...
	SMember(FVector)                                   ScabbardLoc                                                 OFFSET(getStruct<T>, {0x1610, 24, 0, 0})
	SMember(FRotator)                                  ScabbardRot                                                 OFFSET(getStruct<T>, {0x1628, 24, 0, 0})
	SMember(FVector)                                   ScabbardLocOffset                                           OFFSET(getStruct<T>, {0x1640, 24, 0, 0})
	SMember(FRotator)                                  ScabbardRotOffset                                           OFFSET(getStruct<T>, {0x1658, 24, 0, 0})
	DMember(bool)                                      IsSurfaceSwimming                                           OFFSET(get<bool>, {0x1670, 1, 0, 0})
	DMember(bool)                                      IsTechniqueActive                                           OFFSET(get<bool>, {0x1671, 1, 0, 0})
	SMember(FVector)                                   SwordLoc                                                    OFFSET(getStruct<T>, {0x1678, 24, 0, 0})
	SMember(FRotator)                                  SwordRot                                                    OFFSET(getStruct<T>, {0x1690, 24, 0, 0})
	SMember(FVector)                                   SwordLocOffset                                              OFFSET(getStruct<T>, {0x16A8, 24, 0, 0})
	SMember(FRotator)                                  SwordRotOffset                                              OFFSET(getStruct<T>, {0x16C0, 24, 0, 0})
	...
	SMember(FName)                                     PelvisSocket                                                OFFSET(getStruct<T>, {0x16EC, 4, 0, 0})
	SMember(FVector)                                   ScabbardLocOffsetVeh                                        OFFSET(getStruct<T>, {0x16F0, 24, 0, 0})
	SMember(FRotator)                                  ScabbardRotOffsetVeh                                        OFFSET(getStruct<T>, {0x1708, 24, 0, 0})
