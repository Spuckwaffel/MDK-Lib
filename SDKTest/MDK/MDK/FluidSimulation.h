...
public:
	...
	CMember(UStaticMeshComponent*)                     DebugPlane                                                  OFFSET(get<T>, {0x298, 8, 0, 0})
	CMember(USceneComponent*)                          DefaultSceneRoot                                            OFFSET(get<T>, {0x2A0, 8, 0, 0})
	CMember(UMaterialInstanceDynamic*)                 RippleSimMID                                                OFFSET(get<T>, {0x2A8, 8, 0, 0})
	CMember(UMaterialInstanceDynamic*)                 RenderNormalsMID                                            OFFSET(get<T>, {0x2B0, 8, 0, 0})
	CMember(UMaterialInstanceDynamic*)                 DisplayMID                                                  OFFSET(get<T>, {0x2B8, 8, 0, 0})
	CMember(UMaterialInstanceDynamic*)                 DisplayBottomMID                                            OFFSET(get<T>, {0x2C0, 8, 0, 0})
	CMember(UMaterialInstanceDynamic*)                 CrossSectionMID                                             OFFSET(get<T>, {0x2C8, 8, 0, 0})
	CMember(TArray<UTextureRenderTarget2D*>)           RippleRTs                                                   OFFSET(get<T>, {0x2D0, 16, 0, 0})
	CMember(UMaterialInterface*)                       Display_Material                                            OFFSET(get<T>, {0x2E0, 8, 0, 0})
	...
	CMember(UTextureRenderTarget2D*)                   NormalRT                                                    OFFSET(get<T>, {0x330, 8, 0, 0})
	SMember(FVector)                                   CutPos                                                      OFFSET(get<T>, {0x338, 24, 0, 0})
	SMember(FVector)                                   PrevLoc                                                     OFFSET(get<T>, {0x350, 24, 0, 0})
	SMember(FVector)                                   PrecLoc2                                                    OFFSET(get<T>, {0x368, 24, 0, 0})
	SMember(FVector)                                   PrevOffset                                                  OFFSET(get<T>, {0x380, 24, 0, 0})
	SMember(FVector)                                   PrevOffset2                                                 OFFSET(get<T>, {0x398, 24, 0, 0})
	SMember(FVector)                                   GridCenter                                                  OFFSET(get<T>, {0x3B0, 24, 0, 0})
	CMember(UTextureRenderTarget2D*)                   TempRT                                                      OFFSET(get<T>, {0x3C8, 8, 0, 0})
	CMember(UTextureRenderTarget2D*)                   ForcesRT                                                    OFFSET(get<T>, {0x3D0, 8, 0, 0})
	DMember(double)                                    ApplyForces                                                 OFFSET(get<double>, {0x3D8, 8, 0, 0})
	CMember(ALandscapeWaterInfo_C*)                    LandscapeWaterInfo                                          OFFSET(get<T>, {0x3E0, 8, 0, 0})
	...
	CMember(UTextureRenderTarget2D*)                   PerfRT                                                      OFFSET(get<T>, {0x3F0, 8, 0, 0})
	...
	CMember(UStaticMeshComponent*)                     Fluid_Display_Mesh                                          OFFSET(get<T>, {0x4B0, 8, 0, 0})
	CMember(UStaticMeshComponent*)                     Cross_Section_Mesh                                          OFFSET(get<T>, {0x4B8, 8, 0, 0})
	...
	CMember(UMaterialInstanceDynamic*)                 PhysicsForceMID                                             OFFSET(get<T>, {0x530, 8, 0, 0})
	DMember(bool)                                      Add_Physics_Forces                                          OFFSET(get<bool>, {0x538, 1, 0, 0})
	CMember(UTexture*)                                 WaterVelocityTexture                                        OFFSET(get<T>, {0x540, 8, 0, 0})
	DMember(bool)                                      UpdateForcesInFixedTimeStep                                 OFFSET(get<bool>, {0x548, 1, 0, 0})
	DMember(bool)                                      UpdateSimInFixedTimeStep                                    OFFSET(get<bool>, {0x549, 1, 0, 0})
	DMember(bool)                                      UpdateNormalInFixedTimeStep                                 OFFSET(get<bool>, {0x54A, 1, 0, 0})
	DMember(bool)                                      ShowDebugWaterPlane                                         OFFSET(get<bool>, {0x54B, 1, 0, 0})
	CMember(UMaterialInstanceDynamic*)                 DebugWaterPlaneMID                                          OFFSET(get<T>, {0x550, 8, 0, 0})
	...
	// void CycleDebugRenderTargets();                                                                                          // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Get Frames Since Last Active Forces
	// void Get Frames Since Last Active Forces();                                                                              // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Clear Sim from Waterbody MIDs
	// void Clear Sim from Waterbody MIDs();                                                                                    // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Remove Projectile Force
	// void Remove Projectile Force(UActorComponent* Component);                                                                // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Register Projectile Force
	// void Register Projectile Force(FFluidForceDynamic Dynamic Fluid Force, USceneComponent* Tracked Component);              // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void Validate RTs(bool& RTs All Valid);                                                                                  // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Set Waterbody MID Params
	// void Set Waterbody MID Params();                                                                                         // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.GetLocalPawn
	// void GetLocalPawn(APawn*& Pawn);                                                                                         // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Draw Dynamic Force
	// void Draw Dynamic Force(UCanvas*& Canvas, FVector2D& Canvas Size, FFluidForceDynamicPerInstanceData& Dynamic Force Settings); // [0x1ebf994] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Remove Dynamic Force
	// void Remove Dynamic Force(UActorComponent* Component);                                                                   // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Register Dynamic Force
	// void Register Dynamic Force(FFluidForceDynamic Dynamic Fluid Force, USceneComponent* Tracked Component, double WaterLevel); // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Update Dynamic Forces
	// void Update Dynamic Forces();                                                                                            // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Draw Impulse Force
	// void Draw Impulse Force(UCanvas* Canvas, FVector2D Canvas Size, FFluidForceImpulsePerInstanceData Impulse Settings);     // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Update Impulse Lifetimes
	// void Update Impulse Lifetimes();                                                                                         // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Apply Fluid Force Impulse
	// void Apply Fluid Force Impulse(FFluidForceImpulse Impulse Settings);                                                     // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Get LandscapeWaterInfo
	// void Get LandscapeWaterInfo();                                                                                           // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Get Force MID
	// void Get Force MID(UMaterialInterface*& Parent, UMaterialInstanceDynamic*& Mid);                                         // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.GridMovement
	// void GridMovement();                                                                                                     // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.SetupSimMIDs
	// void SetupSimMIDs();                                                                                                     // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.SetupDisplayMIDs
	// void SetupDisplayMIDs();                                                                                                 // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Convert Force Position
	// void Convert Force Position(FVector Force Location, double Sine Bob, FVector& UV Location);                              // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /FortWater/FluidSimulation/Blueprints/BP_FluidSim_01.BP_FluidSim_01_C.Cycle Render Targets
	// void Cycle Render Targets(UTextureRenderTarget2D*& Current Target);                                                      // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
...
public:
	...
	CMember(USceneComponent*)                          ForceComponent_34_ABF6640F40D37677EF6F809E09046055          OFFSET(get<T>, {0x10, 8, 0, 0})
	CMember(UMaterialInterface*)                       MaterialOverride_25_5A792CE8489A59E5D9B24F9E4DCFE94A        OFFSET(get<T>, {0x18, 8, 0, 0})
	SMember(FFluidForceSocketInfo)                     SkeletalMeshSetup_31_51A4130440BAFFBA1DA0FE83E942A30A       OFFSET(get<T>, {0x20, 80, 0, 0})
};
...
public:
	SMember(FFluidForceDynamic)                        ForceInfo_2_A6A35E3243FAF59D161A5FBAA2F6F2B1                OFFSET(get<T>, {0x0, 112, 0, 0})
	SMember(FVector)                                   ComponentLocation_13_959307184C8E5CCACA55FC8378D92CFD       OFFSET(get<T>, {0x70, 24, 0, 0})
	SMember(FVector)                                   ComponentVelocity_5_4F6589474918826DF8A6468CF0F2C361        OFFSET(get<T>, {0x88, 24, 0, 0})
...
public:
	...
	CMember(UMaterialInterface*)                       MaterialOverride_42_FB856A244A1713590BB76EAA7CC7A0DF        OFFSET(get<T>, {0x20, 8, 0, 0})
};
...
public:
	SMember(FVector)                                   WorldPosition_32_C9A94C02422D8BF40DF6B1BB2A0D8CBC           OFFSET(get<T>, {0x0, 24, 0, 0})
	...
	CMember(UMaterialInterface*)                       MaterialOverride_24_5A792CE8489A59E5D9B24F9E4DCFE94A        OFFSET(get<T>, {0x20, 8, 0, 0})
	...
	SMember(FFluidForceImpulseTimedEffects)            TimedWaterDropSplashes_38_2CB1456B483AEF3A52677AAF4152E31E  OFFSET(get<T>, {0x30, 40, 0, 0})
};
...
public:
	SMember(FFluidForceImpulse)                        ImpulseSettings_41_C9A94C02422D8BF40DF6B1BB2A0D8CBC         OFFSET(get<T>, {0x0, 88, 0, 0})
