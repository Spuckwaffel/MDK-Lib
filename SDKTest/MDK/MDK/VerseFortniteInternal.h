...
/// Size: 0x04
enum EPlayerSettingStateInternal : uint8_t
{
	EPlayerSettingStateInternal__PlayerUseDefault0                                   = 0,
	EPlayerSettingStateInternal__PlayerIsAllowed1                                    = 1,
	EPlayerSettingStateInternal__PlayerIsDisallowed2                                 = 2,
	EPlayerSettingStateInternal__EPlayerSettingStateInternal_MAX3                    = 3
};
