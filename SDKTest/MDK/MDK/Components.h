...
public:
	...
	// void GetRidingInfoFromTarget(double& JumpAttachGroundHeightMin, double& JumpAttachGroundHeightBuffer, bool& UsesAltRidingMessage); // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ToggleRidingAlternative();                                                                                          // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
...
public:
	...
	SMember(FGameplayTagContainer)                     T_CreatureIsBeingRidden                                     OFFSET(get<T>, {0x6B8, 32, 0, 0})
	...
	SMember(FVector)                                   DebugServerRiderLocation                                    OFFSET(get<T>, {0x6F8, 24, 0, 0})
	...
	SMember(FGameplayTagContainer)                     T_RidingSpecialAbility                                      OFFSET(get<T>, {0x720, 32, 0, 0})
	...
	SMember(FRotator)                                  Clamp_Foot_R_Adjust                                         OFFSET(get<T>, {0x7C8, 24, 0, 0})
	SMember(FRotator)                                  Clamp_Foot_L_Adjust                                         OFFSET(get<T>, {0x7E0, 24, 0, 0})
	...
	SMember(FVector)                                   Clamp_Location_Offset                                       OFFSET(get<T>, {0x808, 24, 0, 0})
	SMember(FRotator)                                  Clamp_Rotation_Offset                                       OFFSET(get<T>, {0x820, 24, 0, 0})
	SMember(FVector)                                   Clamp_ScaleAdjust                                           OFFSET(get<T>, {0x838, 24, 0, 0})
	SMember(FName)                                     RidableSocketName                                           OFFSET(get<T>, {0x850, 4, 0, 0})
	...
	SMember(FGameplayTagContainer)                     T_CreatureOverrideCooldown                                  OFFSET(get<T>, {0x868, 32, 0, 0})
	CMember(TMap<TEnumAsByte, TEnumAsByte>)            OriginalCollisionResponseMap                                OFFSET(get<T>, {0x888, 80, 0, 0})
	SMember(FSoundIndicatorIconPicker)                 RidingSoundIndicatorIconOverride                            OFFSET(get<T>, {0x8D8, 40, 0, 0})
	SMember(FMulticastInlineDelegate)                  AudioOnJump                                                 OFFSET(get<T>, {0x900, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  AudioOnJumpApex                                             OFFSET(get<T>, {0x910, 16, 0, 0})
	DMember(char)                                      MovementMode                                                OFFSET(get<char>, {0x920, 1, 0, 0})
	DMember(bool)                                      bFalling                                                    OFFSET(get<bool>, {0x921, 1, 0, 0})
	SMember(FScalableFloat)                            RidingAbilityEnable_HF                                      OFFSET(get<T>, {0x928, 40, 0, 0})
	...
	SMember(FText)                                     Riding_Interaction_Text                                     OFFSET(get<T>, {0x968, 24, 0, 0})
	...
	SMember(FCurveTableRowHandle)                      EnergyRateOfDecayMoving                                     OFFSET(get<T>, {0x9C0, 16, 0, 0})
	SMember(FCurveTableRowHandle)                      EnergyRateOfDecaySprinting                                  OFFSET(get<T>, {0x9D0, 16, 0, 0})
	DMember(double)                                    CurrentEnergyRateOfRecharge                                 OFFSET(get<double>, {0x9E0, 8, 0, 0})
	SMember(FCurveTableRowHandle)                      ExhaustedEnergyRateOfRecharge                               OFFSET(get<T>, {0x9E8, 16, 0, 0})
	...
	SMember(FGameplayTagContainer)                     T_EnergyWarning                                             OFFSET(get<T>, {0xA48, 32, 0, 0})
	SMember(FGameplayTagContainer)                     T_EnergyCritical                                            OFFSET(get<T>, {0xA68, 32, 0, 0})
	SMember(FGameplayTagContainer)                     T_EnergyDepleted                                            OFFSET(get<T>, {0xA88, 32, 0, 0})
	SMember(FGameplayTagContainer)                     T_CannotRideBucket                                          OFFSET(get<T>, {0xAA8, 32, 0, 0})
	CMember(UClass*)                                   Gameplay_Effect                                             OFFSET(get<T>, {0xAC8, 8, 0, 0})
	SMember(FGameplayTag)                              SprintingAbilityTag                                         OFFSET(get<T>, {0xAD0, 4, 0, 0})
	CMember(UClass*)                                   GE_EatToRefuel                                              OFFSET(get<T>, {0xAD8, 8, 0, 0})
	SMember(FSlateBrush)                               IconBrush                                                   OFFSET(get<T>, {0xAE0, 192, 0, 0})
	...
	SMember(FGameplayTagContainer)                     TagsPreventSprinting                                        OFFSET(get<T>, {0xBB0, 32, 0, 0})
	SMember(FMulticastInlineDelegate)                  RidableUIStart                                              OFFSET(get<T>, {0xBD0, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  RidableUIUpdateEnergy                                       OFFSET(get<T>, {0xBE0, 16, 0, 0})
	SMember(FGameplayTag)                              OutOfEnergySoundLibTag                                      OFFSET(get<T>, {0xBF0, 4, 0, 0})
	SMember(FGameplayTag)                              SprintStartSoundLibTag                                      OFFSET(get<T>, {0xBF4, 4, 0, 0})
	...
	SMember(FTimerHandle)                              RetryJumpExitTimerHandle                                    OFFSET(get<T>, {0xC08, 8, 0, 0})
	DMember(double)                                    JumpExitBufferStartTimeStamp                                OFFSET(get<double>, {0xC10, 8, 0, 0})
	SMember(FScalableFloat)                            JumpExitBufferTime                                          OFFSET(get<T>, {0xC18, 40, 0, 0})
	SMember(FTimerHandle)                              JumpExitBufferTimerHandle                                   OFFSET(get<T>, {0xC40, 8, 0, 0})
	SMember(FGameplayTag)                              MountLandedCueTag                                           OFFSET(get<T>, {0xC48, 4, 0, 0})
	...
	SMember(FGameplayTagContainer)                     BlockPetting_TagContainer                                   OFFSET(get<T>, {0xC60, 32, 0, 0})
	DMember(bool)                                      infiniteStaminaBuffEnabled                                  OFFSET(get<bool>, {0xC80, 1, 0, 0})
	SMember(FGameplayTag)                              InfiniteStaminaEffect_GameplayCueTag                        OFFSET(get<T>, {0xC84, 4, 0, 0})
	SMember(FGameplayTagContainer)                     Cannot_Ride_Rider_Bucket                                    OFFSET(get<T>, {0xC88, 32, 0, 0})
	SMember(FScalableFloat)                            JumpFatigue_Enabled                                         OFFSET(get<T>, {0xCA8, 40, 0, 0})
	SMember(FScalableFloat)                            JumpFatigue_ApplyFatigueMinJumpCount                        OFFSET(get<T>, {0xCD0, 40, 0, 0})
	...
	SMember(FScalableFloat)                            JumpFatigue_ResetCounterDelay                               OFFSET(get<T>, {0xD10, 40, 0, 0})
	DMember(bool)                                      JumpFatigue_ShouldTimeStampNextLanding                      OFFSET(get<bool>, {0xD38, 1, 0, 0})
	SMember(FActiveGameplayEffectHandle)               JumpFatigue_GEHandle                                        OFFSET(get<T>, {0xD3C, 8, 0, 0})
	...
	// void JumpFatigue_LandTimeStamp();                                                                                        // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	...
	// void Should Convert Jump Exit to Jump(bool& Out);                                                                        // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void ShouldBufferJumpExitToRetryJump(bool& Output);                                                                      // [0x1ebf994] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.SetInfiniteStaminaBuff
	// void SetInfiniteStaminaBuff(bool Enabled);                                                                               // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.CanBePet
	// bool CanBePet(URiderComponent* Rider);                                                                                   // [0x1ebf994] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.CanJumpExit
	// void CanJumpExit(bool& CanJumpExit);                                                                                     // [0x1ebf994] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.UpdateLootAnimalGlow
	// void UpdateLootAnimalGlow(double Scale);                                                                                 // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.OnRep_currentEnergyValue
	// void OnRep_currentEnergyValue();                                                                                         // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void Propagate Immunity Fall Damage();                                                                                   // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.CanRiderPlayEmote
	// bool CanRiderPlayEmote(URiderComponent* Rider);                                                                          // [0x1ebf994] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	...
	// void HandleEnemyFoleySoundLibrary(UActorComponent* Rider, bool bIsRiding);                                               // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.OnMovementModeChanged
	// void OnMovementModeChanged(ACharacter* Character, TEnumAsByte<EMovementMode> PrevMovementMode, char PreviousCustomMode); // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.IsSwimming
	// void IsSwimming(bool& IsSwimming);                                                                                       // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.StopSprinting
	// void StopSprinting();                                                                                                    // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.RemoveGEByTag
	// void RemoveGEByTag(FGameplayTagContainer Tags);                                                                          // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.ApplyGEToSelf
	// void ApplyGEToSelf(UClass* GameplayEffectClass, bool& IsValidClass);                                                     // [0x1ebf994] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.KickRiderOffSelf
	// void KickRiderOffSelf();                                                                                                 // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.DetermineRateOfChange
	// void DetermineRateOfChange(double& rateOfChange);                                                                        // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.CommitEnergyCosts
	// void CommitEnergyCosts(bool RequireAllEnergy, double EnergyCost, bool& Success);                                         // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.TestThreshold
	// void TestThreshold(bool isDecaying, double CurrentValue, double testTreshold, bool PreviousState, bool& crossedThreshold); // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.SetWildlifeHealth
	// void SetWildlifeHealth();                                                                                                // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.UpdateValue
	// void UpdateValue(double TargetValue, double rateOfChange, double DeltaTime, double& updatedValue, bool& EnergyDepleted); // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.ToggleRiding
	// void ToggleRiding(AActor* PlayerPawn, AActor* Target, bool ShouldRide, bool& bChangedRiding);                            // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.ForceTaming
	// void ForceTaming(AActor* PlayerPawn, AActor* CreaturePawn, bool& IsTamingEnabled);                                       // [0x1ebf994] Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.RestoreCollisionResponses
	// void RestoreCollisionResponses();                                                                                        // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.ApplyCollisionResponse
	// void ApplyCollisionResponse(TArray<TEnumAsByte>& Channels, TEnumAsByte<ECollisionResponse> Response);                    // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.ShouldCameraFocusOnRidable
	// bool ShouldCameraFocusOnRidable(URiderComponent* Rider);                                                                 // [0x1ebf994] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.UpdateAnimInputBool
	// void UpdateAnimInputBool(AFortPawn* FortPawn, bool IsBeingRidden);                                                       // [0x1ebf994] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.GetRiderCapsuleSize
	// void GetRiderCapsuleSize(URiderComponent* Rider, double& RiderCapsuleRadius, double& RiderCapsuleHH);                    // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.GetRidingEmoteCapsuleSize
	// void GetRidingEmoteCapsuleSize(URiderComponent* Rider, float OriginalRadius, float OriginalHalfHeight, float& OutRadius, float& OutHalfHeight); // [0x1ebf994] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.GetRidingCapsuleSize
	// void GetRidingCapsuleSize(URiderComponent* Rider, float OriginalRadius, float OriginalHalfHeight, float& OutRadius, float& OutHalfHeight); // [0x1ebf994] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.OnRep_IdleAnim_Add
	// void OnRep_IdleAnim_Add();                                                                                               // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.ShouldSetAsViewTarget
	// bool ShouldSetAsViewTarget(URiderComponent* Rider);                                                                      // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.GetRiderLocation
	// void GetRiderLocation(FVector& Location);                                                                                // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent|BlueprintPure 
	...
	// void Removed_AD51144144164FD235EE5BA4F6E87456();                                                                         // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void Added_FBD936634BCC61A726DA279226E2F4BE();                                                                           // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void Removed_C4C6E29B4217C014B9DE0E80B7134D6E();                                                                         // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void HandleRiderStartedRiding(URiderComponent* Rider);                                                                   // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.HandleRiderStoppedRiding
	// void HandleRiderStoppedRiding(URiderComponent* Rider);                                                                   // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.UpdateDebug
	// void UpdateDebug();                                                                                                      // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void OnJumping(double JumpPitchInterpSpeed);                                                                             // [0x1ebf994] Net|NetReliableNetMulticast|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.OnJumpingApex
	// void OnJumpingApex();                                                                                                    // [0x1ebf994] Net|NetReliableNetMulticast|BlueprintCallable|BlueprintEvent 
	...
	// void NPCPawnInteractWithDispatcher_Event(AActor* AIPawn, AFortPlayerPawn* InteractingPlayerPawn);                        // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.EnergyTrackingStart
	// void EnergyTrackingStart();                                                                                              // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.EnergyTrackingStop
	// void EnergyTrackingStop();                                                                                               // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void Check Regen on Stopped Riding();                                                                                    // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteBufferedJumpExit();                                                                                          // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.CancelJumpExitAndJump
	// void CancelJumpExitAndJump();                                                                                            // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/CreatureBaseRidableComponent.CreatureBaseRidableComponent_C.MountLandedClient
	// void MountLandedClient(FHitResult& Hit);                                                                                 // [0x1ebf994] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void TryConvertBufferedJumpExitToJump();                                                                                 // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void MountLandedServer_JumpFatigue(FHitResult& Hit);                                                                     // [0x1ebf994] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_CreatureBaseRidableComponent(int32_t EntryPoint);                                                  // [0x1ebf994] Final|HasDefaults    
	...
	// void RidableUIUpdateEnergy__DelegateSignature(double Energy, bool bIsResting);                                           // [0x1ebf994] Public|Delegate|BlueprintCallable|BlueprintEvent 
	...
	// void RidableUIStart__DelegateSignature(FText Name, FSlateBrush Icon);                                                    // [0x1ebf994] Public|Delegate|BlueprintCallable|BlueprintEvent 
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(get<T>, {0x6C8, 8, 0, 0})
	SMember(FGameplayTagContainer)                     T_PlayerIsRiding                                            OFFSET(get<T>, {0x6D0, 32, 0, 0})
	...
	SMember(FMulticastInlineDelegate)                  RiderUINewStats                                             OFFSET(get<T>, {0x708, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  RiderUIEnd                                                  OFFSET(get<T>, {0x718, 16, 0, 0})
	DMember(double)                                    targetEnergy                                                OFFSET(get<double>, {0x728, 8, 0, 0})
	DMember(double)                                    targetHealth                                                OFFSET(get<double>, {0x730, 8, 0, 0})
	SMember(FGameplayTagContainer)                     T_CannotRideBucket                                          OFFSET(get<T>, {0x738, 32, 0, 0})
	SMember(FMulticastInlineDelegate)                  RiderUIUpdateEnergy                                         OFFSET(get<T>, {0x758, 16, 0, 0})
	SMember(FMulticastInlineDelegate)                  RiderUIUpdateHealth                                         OFFSET(get<T>, {0x768, 16, 0, 0})
	CMember(AActor*)                                   CachedRidableActor                                          OFFSET(get<T>, {0x778, 8, 0, 0})
	SMember(FGameplayTagContainer)                     Cannot_Ride_Rider_Bucket                                    OFFSET(get<T>, {0x780, 32, 0, 0})
	SMember(FGameplayTag)                              JumpOnCreature_Cue_Tag                                      OFFSET(get<T>, {0x7A0, 4, 0, 0})
	...
	// void OnRep_targetHealth();                                                                                               // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.OnRep_targetEnergy
	// void OnRep_targetEnergy();                                                                                               // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.GetJumpInfo
	// void GetJumpInfo(AActor* TargetActor, UActorComponent*& TargetActorComponent, double& JumpAttach_GroundHeightMin, double& JumpAttach_GroundHeightBuffer, bool& UseAltRidingMessage); // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.TestIfValidForRidingAttempt
	// void TestIfValidForRidingAttempt(UObject* Object, bool& Success, UObject*& TargetObject, bool& UseAltRidingMessage);     // [0x1ebf994] Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void EventReceived_E5B5FB5340DB5660002329825657B406(FGameplayEventData Payload);                                         // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.Added_42EF586645CCFF06FFA4D9A5D59B1298
	// void Added_42EF586645CCFF06FFA4D9A5D59B1298();                                                                           // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.Added_A83C775344FE0F6BDAAC4B971F57425E
	// void Added_A83C775344FE0F6BDAAC4B971F57425E();                                                                           // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void EventReceived_3DA19BC649FB853BA2CC0FADFF8D08F6(FGameplayEventData Payload);                                         // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.Added_D3DFE4374EED456A4C597E95375A2028
	// void Added_D3DFE4374EED456A4C597E95375A2028();                                                                           // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	...
	// void HandleStartedRiding(URidableComponent* Ridable);                                                                    // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.HandleStoppedRiding
	// void HandleStoppedRiding(URidableComponent* Ridable);                                                                    // [0x1ebf994] Event|Protected|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.ToggleRidingOnServer
	// void ToggleRidingOnServer(UObject* TargetObject, bool UseAltRidingMessage);                                              // [0x1ebf994] Net|NetServer|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.SetTargetHealth
	// void SetTargetHealth(double targetHealth);                                                                               // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.RiderUIStartClient
	// void RiderUIStartClient(FText Name, FSlateBrush Icon, AActor* Ridable);                                                  // [0x1ebf994] Net|NetClient|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.RiderUIEndClient
	// void RiderUIEndClient(AActor* Ridable);                                                                                  // [0x1ebf994] Net|NetClient|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.MovementModeChanged
	// void MovementModeChanged(ACharacter* Character, TEnumAsByte<EMovementMode> PrevMovementMode, char PreviousCustomMode);   // [0x1ebf994] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.MountLanded
	// void MountLanded(FHitResult& Hit);                                                                                       // [0x1ebf994] HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_PlayerRiderComponent(int32_t EntryPoint);                                                          // [0x1ebf994] Final|HasDefaults    
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.RiderUIUpdateHealth__DelegateSignature
	// void RiderUIUpdateHealth__DelegateSignature(double Health);                                                              // [0x1ebf994] Public|Delegate|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/Components/PlayerRiderComponent.PlayerRiderComponent_C.RiderUIUpdateEnergy__DelegateSignature
	// void RiderUIUpdateEnergy__DelegateSignature(double Energy);                                                              // [0x1ebf994] Public|Delegate|BlueprintCallable|BlueprintEvent 
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(get<T>, {0xD80, 8, 0, 0})
	...
	SMember(FGameplayTag)                              SprintImpactGameplayCueTag                                  OFFSET(get<T>, {0xDA8, 4, 0, 0})
	...
	// void OnReaction(UObject* Object, FHitResult HitResult);                                                                  // [0x1ebf994] Public|HasDefaults|BlueprintCallable|BlueprintEvent 
	...
	// void OnReactionEvent(AActor* HitActor, bool bFromAsyncSweepBox, FCollisionReactionType CollisionReactionType, bool bIsFirstContinuousReactionOnDelayableActor, FHitResult& HitResult); // [0x1ebf994] HasOutParms|BlueprintCallable|BlueprintEvent 
...
public:
	...
	// void On Source Played(UStreamingRadioPlayerComponent* Component, FAthenaRadioStation AffectedSource);                    // [0x1ebf994] BlueprintCallable|BlueprintEvent 
