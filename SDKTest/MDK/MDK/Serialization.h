...
public:
	CMember(UClass*)                                   RawClass                                                    OFFSET(get<T>, {0x0, 8, 0, 0})
	CMember(UClass*)                                   WrappedClass                                                OFFSET(get<T>, {0x8, 8, 0, 0})
	CMember(UClass*)                                   SubClass                                                    OFFSET(get<T>, {0x10, 8, 0, 0})
	CMember(TWeakObjectPtr<UClass*>)                   SoftClass                                                   OFFSET(get<T>, {0x18, 32, 0, 0})
	CMember(UObject*)                                  RawObject                                                   OFFSET(get<T>, {0x38, 8, 0, 0})
