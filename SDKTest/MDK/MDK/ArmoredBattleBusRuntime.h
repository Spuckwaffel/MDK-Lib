...
public:
	SMember(FRotator)                                  PreviousVehicleRotator                                      OFFSET(get<T>, {0x15C8, 24, 0, 0})
	...
	SMember(FRotator)                                  TurretYawRotator                                            OFFSET(get<T>, {0x1600, 24, 0, 0})
	...
	SMember(FVector)                                   HandAttachL                                                 OFFSET(get<T>, {0x1620, 24, 0, 0})
	SMember(FVector)                                   HandAttachR                                                 OFFSET(get<T>, {0x1638, 24, 0, 0})
	...
	SMember(FName)                                     FrontFootBoneName                                           OFFSET(get<T>, {0x1660, 4, 0, 0})
	SMember(FName)                                     RearFootBoneName                                            OFFSET(get<T>, {0x1664, 4, 0, 0})
	SMember(FName)                                     GunHandAttachBoneName_FrontLeft                             OFFSET(get<T>, {0x1668, 4, 0, 0})
	SMember(FName)                                     GunHandAttachBoneName_RearLeft                              OFFSET(get<T>, {0x166C, 4, 0, 0})
	SMember(FName)                                     GunHandAttachBoneName_FrontRight                            OFFSET(get<T>, {0x1670, 4, 0, 0})
	SMember(FName)                                     GunHandAttachBoneName_RearRight                             OFFSET(get<T>, {0x1674, 4, 0, 0})
	SMember(FName)                                     PassengerBoneName_Front                                     OFFSET(get<T>, {0x1678, 4, 0, 0})
	SMember(FName)                                     PassengerBoneName_Rear                                      OFFSET(get<T>, {0x167C, 4, 0, 0})
...
public:
	...
	SMember(FRotator)                                  FrontWeaponYaw                                              OFFSET(get<T>, {0x618, 24, 0, 0})
	SMember(FRotator)                                  RearWeaponYaw                                               OFFSET(get<T>, {0x630, 24, 0, 0})
	SMember(FRotator)                                  PreviousVehicleRotator                                      OFFSET(get<T>, {0x648, 24, 0, 0})
