...
public:
	...
	SMember(FLinearColor)                              BaseColor_BG1                                               OFFSET(getStruct<T>, {0x330, 16, 0, 0})
	SMember(FLinearColor)                              ShieldColor_BG1                                             OFFSET(getStruct<T>, {0x340, 16, 0, 0})
	SMember(FLinearColor)                              CritColor_BG1                                               OFFSET(getStruct<T>, {0x350, 16, 0, 0})
	SMember(FLinearColor)                              ElimColor_BG1                                               OFFSET(getStruct<T>, {0x360, 16, 0, 0})
	SMember(FLinearColor)                              BaseColor_BG2                                               OFFSET(getStruct<T>, {0x370, 16, 0, 0})
	SMember(FLinearColor)                              ShieldColor_BG2                                             OFFSET(getStruct<T>, {0x380, 16, 0, 0})
	SMember(FLinearColor)                              CritColor_BG2                                               OFFSET(getStruct<T>, {0x390, 16, 0, 0})
	SMember(FLinearColor)                              ElimColor_BG2                                               OFFSET(getStruct<T>, {0x3A0, 16, 0, 0})
	SMember(FLinearColor)                              BaseColor_Outline1                                          OFFSET(getStruct<T>, {0x3B0, 16, 0, 0})
	SMember(FLinearColor)                              ShieldColor_Outline1                                        OFFSET(getStruct<T>, {0x3C0, 16, 0, 0})
	SMember(FLinearColor)                              CritColor_Outline1                                          OFFSET(getStruct<T>, {0x3D0, 16, 0, 0})
	SMember(FLinearColor)                              ElimColor_Outline1                                          OFFSET(getStruct<T>, {0x3E0, 16, 0, 0})
	SMember(FLinearColor)                              BaseColor_Outline2                                          OFFSET(getStruct<T>, {0x3F0, 16, 0, 0})
	SMember(FLinearColor)                              ShieldColor_Outline2                                        OFFSET(getStruct<T>, {0x400, 16, 0, 0})
	SMember(FLinearColor)                              CritColor_Outline2                                          OFFSET(getStruct<T>, {0x410, 16, 0, 0})
	SMember(FLinearColor)                              ElimColor_Outline2                                          OFFSET(getStruct<T>, {0x420, 16, 0, 0})
	SMember(FGameplayTag)                              UseNativeMarkerTag                                          OFFSET(getStruct<T>, {0x430, 4, 0, 0})
