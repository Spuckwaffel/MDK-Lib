...
class FWarEffortFundingChoiceData : public MDKStruct
{ 
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 40;
...
class FWarEffortIndexedFundingData : public MDKStruct
{ 
	friend MDKBase;
...
class FCubeMovement_CorruptionGenerationSplinePointData : public MDKStruct
{ 
	friend MDKBase;
...
class FCubeMovement_CorruptionGenerationTravelerData : public MDKStruct
{ 
	friend MDKBase;
...
/// Size: 0x0010 (0x000000 - 0x000010)
class FCubeMovement_CorruptionGenerationData : public MDKStruct
{ 
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 16;
...
/// Size: 0x0018 (0x000000 - 0x000018)
class FCorruptionCalendarEventData : public MDKStruct
{ 
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 24;
...
/// Size: 0x0018 (0x000000 - 0x000018)
class FCorruptionPauseEvent : public MDKStruct
{ 
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 24;
...
class FTravelerStepCorruptionOverrideData : public MDKStruct
{ 
	friend MDKBase;
	static inline constexpr uint64_t __MDKClassSize = 80;
...
class FWarEffortMutatorChoiceData : public MDKStruct
{ 
	friend MDKBase;
...
class FWarEffortFundingData : public MDKStruct
{ 
	friend MDKBase;
