...
public:
	...
	// void ResolveBuildingDamage(ABuildingActor* DamagedBuildingActor, AController* InstigatedBy, AActor* DamageCauser);       // [0xa171f50] Final|Native|Private 
	// Function /Script/IceRuntime.FortCurieElementAttachHandlerIce.HandleBuildingDamaged
	// void HandleBuildingDamaged(AActor* DamagedActor, float Damage, AController* InstigatedBy, AActor* DamageCauser, FVector HitLocation, UPrimitiveComponent* FHitComponent, FName BoneName, FVector Momentum); // [0xa1714b8] Final|Native|Private|HasDefaults 
};
...
public:
	CMember(UStaticMesh*)                              StaticMesh                                                  OFFSET(get<T>, {0x290, 8, 0, 0})
	CMember(UMaterial*)                                Material                                                    OFFSET(get<T>, {0x298, 8, 0, 0})
	...
	CMember(TArray<UBoxComponent*>)                    BoxColliderArray                                            OFFSET(get<T>, {0x2E0, 16, 0, 0})


	/// Functions
	// Function /Script/IceRuntime.IceGroundPath.OnRep_SplinePoints
	// void OnRep_SplinePoints();                                                                                               // [0xa171efc] Final|Native|Private 
	// Function /Script/IceRuntime.IceGroundPath.GetLocationOnLandscape
	// FVector GetLocationOnLandscape(FVector Location);                                                                        // [0xa171340] Final|Native|Public|HasDefaults|BlueprintCallable 
	// Function /Script/IceRuntime.IceGroundPath.GetLastSplinePointLocation
	// bool GetLastSplinePointLocation(FVector& LastPointLocation);                                                             // [0xa17122c] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/IceRuntime.IceGroundPath.AddSplinePoint
	// void AddSplinePoint(FVector InWorldLoc);                                                                                 // [0xa1710dc] Final|Native|Public|HasDefaults|BlueprintCallable 
};
...
public:
	...
	CMember(UClass*)                                   IceBlockClass                                               OFFSET(get<T>, {0x48, 8, 0, 0})
...
public:
	CMember(UFortCurieIcePropagationManagerConfig*)    InternalManagerConfig                                       OFFSET(get<T>, {0x30, 8, 0, 0})


	/// Functions
	// Function /Script/IceRuntime.FortCurieIcePropagationManager.OnIceBlockDied
	// void OnIceBlockDied(AActor* DamagedActor, float Damage, AController* InstigatedBy, AActor* DamageCauser, FVector HitLocation, UPrimitiveComponent* FHitComponent, FName BoneName, FVector Momentum); // [0xa1719b8] Final|Native|Public|HasDefaults 
};
