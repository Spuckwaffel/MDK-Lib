...
public:
	...
	// bool OnExecute(AActor* MyTarget, FGameplayCueParameters& Parameters);                                                    // [0x1d9241c] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/GameplayCues/GCN_BurtCharging_Player_Latent.GCN_BurtCharging_Player_Latent_C.ExecuteBoostLogic
	// void ExecuteBoostLogic();                                                                                                // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/GameplayCues/GCN_BurtCharging_Player_Latent.GCN_BurtCharging_Player_Latent_C.BoostEndEvent
	// void BoostEndEvent();                                                                                                    // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCN_BurtCharging_Player_Latent(int32_t EntryPoint);                                                // [0x1d9241c] Final|HasDefaults    
};
...
public:
	...
	// void OnApplicationGeneric(AActor* MyTarget, FGameplayCueParameters& Parameters, TArray<UFXSystemComponent*>& ParticleComponents, TArray<UAudioComponent*>& AudioComponents, ULegacyCameraShake* BurstCameraShakeInstance, ADecalActor* BurstDecalInstance); // [0x1d9241c] Event|Public|HasOutParms|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCNL_RidingSprint_SpeedLines(int32_t EntryPoint);                                                  // [0x1d9241c] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_GCNL_Riding_Sprint_CameraShake(int32_t EntryPoint);                                                // [0x1d9241c] Final|HasDefaults    
};
...
public:
	...
	// void Added_7482F31A49360978B87F339D76FC2BB7();                                                                           // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void Removed_AD34CCD44592FD2F05DB47BDF9413ACC();                                                                         // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCNL_Athena_Energy_ConstantRegen_Active_WildlifeMount(int32_t EntryPoint);                         // [0x1d9241c] Final|HasDefaults    
};
...
public:
	...
	// void CalculateVelocityParam();                                                                                           // [0x1d9241c] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/GameplayCues/GCNL_PlayerIsRiding.GCNL_PlayerIsRiding_C.WhileActive
	// bool WhileActive(AActor* MyTarget, FGameplayCueParameters& Parameters);                                                  // [0x1d9241c] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
...
public:
	...
	// void OnBurstGeneric(AActor* MyTarget, FGameplayCueParameters& Parameters, TArray<UFXSystemComponent*>& ParticleComponents, TArray<UAudioComponent*>& AudioComponents, ULegacyCameraShake* BurstCameraShakeInstance, ADecalActor* BurstDecalInstance); // [0x1d9241c] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
};
...
public:
	...
	// void AllowAudio();                                                                                                       // [0x1d9241c] Public|BlueprintCallable|BlueprintEvent 
	// Function /GrindRail/GameplayCues/GCNL_Grinding.GCNL_Grinding_C.OnJumpedOff
	// void OnJumpedOff();                                                                                                      // [0x1d9241c] Public|BlueprintCallable|BlueprintEvent 
	// Function /GrindRail/GameplayCues/GCNL_Grinding.GCNL_Grinding_C.GrindAudioState
	// void GrindAudioState(bool Start);                                                                                        // [0x1d9241c] Public|BlueprintCallable|BlueprintEvent 
	// Function /GrindRail/GameplayCues/GCNL_Grinding.GCNL_Grinding_C.AlphaCurve__FinishedFunc
	// void AlphaCurve__FinishedFunc();                                                                                         // [0x1d9241c] BlueprintEvent       
	// Function /GrindRail/GameplayCues/GCNL_Grinding.GCNL_Grinding_C.AlphaCurve__UpdateFunc
	// void AlphaCurve__UpdateFunc();                                                                                           // [0x1d9241c] BlueprintEvent       
	// Function /GrindRail/GameplayCues/GCNL_Grinding.GCNL_Grinding_C.OnFeetLanded
	// void OnFeetLanded();                                                                                                     // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	// Function /GrindRail/GameplayCues/GCNL_Grinding.GCNL_Grinding_C.OnGrindRailSprint
	// void OnGrindRailSprint(bool bNewIsSprinting);                                                                            // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	// Function /GrindRail/GameplayCues/GCNL_Grinding.GCNL_Grinding_C.OnGrindRailBoosterMode
	// void OnGrindRailBoosterMode(EGrindRailBoosterMode PreviousBoosterMode);                                                  // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void HandleGrindRailChanged(AFortGrindRail* OldRail, AFortGrindRail* NewRail);                                           // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCNL_Grinding(int32_t EntryPoint);                                                                 // [0x1d9241c] Final|HasDefaults    
};
...
public:
	...
	// void ExecuteUbergraph_GCNL_GrindSprinting(int32_t EntryPoint);                                                           // [0x1d9241c] Final|HasDefaults    
};
...
public:
	...
	// void VisualizeAudio();                                                                                                   // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCNL_Ascender_Descent(int32_t EntryPoint);                                                         // [0x1d9241c] Final|HasDefaults    
};
...
public:
	...
	// void AVIndicatorLoop();                                                                                                  // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCNL_Athena_VictoryCrown_CrownWearer_Looping(int32_t EntryPoint);                                  // [0x1d9241c] Final|HasDefaults    
};
...
public:
	...
	// void cameraShakeTimer();                                                                                                 // [0x1d9241c] BlueprintCallable|BlueprintEvent 
	// Function /Ascender/GameplayCues/GCNL_Ascender_Ascent.GCNL_Ascender_Ascent_C.ExecuteUbergraph_GCNL_Ascender_Ascent
	// void ExecuteUbergraph_GCNL_Ascender_Ascent(int32_t EntryPoint);                                                          // [0x1d9241c] Final|HasDefaults    
};
...
public:
	...
	// void OnBurst(AActor* MyTarget, FGameplayCueParameters& Parameters, TArray<UParticleSystemComponent*>& ParticleComponents, TArray<UAudioComponent*>& AudioComponents, ULegacyCameraShake* BurstCameraShakeInstance, ADecalActor* BurstDecalInstance); // [0x1d9241c] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
};
