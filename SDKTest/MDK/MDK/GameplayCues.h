...
public:
	...
	CMember(USoundBase*)                               SlideSound                                                  OFFSET(get<T>, {0x9B8, 8, 0, 0})
	CMember(UAudioComponent*)                          SlidingSoundComponent                                       OFFSET(get<T>, {0x9C0, 8, 0, 0})


	/// Functions
	// Function /Irwin/GameplayCues/GCNL_Irwin_Slide.GCNL_Irwin_Slide_C.OnLoopingStartGeneric
	// void OnLoopingStartGeneric(AActor* MyTarget, FGameplayCueParameters& Parameters, TArray<UFXSystemComponent*>& ParticleComponents, TArray<UAudioComponent*>& AudioComponents); // [0x101681c] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Irwin/GameplayCues/GCNL_Irwin_Slide.GCNL_Irwin_Slide_C.OnRemovalGeneric
	// void OnRemovalGeneric(AActor* MyTarget, FGameplayCueParameters& Parameters, TArray<UFXSystemComponent*>& ParticleComponents, TArray<UAudioComponent*>& AudioComponents, ULegacyCameraShake* BurstCameraShakeInstance, ADecalActor* BurstDecalInstance); // [0x101681c] Event|Public|HasOutParms|BlueprintEvent 
	// Function /Irwin/GameplayCues/GCNL_Irwin_Slide.GCNL_Irwin_Slide_C.ExecuteUbergraph_GCNL_Irwin_Slide
	// void ExecuteUbergraph_GCNL_Irwin_Slide(int32_t EntryPoint);                                                              // [0x101681c] Final|HasDefaults    
};
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x9B0, 8, 0, 0})
	CMember(UAudioComponent*)                          FloatSound                                                  OFFSET(get<T>, {0x9B8, 8, 0, 0})
	...
	// void ExecuteUbergraph_GCNL_Irwin_Player_Prey_Nug_Float(int32_t EntryPoint);                                              // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	// void OnBurstNiagara(AActor* MyTarget, FGameplayCueParameters& Parameters, TArray<UNiagaraComponent*>& ParticleComponents, TArray<UAudioComponent*>& AudioComponents, ULegacyCameraShake* BurstCameraShakeInstance, ADecalActor* BurstDecalInstance); // [0x101681c] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
};
...
public:
	...
	CMember(APlayerController*)                        GCPlayerController                                          OFFSET(get<T>, {0x558, 8, 0, 0})
	CMember(AFortPlayerPawn*)                          FortPlayerPawn                                              OFFSET(get<T>, {0x560, 8, 0, 0})
	CMember(USoundBase*)                               BoostSound                                                  OFFSET(get<T>, {0x568, 8, 0, 0})
	CMember(UAudioComponent*)                          BoostAudioComponent                                         OFFSET(get<T>, {0x570, 8, 0, 0})
	CMember(USoundBase*)                               BoostEndSound                                               OFFSET(get<T>, {0x578, 8, 0, 0})


	/// Functions
	// Function /RidingContent/GameplayCues/GCN_BurtCharging_Player_Latent.GCN_BurtCharging_Player_Latent_C.OnExecute
	// bool OnExecute(AActor* MyTarget, FGameplayCueParameters& Parameters);                                                    // [0x101681c] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/GameplayCues/GCN_BurtCharging_Player_Latent.GCN_BurtCharging_Player_Latent_C.ExecuteBoostLogic
	// void ExecuteBoostLogic();                                                                                                // [0x101681c] BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/GameplayCues/GCN_BurtCharging_Player_Latent.GCN_BurtCharging_Player_Latent_C.BoostEndEvent
	// void BoostEndEvent();                                                                                                    // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCN_BurtCharging_Player_Latent(int32_t EntryPoint);                                                // [0x101681c] Final|HasDefaults    
};

/// Class /RidingContent/GameplayCues/GCNL_PlayerIsRiding.GCNL_PlayerIsRiding_C
/// Size: 0x00D0 (0x0009B0 - 0x000A80)
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x9B0, 8, 0, 0})
	CMember(USoundBase*)                               RidingSoundLoop                                             OFFSET(get<T>, {0x9B8, 8, 0, 0})
	CMember(UAudioComponent*)                          RidingSoundLoopComp                                         OFFSET(get<T>, {0x9C0, 8, 0, 0})
	SMember(FTimerHandle)                              VelocityTimerHandle                                         OFFSET(getStruct<T>, {0x9C8, 8, 0, 0})
	CMember(AActor*)                                   Player                                                      OFFSET(get<T>, {0x9D0, 8, 0, 0})
	...
	CMember(USoundBase*)                               Enemy_RidingSoundLoop                                       OFFSET(get<T>, {0xA00, 8, 0, 0})
	CMember(AFortPlayerPawnAthena*)                    As_Fort_Player_Pawn_Athena                                  OFFSET(get<T>, {0xA08, 8, 0, 0})
	...
	CMember(UPawnMovementComponent*)                   CreatureMovementComponent                                   OFFSET(get<T>, {0xA28, 8, 0, 0})
	...
	// void CalculateVelocityParam();                                                                                           // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /RidingContent/GameplayCues/GCNL_PlayerIsRiding.GCNL_PlayerIsRiding_C.WhileActive
	// bool WhileActive(AActor* MyTarget, FGameplayCueParameters& Parameters);                                                  // [0x101681c] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x9B0, 8, 0, 0})
	CMember(USoundBase*)                               SpeedLinesAudio                                             OFFSET(get<T>, {0x9B8, 8, 0, 0})
	CMember(UAudioComponent*)                          SpeedlinesAudioComp                                         OFFSET(get<T>, {0x9C0, 8, 0, 0})


	/// Functions
	// Function /RidingContent/GameplayCues/GCNL_RidingSprint_SpeedLines.GCNL_RidingSprint_SpeedLines_C.OnApplicationGeneric
	// void OnApplicationGeneric(AActor* MyTarget, FGameplayCueParameters& Parameters, TArray<UFXSystemComponent*>& ParticleComponents, TArray<UAudioComponent*>& AudioComponents, ULegacyCameraShake* BurstCameraShakeInstance, ADecalActor* BurstDecalInstance); // [0x101681c] Event|Public|HasOutParms|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCNL_RidingSprint_SpeedLines(int32_t EntryPoint);                                                  // [0x101681c] Final|HasDefaults    
};
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x9B0, 8, 0, 0})
	CMember(AFortPlayerController*)                    FortPlayerController                                        OFFSET(get<T>, {0x9B8, 8, 0, 0})
	CMember(UCameraShakeBase*)                         FOVFlare                                                    OFFSET(get<T>, {0x9C0, 8, 0, 0})
	CMember(UCameraShakeBase*)                         ShakeNoise                                                  OFFSET(get<T>, {0x9C8, 8, 0, 0})


	/// Functions
	// Function /RidingContent/GameplayCues/GCNL_Riding_Sprint_CameraShake.GCNL_Riding_Sprint_CameraShake_C.OnRemove
	// bool OnRemove(AActor* MyTarget, FGameplayCueParameters& Parameters);                                                     // [0x101681c] Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCNL_Riding_Sprint_CameraShake(int32_t EntryPoint);                                                // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	CMember(UFXSystemComponent*)                       MainNS                                                      OFFSET(get<T>, {0x9C0, 8, 0, 0})
	...
	// void Added_7482F31A49360978B87F339D76FC2BB7();                                                                           // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void Removed_AD34CCD44592FD2F05DB47BDF9413ACC();                                                                         // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCNL_Athena_Energy_ConstantRegen_Active_WildlifeMount(int32_t EntryPoint);                         // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	// void OnBurstGeneric(AActor* MyTarget, FGameplayCueParameters& Parameters, TArray<UFXSystemComponent*>& ParticleComponents, TArray<UAudioComponent*>& AudioComponents, ULegacyCameraShake* BurstCameraShakeInstance, ADecalActor* BurstDecalInstance); // [0x101681c] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
};
...
public:
	...
	CMember(AActor*)                                   My_Target                                                   OFFSET(get<T>, {0x9C0, 8, 0, 0})
	CMember(UAudioComponent*)                          AudioComponent                                              OFFSET(get<T>, {0x9C8, 8, 0, 0})
	CMember(UTexture*)                                 Override_Icon                                               OFFSET(get<T>, {0x9D0, 8, 0, 0})
	...
	// void VisualizeAudio();                                                                                                   // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCNL_Ascender_Descent(int32_t EntryPoint);                                                         // [0x101681c] Final|HasDefaults    
};
...
/// Size: 0x0091 (0x000B40 - 0x000BD1)
class AGCNL_Grinding_C : public AFortGameplayCueNotifyLoop_Grinding
{ 
	friend MDKHandler;
	static inline constexpr uint64_t __MDKClassSize = 3025;

public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0xB40, 8, 0, 0})
	CMember(UFortSoundIndicatorComponent*)             FortSoundIndicator                                          OFFSET(get<T>, {0xB48, 8, 0, 0})
	DMember(float)                                     AlphaCurve_AlphaCurve_9B7371B340D33525AE3B1686831C0FC6      OFFSET(get<float>, {0xB50, 4, 0, 0})
	CMember(TEnumAsByte<ETimelineDirection>)           AlphaCurve__Direction_9B7371B340D33525AE3B1686831C0FC6      OFFSET(get<T>, {0xB54, 1, 0, 0})
	CMember(UTimelineComponent*)                       AlphaCurve                                                  OFFSET(get<T>, {0xB58, 8, 0, 0})
	CMember(UFXSystemComponent*)                       GrindRailFX                                                 OFFSET(get<T>, {0xB60, 8, 0, 0})
	CMember(UBP_GrindingComponent_C*)                  Cached_Grinding_Component                                   OFFSET(get<T>, {0xB68, 8, 0, 0})
	CMember(UAudioComponent*)                          GrindAudioLoop                                              OFFSET(get<T>, {0xB70, 8, 0, 0})
	CMember(UAudioComponent*)                          GrindAudioStart                                             OFFSET(get<T>, {0xB78, 8, 0, 0})
	CMember(AFortPlayerPawn*)                          PlayerPawn                                                  OFFSET(get<T>, {0xB80, 8, 0, 0})
	CMember(TEnumAsByte<ColorSelect>)                  ColorEnum                                                   OFFSET(get<T>, {0xB88, 1, 0, 0})
	CMember(AFortGrindRail*)                           GrindRail                                                   OFFSET(get<T>, {0xB90, 8, 0, 0})
	CMember(ABuildingGameplayActor*)                   GrindingRail                                                OFFSET(get<T>, {0xB98, 8, 0, 0})
	CMember(UAudioComponent*)                          JumpOffAudio                                                OFFSET(get<T>, {0xBA0, 8, 0, 0})
	DMember(float)                                     NotRenderedDisableEffectsTime                               OFFSET(get<float>, {0xBA8, 4, 0, 0})
	CMember(USoundBase*)                               StartLoopSound                                              OFFSET(get<T>, {0xBB0, 8, 0, 0})
	CMember(USoundBase*)                               LeanForwardSound                                            OFFSET(get<T>, {0xBB8, 8, 0, 0})
	CMember(USoundBase*)                               JumpUpSound                                                 OFFSET(get<T>, {0xBC0, 8, 0, 0})
	CMember(UAudioComponent*)                          LeanForwardAudio                                            OFFSET(get<T>, {0xBC8, 8, 0, 0})
	DMember(bool)                                      bGrinding                                                   OFFSET(get<bool>, {0xBD0, 1, 0, 0})


	/// Functions
	// Function /GrindRail/GameplayCues/GCNL_Grinding.GCNL_Grinding_C.AllowAudio
	// void AllowAudio();                                                                                                       // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /GrindRail/GameplayCues/GCNL_Grinding.GCNL_Grinding_C.OnJumpedOff
	// void OnJumpedOff();                                                                                                      // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /GrindRail/GameplayCues/GCNL_Grinding.GCNL_Grinding_C.GrindAudioState
	// void GrindAudioState(bool Start);                                                                                        // [0x101681c] Public|BlueprintCallable|BlueprintEvent 
	// Function /GrindRail/GameplayCues/GCNL_Grinding.GCNL_Grinding_C.AlphaCurve__FinishedFunc
	// void AlphaCurve__FinishedFunc();                                                                                         // [0x101681c] BlueprintEvent       
	// Function /GrindRail/GameplayCues/GCNL_Grinding.GCNL_Grinding_C.AlphaCurve__UpdateFunc
	// void AlphaCurve__UpdateFunc();                                                                                           // [0x101681c] BlueprintEvent       
	// Function /GrindRail/GameplayCues/GCNL_Grinding.GCNL_Grinding_C.OnFeetLanded
	// void OnFeetLanded();                                                                                                     // [0x101681c] BlueprintCallable|BlueprintEvent 
	// Function /GrindRail/GameplayCues/GCNL_Grinding.GCNL_Grinding_C.OnGrindRailSprint
	// void OnGrindRailSprint(bool bNewIsSprinting);                                                                            // [0x101681c] BlueprintCallable|BlueprintEvent 
	// Function /GrindRail/GameplayCues/GCNL_Grinding.GCNL_Grinding_C.OnGrindRailBoosterMode
	// void OnGrindRailBoosterMode(EGrindRailBoosterMode PreviousBoosterMode);                                                  // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void HandleGrindRailChanged(AFortGrindRail* OldRail, AFortGrindRail* NewRail);                                           // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCNL_Grinding(int32_t EntryPoint);                                                                 // [0x101681c] Final|HasDefaults    
};
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x9B0, 8, 0, 0})
	CMember(UAudioComponent*)                          BoostAudio                                                  OFFSET(get<T>, {0x9B8, 8, 0, 0})
	CMember(UAudioComponent*)                          BoostEndAudio                                               OFFSET(get<T>, {0x9C0, 8, 0, 0})
	...
	// void ExecuteUbergraph_GCNL_GrindSprinting(int32_t EntryPoint);                                                           // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	// void AVIndicatorLoop();                                                                                                  // [0x101681c] BlueprintCallable|BlueprintEvent 
	...
	// void ExecuteUbergraph_GCNL_Athena_VictoryCrown_CrownWearer_Looping(int32_t EntryPoint);                                  // [0x101681c] Final|HasDefaults    
};
...
public:
	SMember(FPointerToUberGraphFrame)                  UberGraphFrame                                              OFFSET(getStruct<T>, {0x9B0, 8, 0, 0})
	CMember(AFortPlayerPawn*)                          PlayerPawn                                                  OFFSET(get<T>, {0x9B8, 8, 0, 0})
	...
	CMember(ULegacyCameraShake*)                       matineeCamShake                                             OFFSET(get<T>, {0x9E0, 8, 0, 0})
	...
	// void cameraShakeTimer();                                                                                                 // [0x101681c] BlueprintCallable|BlueprintEvent 
	// Function /Ascender/GameplayCues/GCNL_Ascender_Ascent.GCNL_Ascender_Ascent_C.ExecuteUbergraph_GCNL_Ascender_Ascent
	// void ExecuteUbergraph_GCNL_Ascender_Ascent(int32_t EntryPoint);                                                          // [0x101681c] Final|HasDefaults    
};
...
public:
	...
	// void OnBurst(AActor* MyTarget, FGameplayCueParameters& Parameters, TArray<UParticleSystemComponent*>& ParticleComponents, TArray<UAudioComponent*>& AudioComponents, ULegacyCameraShake* BurstCameraShakeInstance, ADecalActor* BurstDecalInstance); // [0x101681c] Event|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintEvent|Const 
};
