...
public:
	DMember(unsigned char)                             ManifestFileVersion                                         OFFSET(get<unsigned char>, {0x28, 1, 0, 0})
...
public:
	DMember(unsigned char)                             Hash                                                        OFFSET(get<unsigned char>, {0x0, 20, 0, 0})
};
...
public:
	...
	DMember(unsigned char)                             GroupNumber                                                 OFFSET(get<unsigned char>, {0x38, 1, 0, 0})
};
