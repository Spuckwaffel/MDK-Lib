...
public:
	...
	CMember(UOverlay*)                                 Overlay_Health                                              OFFSET(get<T>, {0x358, 8, 0, 0})
	CMember(UOverlay*)                                 Overlay_EnergyLevel                                         OFFSET(get<T>, {0x360, 8, 0, 0})
	CMember(UOverlay*)                                 Overlay_Reticle                                             OFFSET(get<T>, {0x368, 8, 0, 0})
	CMember(UOverlay*)                                 Overlay_TetheringIndicator                                  OFFSET(get<T>, {0x370, 8, 0, 0})
